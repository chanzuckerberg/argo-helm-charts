...
| - [oidcProxyGateway](#cronJobs_pattern1_oidcProxyGateway )                   | No      | object           | No         | -                       | Native Envoy Gateway OIDC authentication configuration (used when gateway.oidcProtected is true). Automatically discovers OAUTH2_PROXY_CLIENT_ID and OAUTH2_PROXY_CLIENT_SECRET from appSecrets and oidcProxy.additionalSecrets. |
...
#### <a name="cronJobs_pattern1_oidcProxyGateway"></a>2.1.26. Property `stack > cronJobs > ^.*$ > oidcProxyGateway`
...
**Description:** Native Envoy Gateway OIDC authentication configuration (used when gateway.oidcProtected is true). Automatically discovers OAUTH2_PROXY_CLIENT_ID and OAUTH2_PROXY_CLIENT_SECRET from appSecrets and oidcProxy.additionalSecrets.
...
| - [redirectURL](#cronJobs_pattern1_oidcProxyGateway_redirectURL )               | No      | string          | No         | -          | OIDC redirect URL (e.g., https://yourapp.cluster.dev.czi.team/oauth2/callback)         |
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_cookieDomain"></a>2.1.26.2. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > cookieDomain`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_cookieNames"></a>2.1.26.3. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > cookieNames`
...
###### <a name="cronJobs_pattern1_oidcProxyGateway_cookieNames_accessToken"></a>2.1.26.3.1. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > cookieNames > accessToken`
...
###### <a name="cronJobs_pattern1_oidcProxyGateway_cookieNames_idToken"></a>2.1.26.3.2. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > cookieNames > idToken`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_forwardAccessToken"></a>2.1.26.4. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > forwardAccessToken`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_logoutPath"></a>2.1.26.5. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > logoutPath`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_provider"></a>2.1.26.6. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > provider`
...
| Property                                                                                       | Pattern | Type   | Deprecated | Definition | Title/Description                                          |
| ---------------------------------------------------------------------------------------------- | ------- | ------ | ---------- | ---------- | ---------------------------------------------------------- |
| - [authorizationEndpoint](#cronJobs_pattern1_oidcProxyGateway_provider_authorizationEndpoint ) | No      | string | No         | -          | Optional authorization endpoint (auto-discovered if empty) |
...
###### <a name="cronJobs_pattern1_oidcProxyGateway_provider_authorizationEndpoint"></a>2.1.26.6.1. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > provider > authorizationEndpoint`
...
###### <a name="cronJobs_pattern1_oidcProxyGateway_provider_issuer"></a>2.1.26.6.2. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > provider > issuer`
...
###### <a name="cronJobs_pattern1_oidcProxyGateway_provider_tokenEndpoint"></a>2.1.26.6.3. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > provider > tokenEndpoint`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_redirectURL"></a>2.1.26.7. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > redirectURL`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_refreshToken"></a>2.1.26.8. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > refreshToken`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_resources"></a>2.1.26.9. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > resources`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_scopes"></a>2.1.26.10. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > scopes`
...
###### <a name="cronJobs_pattern1_oidcProxyGateway_scopes_items"></a>2.1.26.10.1. stack > cronJobs > ^.*$ > oidcProxyGateway > scopes > scopes items
...
#### <a name="cronJobs_pattern1_persistence"></a>2.1.27. Property `stack > cronJobs > ^.*$ > persistence`
...
##### <a name="cronJobs_pattern1_persistence_enabled"></a>2.1.27.1. Property `stack > cronJobs > ^.*$ > persistence > enabled`
...
##### <a name="cronJobs_pattern1_persistence_existingClaim"></a>2.1.27.2. Property `stack > cronJobs > ^.*$ > persistence > existingClaim`
...
##### <a name="cronJobs_pattern1_persistence_mountPath"></a>2.1.27.3. Property `stack > cronJobs > ^.*$ > persistence > mountPath`
...
##### <a name="cronJobs_pattern1_persistence_pvc"></a>2.1.27.4. Property `stack > cronJobs > ^.*$ > persistence > pvc`
...
###### <a name="cronJobs_pattern1_persistence_pvc_accessModes"></a>2.1.27.4.1. Property `stack > cronJobs > ^.*$ > persistence > pvc > accessModes`
...
###### <a name="cronJobs_pattern1_persistence_pvc_accessModes_items"></a>2.1.27.4.1.1. stack > cronJobs > ^.*$ > persistence > pvc > accessModes > accessModes items
...
###### <a name="cronJobs_pattern1_persistence_pvc_dataSource"></a>2.1.27.4.2. Property `stack > cronJobs > ^.*$ > persistence > pvc > dataSource`
...
###### <a name="cronJobs_pattern1_persistence_pvc_dataSource_apiGroup"></a>2.1.27.4.2.1. Property `stack > cronJobs > ^.*$ > persistence > pvc > dataSource > apiGroup`
...
###### <a name="cronJobs_pattern1_persistence_pvc_dataSource_kind"></a>2.1.27.4.2.2. Property `stack > cronJobs > ^.*$ > persistence > pvc > dataSource > kind`
...
###### <a name="cronJobs_pattern1_persistence_pvc_dataSource_name"></a>2.1.27.4.2.3. Property `stack > cronJobs > ^.*$ > persistence > pvc > dataSource > name`
...
###### <a name="cronJobs_pattern1_persistence_pvc_resources"></a>2.1.27.4.3. Property `stack > cronJobs > ^.*$ > persistence > pvc > resources`
...
###### <a name="cronJobs_pattern1_persistence_pvc_resources_requests"></a>2.1.27.4.3.1. Property `stack > cronJobs > ^.*$ > persistence > pvc > resources > requests`
...
###### <a name="cronJobs_pattern1_persistence_pvc_resources_requests_storage"></a>2.1.27.4.3.1.1. Property `stack > cronJobs > ^.*$ > persistence > pvc > resources > requests > storage`
...
###### <a name="cronJobs_pattern1_persistence_pvc_storageClassName"></a>2.1.27.4.4. Property `stack > cronJobs > ^.*$ > persistence > pvc > storageClassName`
...
#### <a name="cronJobs_pattern1_podAnnotations"></a>2.1.28. Property `stack > cronJobs > ^.*$ > podAnnotations`
...
#### <a name="cronJobs_pattern1_podLabels"></a>2.1.29. Property `stack > cronJobs > ^.*$ > podLabels`
...
#### <a name="cronJobs_pattern1_podSecurityContext"></a>2.1.30. Property `stack > cronJobs > ^.*$ > podSecurityContext`
...
#### <a name="cronJobs_pattern1_progressDeadlineSeconds"></a>2.1.31. Property `stack > cronJobs > ^.*$ > progressDeadlineSeconds`
...
#### <a name="cronJobs_pattern1_readinessProbe"></a>2.1.32. Property `stack > cronJobs > ^.*$ > readinessProbe`
...
##### <a name="cronJobs_pattern1_readinessProbe_failureThreshold"></a>2.1.32.1. Property `stack > cronJobs > ^.*$ > readinessProbe > failureThreshold`
...
##### <a name="cronJobs_pattern1_readinessProbe_httpGet"></a>2.1.32.2. Property `stack > cronJobs > ^.*$ > readinessProbe > httpGet`
...
###### <a name="cronJobs_pattern1_readinessProbe_httpGet_path"></a>2.1.32.2.1. Property `stack > cronJobs > ^.*$ > readinessProbe > httpGet > path`
...
###### <a name="cronJobs_pattern1_readinessProbe_httpGet_port"></a>2.1.32.2.2. Property `stack > cronJobs > ^.*$ > readinessProbe > httpGet > port`
...
###### <a name="cronJobs_pattern1_readinessProbe_httpGet_port_oneOf_i0"></a>2.1.32.2.2.1. Property `stack > cronJobs > ^.*$ > readinessProbe > httpGet > port > oneOf > item 0`
...
###### <a name="cronJobs_pattern1_readinessProbe_httpGet_port_oneOf_i1"></a>2.1.32.2.2.2. Property `stack > cronJobs > ^.*$ > readinessProbe > httpGet > port > oneOf > item 1`
...
###### <a name="cronJobs_pattern1_readinessProbe_httpGet_scheme"></a>2.1.32.2.3. Property `stack > cronJobs > ^.*$ > readinessProbe > httpGet > scheme`
...
##### <a name="cronJobs_pattern1_readinessProbe_initialDelaySeconds"></a>2.1.32.3. Property `stack > cronJobs > ^.*$ > readinessProbe > initialDelaySeconds`
...
##### <a name="cronJobs_pattern1_readinessProbe_periodSeconds"></a>2.1.32.4. Property `stack > cronJobs > ^.*$ > readinessProbe > periodSeconds`
...
##### <a name="cronJobs_pattern1_readinessProbe_successThreshold"></a>2.1.32.5. Property `stack > cronJobs > ^.*$ > readinessProbe > successThreshold`
...
##### <a name="cronJobs_pattern1_readinessProbe_timeoutSeconds"></a>2.1.32.6. Property `stack > cronJobs > ^.*$ > readinessProbe > timeoutSeconds`
...
#### <a name="cronJobs_pattern1_replicaCount"></a>2.1.33. Property `stack > cronJobs > ^.*$ > replicaCount`
...
#### <a name="cronJobs_pattern1_resources"></a>2.1.34. Property `stack > cronJobs > ^.*$ > resources`
...
##### <a name="cronJobs_pattern1_resources_limits"></a>2.1.34.1. Property `stack > cronJobs > ^.*$ > resources > limits`
...
###### <a name="cronJobs_pattern1_resources_limits_cpu"></a>2.1.34.1.1. Property `stack > cronJobs > ^.*$ > resources > limits > cpu`
...
###### <a name="cronJobs_pattern1_resources_limits_cpu_oneOf_i0"></a>2.1.34.1.1.1. Property `stack > cronJobs > ^.*$ > resources > limits > cpu > oneOf > item 0`
...
###### <a name="cronJobs_pattern1_resources_limits_cpu_oneOf_i1"></a>2.1.34.1.1.2. Property `stack > cronJobs > ^.*$ > resources > limits > cpu > oneOf > item 1`
...
###### <a name="cronJobs_pattern1_resources_limits_memory"></a>2.1.34.1.2. Property `stack > cronJobs > ^.*$ > resources > limits > memory`
...
##### <a name="cronJobs_pattern1_resources_requests"></a>2.1.34.2. Property `stack > cronJobs > ^.*$ > resources > requests`
...
###### <a name="cronJobs_pattern1_resources_requests_cpu"></a>2.1.34.2.1. Property `stack > cronJobs > ^.*$ > resources > requests > cpu`
...
###### <a name="cronJobs_pattern1_resources_requests_cpu_oneOf_i0"></a>2.1.34.2.1.1. Property `stack > cronJobs > ^.*$ > resources > requests > cpu > oneOf > item 0`
...
###### <a name="cronJobs_pattern1_resources_requests_cpu_oneOf_i1"></a>2.1.34.2.1.2. Property `stack > cronJobs > ^.*$ > resources > requests > cpu > oneOf > item 1`
...
###### <a name="cronJobs_pattern1_resources_requests_memory"></a>2.1.34.2.2. Property `stack > cronJobs > ^.*$ > resources > requests > memory`
...
#### <a name="cronJobs_pattern1_restartPolicy"></a>2.1.35. Property `stack > cronJobs > ^.*$ > restartPolicy`
...
#### <a name="cronJobs_pattern1_rollout"></a>2.1.36. Property `stack > cronJobs > ^.*$ > rollout`
...
##### <a name="cronJobs_pattern1_rollout_strategy"></a>2.1.36.1. Property `stack > cronJobs > ^.*$ > rollout > strategy`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen"></a>2.1.36.1.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_activeService"></a>2.1.36.1.1.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > activeService`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_autoPromotionEnabled"></a>2.1.36.1.1.2. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > autoPromotionEnabled`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis"></a>2.1.36.1.1.3. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_analysisRunMetadata"></a>2.1.36.1.1.3.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > analysisRunMetadata`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_analysisRunMetadata_annotations"></a>2.1.36.1.1.3.1.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > analysisRunMetadata > annotations`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_analysisRunMetadata_labels"></a>2.1.36.1.1.3.1.2. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > analysisRunMetadata > labels`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args"></a>2.1.36.1.1.3.2. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args_items"></a>2.1.36.1.1.3.2.1. stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args > args items
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args_items_name"></a>2.1.36.1.1.3.2.1.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args > args items > name`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args_items_value"></a>2.1.36.1.1.3.2.1.2. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args > args items > value`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args_items_valueFrom"></a>2.1.36.1.1.3.2.1.3. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args > args items > valueFrom`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args_items_valueFrom_fieldRef"></a>2.1.36.1.1.3.2.1.3.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args > args items > valueFrom > fieldRef`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args_items_valueFrom_fieldRef_fieldPath"></a>2.1.36.1.1.3.2.1.3.1.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args > args items > valueFrom > fieldRef > fieldPath`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args_items_valueFrom_podTemplateHashValue"></a>2.1.36.1.1.3.2.1.3.2. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args > args items > valueFrom > podTemplateHashValue`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_templates"></a>2.1.36.1.1.3.3. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > templates`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_templates_items"></a>2.1.36.1.1.3.3.1. stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > templates > templates items
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_templates_items_clusterScope"></a>2.1.36.1.1.3.3.1.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > templates > templates items > clusterScope`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_templates_items_templateName"></a>2.1.36.1.1.3.3.1.2. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > templates > templates items > templateName`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_previewService"></a>2.1.36.1.1.4. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > previewService`
...
#### <a name="cronJobs_pattern1_s3Storage"></a>2.1.37. Property `stack > cronJobs > ^.*$ > s3Storage`
...
##### <a name="cronJobs_pattern1_s3Storage_accessModes"></a>2.1.37.1. Property `stack > cronJobs > ^.*$ > s3Storage > accessModes`
...
###### <a name="cronJobs_pattern1_s3Storage_accessModes_items"></a>2.1.37.1.1. stack > cronJobs > ^.*$ > s3Storage > accessModes > accessModes items
...
##### <a name="cronJobs_pattern1_s3Storage_annotations"></a>2.1.37.2. Property `stack > cronJobs > ^.*$ > s3Storage > annotations`
...
##### <a name="cronJobs_pattern1_s3Storage_bucketName"></a>2.1.37.3. Property `stack > cronJobs > ^.*$ > s3Storage > bucketName`
...
##### <a name="cronJobs_pattern1_s3Storage_capacity"></a>2.1.37.4. Property `stack > cronJobs > ^.*$ > s3Storage > capacity`
...
##### <a name="cronJobs_pattern1_s3Storage_enabled"></a>2.1.37.5. Property `stack > cronJobs > ^.*$ > s3Storage > enabled`
...
##### <a name="cronJobs_pattern1_s3Storage_labels"></a>2.1.37.6. Property `stack > cronJobs > ^.*$ > s3Storage > labels`
...
##### <a name="cronJobs_pattern1_s3Storage_pvName"></a>2.1.37.7. Property `stack > cronJobs > ^.*$ > s3Storage > pvName`
...
##### <a name="cronJobs_pattern1_s3Storage_pvcName"></a>2.1.37.8. Property `stack > cronJobs > ^.*$ > s3Storage > pvcName`
...
##### <a name="cronJobs_pattern1_s3Storage_reclaimPolicy"></a>2.1.37.9. Property `stack > cronJobs > ^.*$ > s3Storage > reclaimPolicy`
...
##### <a name="cronJobs_pattern1_s3Storage_region"></a>2.1.37.10. Property `stack > cronJobs > ^.*$ > s3Storage > region`
...
##### <a name="cronJobs_pattern1_s3Storage_volumeAttributes"></a>2.1.37.11. Property `stack > cronJobs > ^.*$ > s3Storage > volumeAttributes`
...
##### <a name="cronJobs_pattern1_s3Storage_volumeHandle"></a>2.1.37.12. Property `stack > cronJobs > ^.*$ > s3Storage > volumeHandle`
...
#### <a name="cronJobs_pattern1_securityContext"></a>2.1.38. Property `stack > cronJobs > ^.*$ > securityContext`
...
#### <a name="cronJobs_pattern1_service"></a>2.1.39. Property `stack > cronJobs > ^.*$ > service`
...
##### <a name="cronJobs_pattern1_service_port"></a>2.1.39.1. Property `stack > cronJobs > ^.*$ > service > port`
...
##### <a name="cronJobs_pattern1_service_type"></a>2.1.39.2. Property `stack > cronJobs > ^.*$ > service > type`
...
#### <a name="cronJobs_pattern1_serviceAccount"></a>2.1.40. Property `stack > cronJobs > ^.*$ > serviceAccount`
...
##### <a name="cronJobs_pattern1_serviceAccount_annotations"></a>2.1.40.1. Property `stack > cronJobs > ^.*$ > serviceAccount > annotations`
...
##### <a name="cronJobs_pattern1_serviceAccount_automount"></a>2.1.40.2. Property `stack > cronJobs > ^.*$ > serviceAccount > automount`
...
##### <a name="cronJobs_pattern1_serviceAccount_create"></a>2.1.40.3. Property `stack > cronJobs > ^.*$ > serviceAccount > create`
...
##### <a name="cronJobs_pattern1_serviceAccount_name"></a>2.1.40.4. Property `stack > cronJobs > ^.*$ > serviceAccount > name`
...
#### <a name="cronJobs_pattern1_shareProcessNamespace"></a>2.1.41. Property `stack > cronJobs > ^.*$ > shareProcessNamespace`
...
#### <a name="cronJobs_pattern1_sidecars"></a>2.1.42. Property `stack > cronJobs > ^.*$ > sidecars`
...
#### <a name="cronJobs_pattern1_startupProbe"></a>2.1.43. Property `stack > cronJobs > ^.*$ > startupProbe`
...
##### <a name="cronJobs_pattern1_startupProbe_enabled"></a>2.1.43.1. Property `stack > cronJobs > ^.*$ > startupProbe > enabled`
...
##### <a name="cronJobs_pattern1_startupProbe_exec"></a>2.1.43.2. Property `stack > cronJobs > ^.*$ > startupProbe > exec`
...
###### <a name="cronJobs_pattern1_startupProbe_exec_command"></a>2.1.43.2.1. Property `stack > cronJobs > ^.*$ > startupProbe > exec > command`
...
###### <a name="cronJobs_pattern1_startupProbe_exec_command_items"></a>2.1.43.2.1.1. stack > cronJobs > ^.*$ > startupProbe > exec > command > command items
...
##### <a name="cronJobs_pattern1_startupProbe_failureThreshold"></a>2.1.43.3. Property `stack > cronJobs > ^.*$ > startupProbe > failureThreshold`
...
##### <a name="cronJobs_pattern1_startupProbe_initialDelaySeconds"></a>2.1.43.4. Property `stack > cronJobs > ^.*$ > startupProbe > initialDelaySeconds`
...
##### <a name="cronJobs_pattern1_startupProbe_periodSeconds"></a>2.1.43.5. Property `stack > cronJobs > ^.*$ > startupProbe > periodSeconds`
...
##### <a name="cronJobs_pattern1_startupProbe_successThreshold"></a>2.1.43.6. Property `stack > cronJobs > ^.*$ > startupProbe > successThreshold`
...
##### <a name="cronJobs_pattern1_startupProbe_timeoutSeconds"></a>2.1.43.7. Property `stack > cronJobs > ^.*$ > startupProbe > timeoutSeconds`
...
#### <a name="cronJobs_pattern1_tolerations"></a>2.1.44. Property `stack > cronJobs > ^.*$ > tolerations`
...
#### <a name="cronJobs_pattern1_topologySpreadConstraints"></a>2.1.45. Property `stack > cronJobs > ^.*$ > topologySpreadConstraints`
...
#### <a name="cronJobs_pattern1_volumeMounts"></a>2.1.46. Property `stack > cronJobs > ^.*$ > volumeMounts`
...
#### <a name="cronJobs_pattern1_volumes"></a>2.1.47. Property `stack > cronJobs > ^.*$ > volumes`
...
| - [oidcProxyGateway](#global_oidcProxyGateway )                   | No      | object           | No         | -                       | Native Envoy Gateway OIDC authentication configuration (used when gateway.oidcProtected is true). Automatically discovers OAUTH2_PROXY_CLIENT_ID and OAUTH2_PROXY_CLIENT_SECRET from appSecrets and oidcProxy.additionalSecrets. |
...
### <a name="global_oidcProxyGateway"></a>3.26. Property `stack > global > oidcProxyGateway`
...
| - [redirectURL](#global_oidcProxyGateway_redirectURL )               | No      | string          | No         | -          | OIDC redirect URL (e.g., https://yourapp.cluster.dev.czi.team/oauth2/callback)         |
...
#### <a name="global_oidcProxyGateway_cookieDomain"></a>3.26.2. Property `stack > global > oidcProxyGateway > cookieDomain`
...
#### <a name="global_oidcProxyGateway_cookieNames"></a>3.26.3. Property `stack > global > oidcProxyGateway > cookieNames`
...
##### <a name="global_oidcProxyGateway_cookieNames_accessToken"></a>3.26.3.1. Property `stack > global > oidcProxyGateway > cookieNames > accessToken`
...
##### <a name="global_oidcProxyGateway_cookieNames_idToken"></a>3.26.3.2. Property `stack > global > oidcProxyGateway > cookieNames > idToken`
...
#### <a name="global_oidcProxyGateway_forwardAccessToken"></a>3.26.4. Property `stack > global > oidcProxyGateway > forwardAccessToken`
...
#### <a name="global_oidcProxyGateway_logoutPath"></a>3.26.5. Property `stack > global > oidcProxyGateway > logoutPath`
...
#### <a name="global_oidcProxyGateway_provider"></a>3.26.6. Property `stack > global > oidcProxyGateway > provider`
...
| Property                                                                            | Pattern | Type   | Deprecated | Definition | Title/Description                                          |
| ----------------------------------------------------------------------------------- | ------- | ------ | ---------- | ---------- | ---------------------------------------------------------- |
| - [authorizationEndpoint](#global_oidcProxyGateway_provider_authorizationEndpoint ) | No      | string | No         | -          | Optional authorization endpoint (auto-discovered if empty) |
...
##### <a name="global_oidcProxyGateway_provider_authorizationEndpoint"></a>3.26.6.1. Property `stack > global > oidcProxyGateway > provider > authorizationEndpoint`
...
##### <a name="global_oidcProxyGateway_provider_issuer"></a>3.26.6.2. Property `stack > global > oidcProxyGateway > provider > issuer`
...
##### <a name="global_oidcProxyGateway_provider_tokenEndpoint"></a>3.26.6.3. Property `stack > global > oidcProxyGateway > provider > tokenEndpoint`
...
#### <a name="global_oidcProxyGateway_redirectURL"></a>3.26.7. Property `stack > global > oidcProxyGateway > redirectURL`
...
#### <a name="global_oidcProxyGateway_refreshToken"></a>3.26.8. Property `stack > global > oidcProxyGateway > refreshToken`
...
#### <a name="global_oidcProxyGateway_resources"></a>3.26.9. Property `stack > global > oidcProxyGateway > resources`
...
#### <a name="global_oidcProxyGateway_scopes"></a>3.26.10. Property `stack > global > oidcProxyGateway > scopes`
...
##### <a name="global_oidcProxyGateway_scopes_items"></a>3.26.10.1. stack > global > oidcProxyGateway > scopes > scopes items
...
### <a name="global_persistence"></a>3.27. Property `stack > global > persistence`
...
#### <a name="global_persistence_enabled"></a>3.27.1. Property `stack > global > persistence > enabled`
...
#### <a name="global_persistence_existingClaim"></a>3.27.2. Property `stack > global > persistence > existingClaim`
...
#### <a name="global_persistence_mountPath"></a>3.27.3. Property `stack > global > persistence > mountPath`
...
#### <a name="global_persistence_pvc"></a>3.27.4. Property `stack > global > persistence > pvc`
...
##### <a name="global_persistence_pvc_accessModes"></a>3.27.4.1. Property `stack > global > persistence > pvc > accessModes`
...
###### <a name="global_persistence_pvc_accessModes_items"></a>3.27.4.1.1. stack > global > persistence > pvc > accessModes > accessModes items
...
##### <a name="global_persistence_pvc_dataSource"></a>3.27.4.2. Property `stack > global > persistence > pvc > dataSource`
...
###### <a name="global_persistence_pvc_dataSource_apiGroup"></a>3.27.4.2.1. Property `stack > global > persistence > pvc > dataSource > apiGroup`
...
###### <a name="global_persistence_pvc_dataSource_kind"></a>3.27.4.2.2. Property `stack > global > persistence > pvc > dataSource > kind`
...
###### <a name="global_persistence_pvc_dataSource_name"></a>3.27.4.2.3. Property `stack > global > persistence > pvc > dataSource > name`
...
##### <a name="global_persistence_pvc_resources"></a>3.27.4.3. Property `stack > global > persistence > pvc > resources`
...
###### <a name="global_persistence_pvc_resources_requests"></a>3.27.4.3.1. Property `stack > global > persistence > pvc > resources > requests`
...
###### <a name="global_persistence_pvc_resources_requests_storage"></a>3.27.4.3.1.1. Property `stack > global > persistence > pvc > resources > requests > storage`
...
##### <a name="global_persistence_pvc_storageClassName"></a>3.27.4.4. Property `stack > global > persistence > pvc > storageClassName`
...
### <a name="global_podAnnotations"></a>3.28. Property `stack > global > podAnnotations`
...
### <a name="global_podLabels"></a>3.29. Property `stack > global > podLabels`
...
### <a name="global_podSecurityContext"></a>3.30. Property `stack > global > podSecurityContext`
...
### <a name="global_progressDeadlineSeconds"></a>3.31. Property `stack > global > progressDeadlineSeconds`
...
### <a name="global_readinessProbe"></a>3.32. Property `stack > global > readinessProbe`
...
#### <a name="global_readinessProbe_failureThreshold"></a>3.32.1. Property `stack > global > readinessProbe > failureThreshold`
...
#### <a name="global_readinessProbe_httpGet"></a>3.32.2. Property `stack > global > readinessProbe > httpGet`
...
##### <a name="global_readinessProbe_httpGet_path"></a>3.32.2.1. Property `stack > global > readinessProbe > httpGet > path`
...
##### <a name="global_readinessProbe_httpGet_port"></a>3.32.2.2. Property `stack > global > readinessProbe > httpGet > port`
...
###### <a name="global_readinessProbe_httpGet_port_oneOf_i0"></a>3.32.2.2.1. Property `stack > global > readinessProbe > httpGet > port > oneOf > item 0`
...
###### <a name="global_readinessProbe_httpGet_port_oneOf_i1"></a>3.32.2.2.2. Property `stack > global > readinessProbe > httpGet > port > oneOf > item 1`
...
##### <a name="global_readinessProbe_httpGet_scheme"></a>3.32.2.3. Property `stack > global > readinessProbe > httpGet > scheme`
...
#### <a name="global_readinessProbe_initialDelaySeconds"></a>3.32.3. Property `stack > global > readinessProbe > initialDelaySeconds`
...
#### <a name="global_readinessProbe_periodSeconds"></a>3.32.4. Property `stack > global > readinessProbe > periodSeconds`
...
#### <a name="global_readinessProbe_successThreshold"></a>3.32.5. Property `stack > global > readinessProbe > successThreshold`
...
#### <a name="global_readinessProbe_timeoutSeconds"></a>3.32.6. Property `stack > global > readinessProbe > timeoutSeconds`
...
### <a name="global_replicaCount"></a>3.33. Property `stack > global > replicaCount`
...
### <a name="global_resources"></a>3.34. Property `stack > global > resources`
...
#### <a name="global_resources_limits"></a>3.34.1. Property `stack > global > resources > limits`
...
##### <a name="global_resources_limits_cpu"></a>3.34.1.1. Property `stack > global > resources > limits > cpu`
...
###### <a name="global_resources_limits_cpu_oneOf_i0"></a>3.34.1.1.1. Property `stack > global > resources > limits > cpu > oneOf > item 0`
...
###### <a name="global_resources_limits_cpu_oneOf_i1"></a>3.34.1.1.2. Property `stack > global > resources > limits > cpu > oneOf > item 1`
...
##### <a name="global_resources_limits_memory"></a>3.34.1.2. Property `stack > global > resources > limits > memory`
...
#### <a name="global_resources_requests"></a>3.34.2. Property `stack > global > resources > requests`
...
##### <a name="global_resources_requests_cpu"></a>3.34.2.1. Property `stack > global > resources > requests > cpu`
...
###### <a name="global_resources_requests_cpu_oneOf_i0"></a>3.34.2.1.1. Property `stack > global > resources > requests > cpu > oneOf > item 0`
...
###### <a name="global_resources_requests_cpu_oneOf_i1"></a>3.34.2.1.2. Property `stack > global > resources > requests > cpu > oneOf > item 1`
...
##### <a name="global_resources_requests_memory"></a>3.34.2.2. Property `stack > global > resources > requests > memory`
...
### <a name="global_restartPolicy"></a>3.35. Property `stack > global > restartPolicy`
...
### <a name="global_rollout"></a>3.36. Property `stack > global > rollout`
...
#### <a name="cronJobs_pattern1_rollout_strategy"></a>3.36.1. Property `stack > cronJobs > ^.*$ > rollout > strategy`
...
##### <a name="cronJobs_pattern1_rollout_strategy_blueGreen"></a>3.36.1.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_activeService"></a>3.36.1.1.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > activeService`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_autoPromotionEnabled"></a>3.36.1.1.2. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > autoPromotionEnabled`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis"></a>3.36.1.1.3. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_analysisRunMetadata"></a>3.36.1.1.3.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > analysisRunMetadata`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_analysisRunMetadata_annotations"></a>3.36.1.1.3.1.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > analysisRunMetadata > annotations`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_analysisRunMetadata_labels"></a>3.36.1.1.3.1.2. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > analysisRunMetadata > labels`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args"></a>3.36.1.1.3.2. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args_items"></a>3.36.1.1.3.2.1. stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args > args items
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args_items_name"></a>3.36.1.1.3.2.1.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args > args items > name`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args_items_value"></a>3.36.1.1.3.2.1.2. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args > args items > value`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args_items_valueFrom"></a>3.36.1.1.3.2.1.3. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args > args items > valueFrom`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args_items_valueFrom_fieldRef"></a>3.36.1.1.3.2.1.3.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args > args items > valueFrom > fieldRef`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args_items_valueFrom_fieldRef_fieldPath"></a>3.36.1.1.3.2.1.3.1.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args > args items > valueFrom > fieldRef > fieldPath`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args_items_valueFrom_podTemplateHashValue"></a>3.36.1.1.3.2.1.3.2. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args > args items > valueFrom > podTemplateHashValue`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_templates"></a>3.36.1.1.3.3. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > templates`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_templates_items"></a>3.36.1.1.3.3.1. stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > templates > templates items
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_templates_items_clusterScope"></a>3.36.1.1.3.3.1.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > templates > templates items > clusterScope`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_templates_items_templateName"></a>3.36.1.1.3.3.1.2. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > templates > templates items > templateName`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_previewService"></a>3.36.1.1.4. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > previewService`
...
### <a name="global_s3Storage"></a>3.37. Property `stack > global > s3Storage`
...
#### <a name="global_s3Storage_accessModes"></a>3.37.1. Property `stack > global > s3Storage > accessModes`
...
##### <a name="global_s3Storage_accessModes_items"></a>3.37.1.1. stack > global > s3Storage > accessModes > accessModes items
...
#### <a name="global_s3Storage_annotations"></a>3.37.2. Property `stack > global > s3Storage > annotations`
...
#### <a name="global_s3Storage_bucketName"></a>3.37.3. Property `stack > global > s3Storage > bucketName`
...
#### <a name="global_s3Storage_capacity"></a>3.37.4. Property `stack > global > s3Storage > capacity`
...
#### <a name="global_s3Storage_enabled"></a>3.37.5. Property `stack > global > s3Storage > enabled`
...
#### <a name="global_s3Storage_labels"></a>3.37.6. Property `stack > global > s3Storage > labels`
...
#### <a name="global_s3Storage_pvName"></a>3.37.7. Property `stack > global > s3Storage > pvName`
...
#### <a name="global_s3Storage_pvcName"></a>3.37.8. Property `stack > global > s3Storage > pvcName`
...
#### <a name="global_s3Storage_reclaimPolicy"></a>3.37.9. Property `stack > global > s3Storage > reclaimPolicy`
...
#### <a name="global_s3Storage_region"></a>3.37.10. Property `stack > global > s3Storage > region`
...
#### <a name="global_s3Storage_volumeAttributes"></a>3.37.11. Property `stack > global > s3Storage > volumeAttributes`
...
#### <a name="global_s3Storage_volumeHandle"></a>3.37.12. Property `stack > global > s3Storage > volumeHandle`
...
### <a name="global_securityContext"></a>3.38. Property `stack > global > securityContext`
...
### <a name="global_service"></a>3.39. Property `stack > global > service`
...
#### <a name="global_service_port"></a>3.39.1. Property `stack > global > service > port`
...
#### <a name="global_service_type"></a>3.39.2. Property `stack > global > service > type`
...
### <a name="global_serviceAccount"></a>3.40. Property `stack > global > serviceAccount`
...
#### <a name="global_serviceAccount_annotations"></a>3.40.1. Property `stack > global > serviceAccount > annotations`
...
#### <a name="global_serviceAccount_automount"></a>3.40.2. Property `stack > global > serviceAccount > automount`
...
#### <a name="global_serviceAccount_create"></a>3.40.3. Property `stack > global > serviceAccount > create`
...
#### <a name="global_serviceAccount_name"></a>3.40.4. Property `stack > global > serviceAccount > name`
...
### <a name="global_shareProcessNamespace"></a>3.41. Property `stack > global > shareProcessNamespace`
...
### <a name="global_sidecars"></a>3.42. Property `stack > global > sidecars`
...
### <a name="global_startupProbe"></a>3.43. Property `stack > global > startupProbe`
...
#### <a name="global_startupProbe_enabled"></a>3.43.1. Property `stack > global > startupProbe > enabled`
...
#### <a name="global_startupProbe_exec"></a>3.43.2. Property `stack > global > startupProbe > exec`
...
##### <a name="global_startupProbe_exec_command"></a>3.43.2.1. Property `stack > global > startupProbe > exec > command`
...
###### <a name="global_startupProbe_exec_command_items"></a>3.43.2.1.1. stack > global > startupProbe > exec > command > command items
...
#### <a name="global_startupProbe_failureThreshold"></a>3.43.3. Property `stack > global > startupProbe > failureThreshold`
...
#### <a name="global_startupProbe_initialDelaySeconds"></a>3.43.4. Property `stack > global > startupProbe > initialDelaySeconds`
...
#### <a name="global_startupProbe_periodSeconds"></a>3.43.5. Property `stack > global > startupProbe > periodSeconds`
...
#### <a name="global_startupProbe_successThreshold"></a>3.43.6. Property `stack > global > startupProbe > successThreshold`
...
#### <a name="global_startupProbe_timeoutSeconds"></a>3.43.7. Property `stack > global > startupProbe > timeoutSeconds`
...
### <a name="global_tolerations"></a>3.44. Property `stack > global > tolerations`
...
### <a name="global_topologySpreadConstraints"></a>3.45. Property `stack > global > topologySpreadConstraints`
...
### <a name="global_volumeMounts"></a>3.46. Property `stack > global > volumeMounts`
...
### <a name="global_volumes"></a>3.47. Property `stack > global > volumes`
...
#### <a name="cronJobs_pattern1_oidcProxyGateway"></a>4.1.26. Property `stack > cronJobs > ^.*$ > oidcProxyGateway`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_cookieDomain"></a>4.1.26.2. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > cookieDomain`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_cookieNames"></a>4.1.26.3. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > cookieNames`
...
###### <a name="cronJobs_pattern1_oidcProxyGateway_cookieNames_accessToken"></a>4.1.26.3.1. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > cookieNames > accessToken`
...
###### <a name="cronJobs_pattern1_oidcProxyGateway_cookieNames_idToken"></a>4.1.26.3.2. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > cookieNames > idToken`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_forwardAccessToken"></a>4.1.26.4. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > forwardAccessToken`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_logoutPath"></a>4.1.26.5. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > logoutPath`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_provider"></a>4.1.26.6. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > provider`
...
###### <a name="cronJobs_pattern1_oidcProxyGateway_provider_authorizationEndpoint"></a>4.1.26.6.1. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > provider > authorizationEndpoint`
...
###### <a name="cronJobs_pattern1_oidcProxyGateway_provider_issuer"></a>4.1.26.6.2. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > provider > issuer`
...
###### <a name="cronJobs_pattern1_oidcProxyGateway_provider_tokenEndpoint"></a>4.1.26.6.3. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > provider > tokenEndpoint`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_redirectURL"></a>4.1.26.7. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > redirectURL`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_refreshToken"></a>4.1.26.8. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > refreshToken`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_resources"></a>4.1.26.9. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > resources`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_scopes"></a>4.1.26.10. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > scopes`
...
###### <a name="cronJobs_pattern1_oidcProxyGateway_scopes_items"></a>4.1.26.10.1. stack > cronJobs > ^.*$ > oidcProxyGateway > scopes > scopes items
...
#### <a name="cronJobs_pattern1_persistence"></a>4.1.27. Property `stack > cronJobs > ^.*$ > persistence`
...
##### <a name="cronJobs_pattern1_persistence_enabled"></a>4.1.27.1. Property `stack > cronJobs > ^.*$ > persistence > enabled`
...
##### <a name="cronJobs_pattern1_persistence_existingClaim"></a>4.1.27.2. Property `stack > cronJobs > ^.*$ > persistence > existingClaim`
...
##### <a name="cronJobs_pattern1_persistence_mountPath"></a>4.1.27.3. Property `stack > cronJobs > ^.*$ > persistence > mountPath`
...
##### <a name="cronJobs_pattern1_persistence_pvc"></a>4.1.27.4. Property `stack > cronJobs > ^.*$ > persistence > pvc`
...
###### <a name="cronJobs_pattern1_persistence_pvc_accessModes"></a>4.1.27.4.1. Property `stack > cronJobs > ^.*$ > persistence > pvc > accessModes`
...
###### <a name="cronJobs_pattern1_persistence_pvc_accessModes_items"></a>4.1.27.4.1.1. stack > cronJobs > ^.*$ > persistence > pvc > accessModes > accessModes items
...
###### <a name="cronJobs_pattern1_persistence_pvc_dataSource"></a>4.1.27.4.2. Property `stack > cronJobs > ^.*$ > persistence > pvc > dataSource`
...
###### <a name="cronJobs_pattern1_persistence_pvc_dataSource_apiGroup"></a>4.1.27.4.2.1. Property `stack > cronJobs > ^.*$ > persistence > pvc > dataSource > apiGroup`
...
###### <a name="cronJobs_pattern1_persistence_pvc_dataSource_kind"></a>4.1.27.4.2.2. Property `stack > cronJobs > ^.*$ > persistence > pvc > dataSource > kind`
...
###### <a name="cronJobs_pattern1_persistence_pvc_dataSource_name"></a>4.1.27.4.2.3. Property `stack > cronJobs > ^.*$ > persistence > pvc > dataSource > name`
...
###### <a name="cronJobs_pattern1_persistence_pvc_resources"></a>4.1.27.4.3. Property `stack > cronJobs > ^.*$ > persistence > pvc > resources`
...
###### <a name="cronJobs_pattern1_persistence_pvc_resources_requests"></a>4.1.27.4.3.1. Property `stack > cronJobs > ^.*$ > persistence > pvc > resources > requests`
...
###### <a name="cronJobs_pattern1_persistence_pvc_resources_requests_storage"></a>4.1.27.4.3.1.1. Property `stack > cronJobs > ^.*$ > persistence > pvc > resources > requests > storage`
...
###### <a name="cronJobs_pattern1_persistence_pvc_storageClassName"></a>4.1.27.4.4. Property `stack > cronJobs > ^.*$ > persistence > pvc > storageClassName`
...
#### <a name="cronJobs_pattern1_podAnnotations"></a>4.1.28. Property `stack > cronJobs > ^.*$ > podAnnotations`
...
#### <a name="cronJobs_pattern1_podLabels"></a>4.1.29. Property `stack > cronJobs > ^.*$ > podLabels`
...
#### <a name="cronJobs_pattern1_podSecurityContext"></a>4.1.30. Property `stack > cronJobs > ^.*$ > podSecurityContext`
...
#### <a name="cronJobs_pattern1_progressDeadlineSeconds"></a>4.1.31. Property `stack > cronJobs > ^.*$ > progressDeadlineSeconds`
...
#### <a name="cronJobs_pattern1_readinessProbe"></a>4.1.32. Property `stack > cronJobs > ^.*$ > readinessProbe`
...
##### <a name="cronJobs_pattern1_readinessProbe_failureThreshold"></a>4.1.32.1. Property `stack > cronJobs > ^.*$ > readinessProbe > failureThreshold`
...
##### <a name="cronJobs_pattern1_readinessProbe_httpGet"></a>4.1.32.2. Property `stack > cronJobs > ^.*$ > readinessProbe > httpGet`
...
###### <a name="cronJobs_pattern1_readinessProbe_httpGet_path"></a>4.1.32.2.1. Property `stack > cronJobs > ^.*$ > readinessProbe > httpGet > path`
...
###### <a name="cronJobs_pattern1_readinessProbe_httpGet_port"></a>4.1.32.2.2. Property `stack > cronJobs > ^.*$ > readinessProbe > httpGet > port`
...
###### <a name="cronJobs_pattern1_readinessProbe_httpGet_port_oneOf_i0"></a>4.1.32.2.2.1. Property `stack > cronJobs > ^.*$ > readinessProbe > httpGet > port > oneOf > item 0`
...
###### <a name="cronJobs_pattern1_readinessProbe_httpGet_port_oneOf_i1"></a>4.1.32.2.2.2. Property `stack > cronJobs > ^.*$ > readinessProbe > httpGet > port > oneOf > item 1`
...
###### <a name="cronJobs_pattern1_readinessProbe_httpGet_scheme"></a>4.1.32.2.3. Property `stack > cronJobs > ^.*$ > readinessProbe > httpGet > scheme`
...
##### <a name="cronJobs_pattern1_readinessProbe_initialDelaySeconds"></a>4.1.32.3. Property `stack > cronJobs > ^.*$ > readinessProbe > initialDelaySeconds`
...
##### <a name="cronJobs_pattern1_readinessProbe_periodSeconds"></a>4.1.32.4. Property `stack > cronJobs > ^.*$ > readinessProbe > periodSeconds`
...
##### <a name="cronJobs_pattern1_readinessProbe_successThreshold"></a>4.1.32.5. Property `stack > cronJobs > ^.*$ > readinessProbe > successThreshold`
...
##### <a name="cronJobs_pattern1_readinessProbe_timeoutSeconds"></a>4.1.32.6. Property `stack > cronJobs > ^.*$ > readinessProbe > timeoutSeconds`
...
#### <a name="cronJobs_pattern1_replicaCount"></a>4.1.33. Property `stack > cronJobs > ^.*$ > replicaCount`
...
#### <a name="cronJobs_pattern1_resources"></a>4.1.34. Property `stack > cronJobs > ^.*$ > resources`
...
##### <a name="cronJobs_pattern1_resources_limits"></a>4.1.34.1. Property `stack > cronJobs > ^.*$ > resources > limits`
...
###### <a name="cronJobs_pattern1_resources_limits_cpu"></a>4.1.34.1.1. Property `stack > cronJobs > ^.*$ > resources > limits > cpu`
...
###### <a name="cronJobs_pattern1_resources_limits_cpu_oneOf_i0"></a>4.1.34.1.1.1. Property `stack > cronJobs > ^.*$ > resources > limits > cpu > oneOf > item 0`
...
###### <a name="cronJobs_pattern1_resources_limits_cpu_oneOf_i1"></a>4.1.34.1.1.2. Property `stack > cronJobs > ^.*$ > resources > limits > cpu > oneOf > item 1`
...
###### <a name="cronJobs_pattern1_resources_limits_memory"></a>4.1.34.1.2. Property `stack > cronJobs > ^.*$ > resources > limits > memory`
...
##### <a name="cronJobs_pattern1_resources_requests"></a>4.1.34.2. Property `stack > cronJobs > ^.*$ > resources > requests`
...
###### <a name="cronJobs_pattern1_resources_requests_cpu"></a>4.1.34.2.1. Property `stack > cronJobs > ^.*$ > resources > requests > cpu`
...
###### <a name="cronJobs_pattern1_resources_requests_cpu_oneOf_i0"></a>4.1.34.2.1.1. Property `stack > cronJobs > ^.*$ > resources > requests > cpu > oneOf > item 0`
...
###### <a name="cronJobs_pattern1_resources_requests_cpu_oneOf_i1"></a>4.1.34.2.1.2. Property `stack > cronJobs > ^.*$ > resources > requests > cpu > oneOf > item 1`
...
###### <a name="cronJobs_pattern1_resources_requests_memory"></a>4.1.34.2.2. Property `stack > cronJobs > ^.*$ > resources > requests > memory`
...
#### <a name="cronJobs_pattern1_restartPolicy"></a>4.1.35. Property `stack > cronJobs > ^.*$ > restartPolicy`
...
#### <a name="cronJobs_pattern1_rollout"></a>4.1.36. Property `stack > cronJobs > ^.*$ > rollout`
...
##### <a name="cronJobs_pattern1_rollout_strategy"></a>4.1.36.1. Property `stack > cronJobs > ^.*$ > rollout > strategy`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen"></a>4.1.36.1.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_activeService"></a>4.1.36.1.1.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > activeService`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_autoPromotionEnabled"></a>4.1.36.1.1.2. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > autoPromotionEnabled`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis"></a>4.1.36.1.1.3. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_analysisRunMetadata"></a>4.1.36.1.1.3.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > analysisRunMetadata`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_analysisRunMetadata_annotations"></a>4.1.36.1.1.3.1.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > analysisRunMetadata > annotations`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_analysisRunMetadata_labels"></a>4.1.36.1.1.3.1.2. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > analysisRunMetadata > labels`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args"></a>4.1.36.1.1.3.2. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args_items"></a>4.1.36.1.1.3.2.1. stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args > args items
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args_items_name"></a>4.1.36.1.1.3.2.1.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args > args items > name`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args_items_value"></a>4.1.36.1.1.3.2.1.2. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args > args items > value`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args_items_valueFrom"></a>4.1.36.1.1.3.2.1.3. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args > args items > valueFrom`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args_items_valueFrom_fieldRef"></a>4.1.36.1.1.3.2.1.3.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args > args items > valueFrom > fieldRef`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args_items_valueFrom_fieldRef_fieldPath"></a>4.1.36.1.1.3.2.1.3.1.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args > args items > valueFrom > fieldRef > fieldPath`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args_items_valueFrom_podTemplateHashValue"></a>4.1.36.1.1.3.2.1.3.2. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args > args items > valueFrom > podTemplateHashValue`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_templates"></a>4.1.36.1.1.3.3. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > templates`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_templates_items"></a>4.1.36.1.1.3.3.1. stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > templates > templates items
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_templates_items_clusterScope"></a>4.1.36.1.1.3.3.1.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > templates > templates items > clusterScope`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_templates_items_templateName"></a>4.1.36.1.1.3.3.1.2. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > templates > templates items > templateName`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_previewService"></a>4.1.36.1.1.4. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > previewService`
...
#### <a name="cronJobs_pattern1_s3Storage"></a>4.1.37. Property `stack > cronJobs > ^.*$ > s3Storage`
...
##### <a name="cronJobs_pattern1_s3Storage_accessModes"></a>4.1.37.1. Property `stack > cronJobs > ^.*$ > s3Storage > accessModes`
...
###### <a name="cronJobs_pattern1_s3Storage_accessModes_items"></a>4.1.37.1.1. stack > cronJobs > ^.*$ > s3Storage > accessModes > accessModes items
...
##### <a name="cronJobs_pattern1_s3Storage_annotations"></a>4.1.37.2. Property `stack > cronJobs > ^.*$ > s3Storage > annotations`
...
##### <a name="cronJobs_pattern1_s3Storage_bucketName"></a>4.1.37.3. Property `stack > cronJobs > ^.*$ > s3Storage > bucketName`
...
##### <a name="cronJobs_pattern1_s3Storage_capacity"></a>4.1.37.4. Property `stack > cronJobs > ^.*$ > s3Storage > capacity`
...
##### <a name="cronJobs_pattern1_s3Storage_enabled"></a>4.1.37.5. Property `stack > cronJobs > ^.*$ > s3Storage > enabled`
...
##### <a name="cronJobs_pattern1_s3Storage_labels"></a>4.1.37.6. Property `stack > cronJobs > ^.*$ > s3Storage > labels`
...
##### <a name="cronJobs_pattern1_s3Storage_pvName"></a>4.1.37.7. Property `stack > cronJobs > ^.*$ > s3Storage > pvName`
...
##### <a name="cronJobs_pattern1_s3Storage_pvcName"></a>4.1.37.8. Property `stack > cronJobs > ^.*$ > s3Storage > pvcName`
...
##### <a name="cronJobs_pattern1_s3Storage_reclaimPolicy"></a>4.1.37.9. Property `stack > cronJobs > ^.*$ > s3Storage > reclaimPolicy`
...
##### <a name="cronJobs_pattern1_s3Storage_region"></a>4.1.37.10. Property `stack > cronJobs > ^.*$ > s3Storage > region`
...
##### <a name="cronJobs_pattern1_s3Storage_volumeAttributes"></a>4.1.37.11. Property `stack > cronJobs > ^.*$ > s3Storage > volumeAttributes`
...
##### <a name="cronJobs_pattern1_s3Storage_volumeHandle"></a>4.1.37.12. Property `stack > cronJobs > ^.*$ > s3Storage > volumeHandle`
...
#### <a name="cronJobs_pattern1_securityContext"></a>4.1.38. Property `stack > cronJobs > ^.*$ > securityContext`
...
#### <a name="cronJobs_pattern1_service"></a>4.1.39. Property `stack > cronJobs > ^.*$ > service`
...
##### <a name="cronJobs_pattern1_service_port"></a>4.1.39.1. Property `stack > cronJobs > ^.*$ > service > port`
...
##### <a name="cronJobs_pattern1_service_type"></a>4.1.39.2. Property `stack > cronJobs > ^.*$ > service > type`
...
#### <a name="cronJobs_pattern1_serviceAccount"></a>4.1.40. Property `stack > cronJobs > ^.*$ > serviceAccount`
...
##### <a name="cronJobs_pattern1_serviceAccount_annotations"></a>4.1.40.1. Property `stack > cronJobs > ^.*$ > serviceAccount > annotations`
...
##### <a name="cronJobs_pattern1_serviceAccount_automount"></a>4.1.40.2. Property `stack > cronJobs > ^.*$ > serviceAccount > automount`
...
##### <a name="cronJobs_pattern1_serviceAccount_create"></a>4.1.40.3. Property `stack > cronJobs > ^.*$ > serviceAccount > create`
...
##### <a name="cronJobs_pattern1_serviceAccount_name"></a>4.1.40.4. Property `stack > cronJobs > ^.*$ > serviceAccount > name`
...
#### <a name="cronJobs_pattern1_shareProcessNamespace"></a>4.1.41. Property `stack > cronJobs > ^.*$ > shareProcessNamespace`
...
#### <a name="cronJobs_pattern1_sidecars"></a>4.1.42. Property `stack > cronJobs > ^.*$ > sidecars`
...
#### <a name="cronJobs_pattern1_startupProbe"></a>4.1.43. Property `stack > cronJobs > ^.*$ > startupProbe`
...
##### <a name="cronJobs_pattern1_startupProbe_enabled"></a>4.1.43.1. Property `stack > cronJobs > ^.*$ > startupProbe > enabled`
...
##### <a name="cronJobs_pattern1_startupProbe_exec"></a>4.1.43.2. Property `stack > cronJobs > ^.*$ > startupProbe > exec`
...
###### <a name="cronJobs_pattern1_startupProbe_exec_command"></a>4.1.43.2.1. Property `stack > cronJobs > ^.*$ > startupProbe > exec > command`
...
###### <a name="cronJobs_pattern1_startupProbe_exec_command_items"></a>4.1.43.2.1.1. stack > cronJobs > ^.*$ > startupProbe > exec > command > command items
...
##### <a name="cronJobs_pattern1_startupProbe_failureThreshold"></a>4.1.43.3. Property `stack > cronJobs > ^.*$ > startupProbe > failureThreshold`
...
##### <a name="cronJobs_pattern1_startupProbe_initialDelaySeconds"></a>4.1.43.4. Property `stack > cronJobs > ^.*$ > startupProbe > initialDelaySeconds`
...
##### <a name="cronJobs_pattern1_startupProbe_periodSeconds"></a>4.1.43.5. Property `stack > cronJobs > ^.*$ > startupProbe > periodSeconds`
...
##### <a name="cronJobs_pattern1_startupProbe_successThreshold"></a>4.1.43.6. Property `stack > cronJobs > ^.*$ > startupProbe > successThreshold`
...
##### <a name="cronJobs_pattern1_startupProbe_timeoutSeconds"></a>4.1.43.7. Property `stack > cronJobs > ^.*$ > startupProbe > timeoutSeconds`
...
#### <a name="cronJobs_pattern1_tolerations"></a>4.1.44. Property `stack > cronJobs > ^.*$ > tolerations`
...
#### <a name="cronJobs_pattern1_topologySpreadConstraints"></a>4.1.45. Property `stack > cronJobs > ^.*$ > topologySpreadConstraints`
...
#### <a name="cronJobs_pattern1_volumeMounts"></a>4.1.46. Property `stack > cronJobs > ^.*$ > volumeMounts`
...
#### <a name="cronJobs_pattern1_volumes"></a>4.1.47. Property `stack > cronJobs > ^.*$ > volumes`
...
#### <a name="cronJobs_pattern1_oidcProxyGateway"></a>7.1.26. Property `stack > cronJobs > ^.*$ > oidcProxyGateway`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_cookieDomain"></a>7.1.26.2. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > cookieDomain`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_cookieNames"></a>7.1.26.3. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > cookieNames`
...
###### <a name="cronJobs_pattern1_oidcProxyGateway_cookieNames_accessToken"></a>7.1.26.3.1. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > cookieNames > accessToken`
...
###### <a name="cronJobs_pattern1_oidcProxyGateway_cookieNames_idToken"></a>7.1.26.3.2. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > cookieNames > idToken`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_forwardAccessToken"></a>7.1.26.4. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > forwardAccessToken`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_logoutPath"></a>7.1.26.5. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > logoutPath`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_provider"></a>7.1.26.6. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > provider`
...
###### <a name="cronJobs_pattern1_oidcProxyGateway_provider_authorizationEndpoint"></a>7.1.26.6.1. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > provider > authorizationEndpoint`
...
###### <a name="cronJobs_pattern1_oidcProxyGateway_provider_issuer"></a>7.1.26.6.2. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > provider > issuer`
...
###### <a name="cronJobs_pattern1_oidcProxyGateway_provider_tokenEndpoint"></a>7.1.26.6.3. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > provider > tokenEndpoint`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_redirectURL"></a>7.1.26.7. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > redirectURL`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_refreshToken"></a>7.1.26.8. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > refreshToken`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_resources"></a>7.1.26.9. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > resources`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_scopes"></a>7.1.26.10. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > scopes`
...
###### <a name="cronJobs_pattern1_oidcProxyGateway_scopes_items"></a>7.1.26.10.1. stack > cronJobs > ^.*$ > oidcProxyGateway > scopes > scopes items
...
#### <a name="cronJobs_pattern1_persistence"></a>7.1.27. Property `stack > cronJobs > ^.*$ > persistence`
...
##### <a name="cronJobs_pattern1_persistence_enabled"></a>7.1.27.1. Property `stack > cronJobs > ^.*$ > persistence > enabled`
...
##### <a name="cronJobs_pattern1_persistence_existingClaim"></a>7.1.27.2. Property `stack > cronJobs > ^.*$ > persistence > existingClaim`
...
##### <a name="cronJobs_pattern1_persistence_mountPath"></a>7.1.27.3. Property `stack > cronJobs > ^.*$ > persistence > mountPath`
...
##### <a name="cronJobs_pattern1_persistence_pvc"></a>7.1.27.4. Property `stack > cronJobs > ^.*$ > persistence > pvc`
...
###### <a name="cronJobs_pattern1_persistence_pvc_accessModes"></a>7.1.27.4.1. Property `stack > cronJobs > ^.*$ > persistence > pvc > accessModes`
...
###### <a name="cronJobs_pattern1_persistence_pvc_accessModes_items"></a>7.1.27.4.1.1. stack > cronJobs > ^.*$ > persistence > pvc > accessModes > accessModes items
...
###### <a name="cronJobs_pattern1_persistence_pvc_dataSource"></a>7.1.27.4.2. Property `stack > cronJobs > ^.*$ > persistence > pvc > dataSource`
...
###### <a name="cronJobs_pattern1_persistence_pvc_dataSource_apiGroup"></a>7.1.27.4.2.1. Property `stack > cronJobs > ^.*$ > persistence > pvc > dataSource > apiGroup`
...
###### <a name="cronJobs_pattern1_persistence_pvc_dataSource_kind"></a>7.1.27.4.2.2. Property `stack > cronJobs > ^.*$ > persistence > pvc > dataSource > kind`
...
###### <a name="cronJobs_pattern1_persistence_pvc_dataSource_name"></a>7.1.27.4.2.3. Property `stack > cronJobs > ^.*$ > persistence > pvc > dataSource > name`
...
###### <a name="cronJobs_pattern1_persistence_pvc_resources"></a>7.1.27.4.3. Property `stack > cronJobs > ^.*$ > persistence > pvc > resources`
...
###### <a name="cronJobs_pattern1_persistence_pvc_resources_requests"></a>7.1.27.4.3.1. Property `stack > cronJobs > ^.*$ > persistence > pvc > resources > requests`
...
###### <a name="cronJobs_pattern1_persistence_pvc_resources_requests_storage"></a>7.1.27.4.3.1.1. Property `stack > cronJobs > ^.*$ > persistence > pvc > resources > requests > storage`
...
###### <a name="cronJobs_pattern1_persistence_pvc_storageClassName"></a>7.1.27.4.4. Property `stack > cronJobs > ^.*$ > persistence > pvc > storageClassName`
...
#### <a name="cronJobs_pattern1_podAnnotations"></a>7.1.28. Property `stack > cronJobs > ^.*$ > podAnnotations`
...
#### <a name="cronJobs_pattern1_podLabels"></a>7.1.29. Property `stack > cronJobs > ^.*$ > podLabels`
...
#### <a name="cronJobs_pattern1_podSecurityContext"></a>7.1.30. Property `stack > cronJobs > ^.*$ > podSecurityContext`
...
#### <a name="cronJobs_pattern1_progressDeadlineSeconds"></a>7.1.31. Property `stack > cronJobs > ^.*$ > progressDeadlineSeconds`
...
#### <a name="cronJobs_pattern1_readinessProbe"></a>7.1.32. Property `stack > cronJobs > ^.*$ > readinessProbe`
...
##### <a name="cronJobs_pattern1_readinessProbe_failureThreshold"></a>7.1.32.1. Property `stack > cronJobs > ^.*$ > readinessProbe > failureThreshold`
...
##### <a name="cronJobs_pattern1_readinessProbe_httpGet"></a>7.1.32.2. Property `stack > cronJobs > ^.*$ > readinessProbe > httpGet`
...
###### <a name="cronJobs_pattern1_readinessProbe_httpGet_path"></a>7.1.32.2.1. Property `stack > cronJobs > ^.*$ > readinessProbe > httpGet > path`
...
###### <a name="cronJobs_pattern1_readinessProbe_httpGet_port"></a>7.1.32.2.2. Property `stack > cronJobs > ^.*$ > readinessProbe > httpGet > port`
...
###### <a name="cronJobs_pattern1_readinessProbe_httpGet_port_oneOf_i0"></a>7.1.32.2.2.1. Property `stack > cronJobs > ^.*$ > readinessProbe > httpGet > port > oneOf > item 0`
...
###### <a name="cronJobs_pattern1_readinessProbe_httpGet_port_oneOf_i1"></a>7.1.32.2.2.2. Property `stack > cronJobs > ^.*$ > readinessProbe > httpGet > port > oneOf > item 1`
...
###### <a name="cronJobs_pattern1_readinessProbe_httpGet_scheme"></a>7.1.32.2.3. Property `stack > cronJobs > ^.*$ > readinessProbe > httpGet > scheme`
...
##### <a name="cronJobs_pattern1_readinessProbe_initialDelaySeconds"></a>7.1.32.3. Property `stack > cronJobs > ^.*$ > readinessProbe > initialDelaySeconds`
...
##### <a name="cronJobs_pattern1_readinessProbe_periodSeconds"></a>7.1.32.4. Property `stack > cronJobs > ^.*$ > readinessProbe > periodSeconds`
...
##### <a name="cronJobs_pattern1_readinessProbe_successThreshold"></a>7.1.32.5. Property `stack > cronJobs > ^.*$ > readinessProbe > successThreshold`
...
##### <a name="cronJobs_pattern1_readinessProbe_timeoutSeconds"></a>7.1.32.6. Property `stack > cronJobs > ^.*$ > readinessProbe > timeoutSeconds`
...
#### <a name="cronJobs_pattern1_replicaCount"></a>7.1.33. Property `stack > cronJobs > ^.*$ > replicaCount`
...
#### <a name="cronJobs_pattern1_resources"></a>7.1.34. Property `stack > cronJobs > ^.*$ > resources`
...
##### <a name="cronJobs_pattern1_resources_limits"></a>7.1.34.1. Property `stack > cronJobs > ^.*$ > resources > limits`
...
###### <a name="cronJobs_pattern1_resources_limits_cpu"></a>7.1.34.1.1. Property `stack > cronJobs > ^.*$ > resources > limits > cpu`
...
###### <a name="cronJobs_pattern1_resources_limits_cpu_oneOf_i0"></a>7.1.34.1.1.1. Property `stack > cronJobs > ^.*$ > resources > limits > cpu > oneOf > item 0`
...
###### <a name="cronJobs_pattern1_resources_limits_cpu_oneOf_i1"></a>7.1.34.1.1.2. Property `stack > cronJobs > ^.*$ > resources > limits > cpu > oneOf > item 1`
...
###### <a name="cronJobs_pattern1_resources_limits_memory"></a>7.1.34.1.2. Property `stack > cronJobs > ^.*$ > resources > limits > memory`
...
##### <a name="cronJobs_pattern1_resources_requests"></a>7.1.34.2. Property `stack > cronJobs > ^.*$ > resources > requests`
...
###### <a name="cronJobs_pattern1_resources_requests_cpu"></a>7.1.34.2.1. Property `stack > cronJobs > ^.*$ > resources > requests > cpu`
...
###### <a name="cronJobs_pattern1_resources_requests_cpu_oneOf_i0"></a>7.1.34.2.1.1. Property `stack > cronJobs > ^.*$ > resources > requests > cpu > oneOf > item 0`
...
###### <a name="cronJobs_pattern1_resources_requests_cpu_oneOf_i1"></a>7.1.34.2.1.2. Property `stack > cronJobs > ^.*$ > resources > requests > cpu > oneOf > item 1`
...
###### <a name="cronJobs_pattern1_resources_requests_memory"></a>7.1.34.2.2. Property `stack > cronJobs > ^.*$ > resources > requests > memory`
...
#### <a name="cronJobs_pattern1_restartPolicy"></a>7.1.35. Property `stack > cronJobs > ^.*$ > restartPolicy`
...
#### <a name="cronJobs_pattern1_rollout"></a>7.1.36. Property `stack > cronJobs > ^.*$ > rollout`
...
##### <a name="cronJobs_pattern1_rollout_strategy"></a>7.1.36.1. Property `stack > cronJobs > ^.*$ > rollout > strategy`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen"></a>7.1.36.1.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_activeService"></a>7.1.36.1.1.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > activeService`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_autoPromotionEnabled"></a>7.1.36.1.1.2. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > autoPromotionEnabled`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis"></a>7.1.36.1.1.3. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_analysisRunMetadata"></a>7.1.36.1.1.3.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > analysisRunMetadata`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_analysisRunMetadata_annotations"></a>7.1.36.1.1.3.1.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > analysisRunMetadata > annotations`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_analysisRunMetadata_labels"></a>7.1.36.1.1.3.1.2. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > analysisRunMetadata > labels`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args"></a>7.1.36.1.1.3.2. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args_items"></a>7.1.36.1.1.3.2.1. stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args > args items
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args_items_name"></a>7.1.36.1.1.3.2.1.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args > args items > name`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args_items_value"></a>7.1.36.1.1.3.2.1.2. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args > args items > value`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args_items_valueFrom"></a>7.1.36.1.1.3.2.1.3. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args > args items > valueFrom`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args_items_valueFrom_fieldRef"></a>7.1.36.1.1.3.2.1.3.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args > args items > valueFrom > fieldRef`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args_items_valueFrom_fieldRef_fieldPath"></a>7.1.36.1.1.3.2.1.3.1.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args > args items > valueFrom > fieldRef > fieldPath`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_args_items_valueFrom_podTemplateHashValue"></a>7.1.36.1.1.3.2.1.3.2. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > args > args items > valueFrom > podTemplateHashValue`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_templates"></a>7.1.36.1.1.3.3. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > templates`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_templates_items"></a>7.1.36.1.1.3.3.1. stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > templates > templates items
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_templates_items_clusterScope"></a>7.1.36.1.1.3.3.1.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > templates > templates items > clusterScope`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_prePromotionAnalysis_templates_items_templateName"></a>7.1.36.1.1.3.3.1.2. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > prePromotionAnalysis > templates > templates items > templateName`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_previewService"></a>7.1.36.1.1.4. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > previewService`
...
#### <a name="cronJobs_pattern1_s3Storage"></a>7.1.37. Property `stack > cronJobs > ^.*$ > s3Storage`
...
##### <a name="cronJobs_pattern1_s3Storage_accessModes"></a>7.1.37.1. Property `stack > cronJobs > ^.*$ > s3Storage > accessModes`
...
###### <a name="cronJobs_pattern1_s3Storage_accessModes_items"></a>7.1.37.1.1. stack > cronJobs > ^.*$ > s3Storage > accessModes > accessModes items
...
##### <a name="cronJobs_pattern1_s3Storage_annotations"></a>7.1.37.2. Property `stack > cronJobs > ^.*$ > s3Storage > annotations`
...
##### <a name="cronJobs_pattern1_s3Storage_bucketName"></a>7.1.37.3. Property `stack > cronJobs > ^.*$ > s3Storage > bucketName`
...
##### <a name="cronJobs_pattern1_s3Storage_capacity"></a>7.1.37.4. Property `stack > cronJobs > ^.*$ > s3Storage > capacity`
...
##### <a name="cronJobs_pattern1_s3Storage_enabled"></a>7.1.37.5. Property `stack > cronJobs > ^.*$ > s3Storage > enabled`
...
##### <a name="cronJobs_pattern1_s3Storage_labels"></a>7.1.37.6. Property `stack > cronJobs > ^.*$ > s3Storage > labels`
...
##### <a name="cronJobs_pattern1_s3Storage_pvName"></a>7.1.37.7. Property `stack > cronJobs > ^.*$ > s3Storage > pvName`
...
##### <a name="cronJobs_pattern1_s3Storage_pvcName"></a>7.1.37.8. Property `stack > cronJobs > ^.*$ > s3Storage > pvcName`
...
##### <a name="cronJobs_pattern1_s3Storage_reclaimPolicy"></a>7.1.37.9. Property `stack > cronJobs > ^.*$ > s3Storage > reclaimPolicy`
...
##### <a name="cronJobs_pattern1_s3Storage_region"></a>7.1.37.10. Property `stack > cronJobs > ^.*$ > s3Storage > region`
...
##### <a name="cronJobs_pattern1_s3Storage_volumeAttributes"></a>7.1.37.11. Property `stack > cronJobs > ^.*$ > s3Storage > volumeAttributes`
...
##### <a name="cronJobs_pattern1_s3Storage_volumeHandle"></a>7.1.37.12. Property `stack > cronJobs > ^.*$ > s3Storage > volumeHandle`
...
#### <a name="cronJobs_pattern1_securityContext"></a>7.1.38. Property `stack > cronJobs > ^.*$ > securityContext`
...
#### <a name="cronJobs_pattern1_service"></a>7.1.39. Property `stack > cronJobs > ^.*$ > service`
...
##### <a name="cronJobs_pattern1_service_port"></a>7.1.39.1. Property `stack > cronJobs > ^.*$ > service > port`
...
##### <a name="cronJobs_pattern1_service_type"></a>7.1.39.2. Property `stack > cronJobs > ^.*$ > service > type`
...
#### <a name="cronJobs_pattern1_serviceAccount"></a>7.1.40. Property `stack > cronJobs > ^.*$ > serviceAccount`
...
##### <a name="cronJobs_pattern1_serviceAccount_annotations"></a>7.1.40.1. Property `stack > cronJobs > ^.*$ > serviceAccount > annotations`
...
##### <a name="cronJobs_pattern1_serviceAccount_automount"></a>7.1.40.2. Property `stack > cronJobs > ^.*$ > serviceAccount > automount`
...
##### <a name="cronJobs_pattern1_serviceAccount_create"></a>7.1.40.3. Property `stack > cronJobs > ^.*$ > serviceAccount > create`
...
##### <a name="cronJobs_pattern1_serviceAccount_name"></a>7.1.40.4. Property `stack > cronJobs > ^.*$ > serviceAccount > name`
...
#### <a name="cronJobs_pattern1_shareProcessNamespace"></a>7.1.41. Property `stack > cronJobs > ^.*$ > shareProcessNamespace`
...
#### <a name="cronJobs_pattern1_sidecars"></a>7.1.42. Property `stack > cronJobs > ^.*$ > sidecars`
...
#### <a name="cronJobs_pattern1_startupProbe"></a>7.1.43. Property `stack > cronJobs > ^.*$ > startupProbe`
...
##### <a name="cronJobs_pattern1_startupProbe_enabled"></a>7.1.43.1. Property `stack > cronJobs > ^.*$ > startupProbe > enabled`
...
##### <a name="cronJobs_pattern1_startupProbe_exec"></a>7.1.43.2. Property `stack > cronJobs > ^.*$ > startupProbe > exec`
...
###### <a name="cronJobs_pattern1_startupProbe_exec_command"></a>7.1.43.2.1. Property `stack > cronJobs > ^.*$ > startupProbe > exec > command`
...
###### <a name="cronJobs_pattern1_startupProbe_exec_command_items"></a>7.1.43.2.1.1. stack > cronJobs > ^.*$ > startupProbe > exec > command > command items
...
##### <a name="cronJobs_pattern1_startupProbe_failureThreshold"></a>7.1.43.3. Property `stack > cronJobs > ^.*$ > startupProbe > failureThreshold`
...
##### <a name="cronJobs_pattern1_startupProbe_initialDelaySeconds"></a>7.1.43.4. Property `stack > cronJobs > ^.*$ > startupProbe > initialDelaySeconds`
...
##### <a name="cronJobs_pattern1_startupProbe_periodSeconds"></a>7.1.43.5. Property `stack > cronJobs > ^.*$ > startupProbe > periodSeconds`
...
##### <a name="cronJobs_pattern1_startupProbe_successThreshold"></a>7.1.43.6. Property `stack > cronJobs > ^.*$ > startupProbe > successThreshold`
...
##### <a name="cronJobs_pattern1_startupProbe_timeoutSeconds"></a>7.1.43.7. Property `stack > cronJobs > ^.*$ > startupProbe > timeoutSeconds`
...
#### <a name="cronJobs_pattern1_tolerations"></a>7.1.44. Property `stack > cronJobs > ^.*$ > tolerations`
...
#### <a name="cronJobs_pattern1_topologySpreadConstraints"></a>7.1.45. Property `stack > cronJobs > ^.*$ > topologySpreadConstraints`
...
#### <a name="cronJobs_pattern1_volumeMounts"></a>7.1.46. Property `stack > cronJobs > ^.*$ > volumeMounts`
...
#### <a name="cronJobs_pattern1_volumes"></a>7.1.47. Property `stack > cronJobs > ^.*$ > volumes`
