...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_job_spec"></a>2.1.31.3.3.1.8.6.1. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > provider > job > spec`
...
| Property                                                                                                | Pattern | Type   | Deprecated | Definition | Title/Description |
| ------------------------------------------------------------------------------------------------------- | ------- | ------ | ---------- | ---------- | ----------------- |
| - [](#cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_job_spec_additionalProperties ) | No      | object | No         | -          | -                 |

###### <a name="cronJobs_pattern1_rollout_analysisTemplate_enableDefaultMetrics"></a>2.1.31.3.4. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > enableDefaultMetrics`
...
**Description:** Configuration for the Grafana Dashboard to be deployed for the Rollout.

| Property                                                          | Pattern | Type    | Deprecated | Definition | Title/Description                                                                |
| ----------------------------------------------------------------- | ------- | ------- | ---------- | ---------- | -------------------------------------------------------------------------------- |
| - [enabled](#cronJobs_pattern1_rollout_grafanaDashboard_enabled ) | No      | boolean | No         | -          | Enable or disable deployment of the Grafana Dashboard for this Rollout.          |
| - [name](#cronJobs_pattern1_rollout_grafanaDashboard_name )       | No      | string  | No         | -          | Override the name of the Grafana Dashboard resource.                             |
| - [folder](#cronJobs_pattern1_rollout_grafanaDashboard_folder )   | No      | string  | No         | -          | The Grafana folder where the dashboard should be placed. Defaults to 'Rollouts'. |

###### <a name="cronJobs_pattern1_rollout_grafanaDashboard_enabled"></a>2.1.31.4.1. Property `stack > cronJobs > ^.*$ > rollout > grafanaDashboard > enabled`
...
**Description:** Enable or disable deployment of the Grafana Dashboard for this Rollout.

###### <a name="cronJobs_pattern1_rollout_grafanaDashboard_name"></a>2.1.31.4.2. Property `stack > cronJobs > ^.*$ > rollout > grafanaDashboard > name`
...
**Description:** Override the name of the Grafana Dashboard resource.

###### <a name="cronJobs_pattern1_rollout_grafanaDashboard_folder"></a>2.1.31.4.3. Property `stack > cronJobs > ^.*$ > rollout > grafanaDashboard > folder`
...
**Description:** The Grafana folder where the dashboard should be placed. Defaults to 'Rollouts'.

#### <a name="cronJobs_pattern1_securityContext"></a>2.1.32. Property `stack > cronJobs > ^.*$ > securityContext`
...
#### <a name="cronJobs_pattern1_service"></a>2.1.33. Property `stack > cronJobs > ^.*$ > service`
...
##### <a name="cronJobs_pattern1_service_port"></a>2.1.33.1. Property `stack > cronJobs > ^.*$ > service > port`
...
##### <a name="cronJobs_pattern1_service_type"></a>2.1.33.2. Property `stack > cronJobs > ^.*$ > service > type`
...
#### <a name="cronJobs_pattern1_serviceAccount"></a>2.1.34. Property `stack > cronJobs > ^.*$ > serviceAccount`
...
##### <a name="cronJobs_pattern1_serviceAccount_annotations"></a>2.1.34.1. Property `stack > cronJobs > ^.*$ > serviceAccount > annotations`
...
##### <a name="cronJobs_pattern1_serviceAccount_automount"></a>2.1.34.2. Property `stack > cronJobs > ^.*$ > serviceAccount > automount`
...
##### <a name="cronJobs_pattern1_serviceAccount_create"></a>2.1.34.3. Property `stack > cronJobs > ^.*$ > serviceAccount > create`
...
##### <a name="cronJobs_pattern1_serviceAccount_name"></a>2.1.34.4. Property `stack > cronJobs > ^.*$ > serviceAccount > name`
...
#### <a name="cronJobs_pattern1_shareProcessNamespace"></a>2.1.35. Property `stack > cronJobs > ^.*$ > shareProcessNamespace`
...
#### <a name="cronJobs_pattern1_sidecars"></a>2.1.36. Property `stack > cronJobs > ^.*$ > sidecars`
...
#### <a name="cronJobs_pattern1_startupProbe"></a>2.1.37. Property `stack > cronJobs > ^.*$ > startupProbe`
...
##### <a name="cronJobs_pattern1_startupProbe_enabled"></a>2.1.37.1. Property `stack > cronJobs > ^.*$ > startupProbe > enabled`
...
##### <a name="cronJobs_pattern1_startupProbe_exec"></a>2.1.37.2. Property `stack > cronJobs > ^.*$ > startupProbe > exec`
...
###### <a name="cronJobs_pattern1_startupProbe_exec_command"></a>2.1.37.2.1. Property `stack > cronJobs > ^.*$ > startupProbe > exec > command`
...
###### <a name="cronJobs_pattern1_startupProbe_exec_command_items"></a>2.1.37.2.1.1. stack > cronJobs > ^.*$ > startupProbe > exec > command > command items
...
##### <a name="cronJobs_pattern1_startupProbe_failureThreshold"></a>2.1.37.3. Property `stack > cronJobs > ^.*$ > startupProbe > failureThreshold`
...
##### <a name="cronJobs_pattern1_startupProbe_initialDelaySeconds"></a>2.1.37.4. Property `stack > cronJobs > ^.*$ > startupProbe > initialDelaySeconds`
...
##### <a name="cronJobs_pattern1_startupProbe_periodSeconds"></a>2.1.37.5. Property `stack > cronJobs > ^.*$ > startupProbe > periodSeconds`
...
##### <a name="cronJobs_pattern1_startupProbe_successThreshold"></a>2.1.37.6. Property `stack > cronJobs > ^.*$ > startupProbe > successThreshold`
...
##### <a name="cronJobs_pattern1_startupProbe_timeoutSeconds"></a>2.1.37.7. Property `stack > cronJobs > ^.*$ > startupProbe > timeoutSeconds`
...
#### <a name="cronJobs_pattern1_tolerations"></a>2.1.38. Property `stack > cronJobs > ^.*$ > tolerations`
...
#### <a name="cronJobs_pattern1_topologySpreadConstraints"></a>2.1.39. Property `stack > cronJobs > ^.*$ > topologySpreadConstraints`
...
#### <a name="cronJobs_pattern1_volumeMounts"></a>2.1.40. Property `stack > cronJobs > ^.*$ > volumeMounts`
...
#### <a name="cronJobs_pattern1_volumes"></a>2.1.41. Property `stack > cronJobs > ^.*$ > volumes`
...
| - [rollout](#global_rollout )                                     | No      | object           | No         | -          | Argo Rollouts specific configuration, only applicable when deploymentKind is 'Rollout'.                                                     |
...
##### <a name="global_persistence_pvc_resources"></a>3.22.4.2. Property `stack > global > persistence > pvc > resources`
...
###### <a name="global_persistence_pvc_resources_requests"></a>3.22.4.2.1. Property `stack > global > persistence > pvc > resources > requests`
...
###### <a name="global_persistence_pvc_resources_requests_storage"></a>3.22.4.2.1.1. Property `stack > global > persistence > pvc > resources > requests > storage`
...
##### <a name="global_persistence_pvc_storageClassName"></a>3.22.4.3. Property `stack > global > persistence > pvc > storageClassName`
...
| Property                                                      | Pattern | Type   | Deprecated | Definition | Title/Description                                                              |
| ------------------------------------------------------------- | ------- | ------ | ---------- | ---------- | ------------------------------------------------------------------------------ |
| - [strategy](#global_rollout_strategy )                       | No      | object | No         | -          | -                                                                              |
| - [analysisRunMetadata](#global_rollout_analysisRunMetadata ) | No      | object | No         | -          | Metadata (labels/annotations) to attach to the generated AnalysisRun resource. |
| - [analysisTemplate](#global_rollout_analysisTemplate )       | No      | object | No         | -          | Configuration for the AnalysisTemplate generated by this chart.                |
| - [grafanaDashboard](#global_rollout_grafanaDashboard )       | No      | object | No         | -          | Configuration for the Grafana Dashboard to be deployed for the Rollout.        |

#### <a name="global_rollout_strategy"></a>3.31.1. Property `stack > global > rollout > strategy`
...
| Property                                           | Pattern | Type   | Deprecated | Definition | Title/Description |
| -------------------------------------------------- | ------- | ------ | ---------- | ---------- | ----------------- |
| - [blueGreen](#global_rollout_strategy_blueGreen ) | No      | object | No         | -          | -                 |
| - [canary](#global_rollout_strategy_canary )       | No      | object | No         | -          | -                 |

##### <a name="global_rollout_strategy_blueGreen"></a>3.31.1.1. Property `stack > global > rollout > strategy > blueGreen`
...
###### <a name="global_rollout_strategy_blueGreen_previewService"></a>3.31.1.1.2. Property `stack > global > rollout > strategy > blueGreen > previewService`
...
###### <a name="global_rollout_strategy_blueGreen_autoPromotionEnabled"></a>3.31.1.1.3. Property `stack > global > rollout > strategy > blueGreen > autoPromotionEnabled`
...
##### <a name="global_rollout_strategy_canary"></a>3.31.1.2. Property `stack > global > rollout > strategy > canary`
...
| Property                                          | Pattern | Type            | Deprecated | Definition | Title/Description |
| ------------------------------------------------- | ------- | --------------- | ---------- | ---------- | ----------------- |
| - [steps](#global_rollout_strategy_canary_steps ) | No      | array of object | No         | -          | -                 |

###### <a name="global_rollout_strategy_canary_steps"></a>3.31.1.2.1. Property `stack > global > rollout > strategy > canary > steps`
...
| Each item of this array must be                            | Description |
| ---------------------------------------------------------- | ----------- |
| [steps items](#global_rollout_strategy_canary_steps_items) | -           |

###### <a name="global_rollout_strategy_canary_steps_items"></a>3.31.1.2.1.1. stack > global > rollout > strategy > canary > steps > steps items
...
#### <a name="global_rollout_analysisRunMetadata"></a>3.31.2. Property `stack > global > rollout > analysisRunMetadata`
...
| Property                                                          | Pattern | Type   | Deprecated | Definition | Title/Description |
| ----------------------------------------------------------------- | ------- | ------ | ---------- | ---------- | ----------------- |
| - [labels](#global_rollout_analysisRunMetadata_labels )           | No      | object | No         | -          | -                 |
| - [annotations](#global_rollout_analysisRunMetadata_annotations ) | No      | object | No         | -          | -                 |

##### <a name="global_rollout_analysisRunMetadata_labels"></a>3.31.2.1. Property `stack > global > rollout > analysisRunMetadata > labels`
...
| Property                                                               | Pattern | Type   | Deprecated | Definition | Title/Description |
| ---------------------------------------------------------------------- | ------- | ------ | ---------- | ---------- | ----------------- |
| - [](#global_rollout_analysisRunMetadata_labels_additionalProperties ) | No      | object | No         | -          | -                 |

##### <a name="global_rollout_analysisRunMetadata_annotations"></a>3.31.2.2. Property `stack > global > rollout > analysisRunMetadata > annotations`
...
| Property                                                                    | Pattern | Type   | Deprecated | Definition | Title/Description |
| --------------------------------------------------------------------------- | ------- | ------ | ---------- | ---------- | ----------------- |
| - [](#global_rollout_analysisRunMetadata_annotations_additionalProperties ) | No      | object | No         | -          | -                 |

#### <a name="global_rollout_analysisTemplate"></a>3.31.3. Property `stack > global > rollout > analysisTemplate`
...
| Property                                                                         | Pattern | Type            | Deprecated | Definition | Title/Description                                                                                                  |
| -------------------------------------------------------------------------------- | ------- | --------------- | ---------- | ---------- | ------------------------------------------------------------------------------------------------------------------ |
| - [enabled](#global_rollout_analysisTemplate_enabled )                           | No      | boolean         | No         | -          | -                                                                                                                  |
...
##### <a name="global_rollout_analysisTemplate_name"></a>3.31.3.2. Property `stack > global > rollout > analysisTemplate > name`
...
##### <a name="global_rollout_analysisTemplate_metrics"></a>3.31.3.3. Property `stack > global > rollout > analysisTemplate > metrics`
...
| Each item of this array must be                                 | Description |
| --------------------------------------------------------------- | ----------- |
| [metrics items](#global_rollout_analysisTemplate_metrics_items) | -           |

###### <a name="global_rollout_analysisTemplate_metrics_items"></a>3.31.3.3.1. stack > global > rollout > analysisTemplate > metrics > metrics items
...
| Property                                                                               | Pattern | Type        | Deprecated | Definition | Title/Description                                                                                            |
| -------------------------------------------------------------------------------------- | ------- | ----------- | ---------- | ---------- | ------------------------------------------------------------------------------------------------------------ |
| + [name](#global_rollout_analysisTemplate_metrics_items_name )                         | No      | string      | No         | -          | Name of the metric.                                                                                          |
| - [interval](#global_rollout_analysisTemplate_metrics_items_interval )                 | No      | string      | No         | -          | Interval to run the metric (e.g., '1s', '30s').                                                              |
| - [count](#global_rollout_analysisTemplate_metrics_items_count )                       | No      | integer     | No         | -          | Number of times to run the metric. (e.g., 1)                                                                 |
| - [initialDelay](#global_rollout_analysisTemplate_metrics_items_initialDelay )         | No      | string      | No         | -          | InitialDelay is a duration string (e.g., '5s') that delays the first evaluation of a metric.                 |
| - [timeout](#global_rollout_analysisTemplate_metrics_items_timeout )                   | No      | string      | No         | -          | Timeout is a duration string (e.g., '30s') after which metric evaluation is considered a failure.            |
| - [successCondition](#global_rollout_analysisTemplate_metrics_items_successCondition ) | No      | string      | No         | -          | Condition for metric success (e.g., 'result == "success"').                                                  |
| - [failureCondition](#global_rollout_analysisTemplate_metrics_items_failureCondition ) | No      | string      | No         | -          | Condition for metric failure (e.g., 'result == "fail"').                                                     |
| + [provider](#global_rollout_analysisTemplate_metrics_items_provider )                 | No      | Combination | No         | -          | Provider configuration for the metric. Only one provider type can be specified (e.g., web, job, prometheus). |

###### <a name="global_rollout_analysisTemplate_metrics_items_name"></a>3.31.3.3.1.1. Property `stack > global > rollout > analysisTemplate > metrics > metrics items > name`
...
###### <a name="global_rollout_analysisTemplate_metrics_items_interval"></a>3.31.3.3.1.2. Property `stack > global > rollout > analysisTemplate > metrics > metrics items > interval`
...
###### <a name="global_rollout_analysisTemplate_metrics_items_count"></a>3.31.3.3.1.3. Property `stack > global > rollout > analysisTemplate > metrics > metrics items > count`
...
###### <a name="global_rollout_analysisTemplate_metrics_items_initialDelay"></a>3.31.3.3.1.4. Property `stack > global > rollout > analysisTemplate > metrics > metrics items > initialDelay`
...
###### <a name="global_rollout_analysisTemplate_metrics_items_timeout"></a>3.31.3.3.1.5. Property `stack > global > rollout > analysisTemplate > metrics > metrics items > timeout`
...
###### <a name="global_rollout_analysisTemplate_metrics_items_successCondition"></a>3.31.3.3.1.6. Property `stack > global > rollout > analysisTemplate > metrics > metrics items > successCondition`
...
###### <a name="global_rollout_analysisTemplate_metrics_items_failureCondition"></a>3.31.3.3.1.7. Property `stack > global > rollout > analysisTemplate > metrics > metrics items > failureCondition`
...
###### <a name="global_rollout_analysisTemplate_metrics_items_provider"></a>3.31.3.3.1.8. Property `stack > global > rollout > analysisTemplate > metrics > metrics items > provider`
...
| Property                                                                            | Pattern | Type   | Deprecated | Definition                                                                                           | Title/Description |
| ----------------------------------------------------------------------------------- | ------- | ------ | ---------- | ---------------------------------------------------------------------------------------------------- | ----------------- |
| - [web](#global_rollout_analysisTemplate_metrics_items_provider_web )               | No      | object | No         | Same as [web](#cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_web )               | -                 |
| - [prometheus](#global_rollout_analysisTemplate_metrics_items_provider_prometheus ) | No      | object | No         | Same as [prometheus](#cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_prometheus ) | -                 |
| - [job](#global_rollout_analysisTemplate_metrics_items_provider_job )               | No      | object | No         | Same as [job](#cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_job )               | -                 |

| One of(Option)                                                             |
| -------------------------------------------------------------------------- |
| [item 0](#global_rollout_analysisTemplate_metrics_items_provider_oneOf_i0) |
| [item 1](#global_rollout_analysisTemplate_metrics_items_provider_oneOf_i1) |
| [item 2](#global_rollout_analysisTemplate_metrics_items_provider_oneOf_i2) |

###### <a name="global_rollout_analysisTemplate_metrics_items_provider_oneOf_i0"></a>3.31.3.3.1.8.1. Property `stack > global > rollout > analysisTemplate > metrics > metrics items > provider > oneOf > item 0`
...
###### <a name="autogenerated_heading_5"></a>3.31.3.3.1.8.1.1. The following properties are required
* web

###### <a name="global_rollout_analysisTemplate_metrics_items_provider_oneOf_i1"></a>3.31.3.3.1.8.2. Property `stack > global > rollout > analysisTemplate > metrics > metrics items > provider > oneOf > item 1`
...
###### <a name="autogenerated_heading_6"></a>3.31.3.3.1.8.2.1. The following properties are required
* prometheus

###### <a name="global_rollout_analysisTemplate_metrics_items_provider_oneOf_i2"></a>3.31.3.3.1.8.3. Property `stack > global > rollout > analysisTemplate > metrics > metrics items > provider > oneOf > item 2`
...
###### <a name="autogenerated_heading_7"></a>3.31.3.3.1.8.3.1. The following properties are required
* job

###### <a name="global_rollout_analysisTemplate_metrics_items_provider_web"></a>3.31.3.3.1.8.4. Property `stack > global > rollout > analysisTemplate > metrics > metrics items > provider > web`
...
| **Required**              | No                                                                            |
| **Additional properties** | Any type allowed                                                              |
| **Same definition as**    | [web](#cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_web) |

###### <a name="global_rollout_analysisTemplate_metrics_items_provider_prometheus"></a>3.31.3.3.1.8.5. Property `stack > global > rollout > analysisTemplate > metrics > metrics items > provider > prometheus`
...
| **Required**              | No                                                                                          |
| **Additional properties** | Any type allowed                                                                            |
| **Same definition as**    | [prometheus](#cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_prometheus) |

###### <a name="global_rollout_analysisTemplate_metrics_items_provider_job"></a>3.31.3.3.1.8.6. Property `stack > global > rollout > analysisTemplate > metrics > metrics items > provider > job`
...
| **Required**              | No                                                                            |
| **Additional properties** | Any type allowed                                                              |
| **Same definition as**    | [job](#cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_job) |

##### <a name="global_rollout_analysisTemplate_enableDefaultMetrics"></a>3.31.3.4. Property `stack > global > rollout > analysisTemplate > enableDefaultMetrics`
...
| Property                                               | Pattern | Type    | Deprecated | Definition | Title/Description                                                                |
| ------------------------------------------------------ | ------- | ------- | ---------- | ---------- | -------------------------------------------------------------------------------- |
| - [enabled](#global_rollout_grafanaDashboard_enabled ) | No      | boolean | No         | -          | Enable or disable deployment of the Grafana Dashboard for this Rollout.          |
| - [name](#global_rollout_grafanaDashboard_name )       | No      | string  | No         | -          | Override the name of the Grafana Dashboard resource.                             |
| - [folder](#global_rollout_grafanaDashboard_folder )   | No      | string  | No         | -          | The Grafana folder where the dashboard should be placed. Defaults to 'Rollouts'. |

##### <a name="global_rollout_grafanaDashboard_enabled"></a>3.31.4.1. Property `stack > global > rollout > grafanaDashboard > enabled`
...
##### <a name="global_rollout_grafanaDashboard_name"></a>3.31.4.2. Property `stack > global > rollout > grafanaDashboard > name`
...
##### <a name="global_rollout_grafanaDashboard_folder"></a>3.31.4.3. Property `stack > global > rollout > grafanaDashboard > folder`
...
### <a name="global_securityContext"></a>3.32. Property `stack > global > securityContext`
...
### <a name="global_service"></a>3.33. Property `stack > global > service`
...
#### <a name="global_service_port"></a>3.33.1. Property `stack > global > service > port`
...
#### <a name="global_service_type"></a>3.33.2. Property `stack > global > service > type`
...
### <a name="global_serviceAccount"></a>3.34. Property `stack > global > serviceAccount`
...
#### <a name="global_serviceAccount_annotations"></a>3.34.1. Property `stack > global > serviceAccount > annotations`
...
#### <a name="global_serviceAccount_automount"></a>3.34.2. Property `stack > global > serviceAccount > automount`
...
#### <a name="global_serviceAccount_create"></a>3.34.3. Property `stack > global > serviceAccount > create`
...
#### <a name="global_serviceAccount_name"></a>3.34.4. Property `stack > global > serviceAccount > name`
...
### <a name="global_shareProcessNamespace"></a>3.35. Property `stack > global > shareProcessNamespace`
...
### <a name="global_sidecars"></a>3.36. Property `stack > global > sidecars`
...
### <a name="global_startupProbe"></a>3.37. Property `stack > global > startupProbe`
...
#### <a name="global_startupProbe_enabled"></a>3.37.1. Property `stack > global > startupProbe > enabled`
...
#### <a name="global_startupProbe_exec"></a>3.37.2. Property `stack > global > startupProbe > exec`
...
##### <a name="global_startupProbe_exec_command"></a>3.37.2.1. Property `stack > global > startupProbe > exec > command`
...
###### <a name="global_startupProbe_exec_command_items"></a>3.37.2.1.1. stack > global > startupProbe > exec > command > command items
...
#### <a name="global_startupProbe_failureThreshold"></a>3.37.3. Property `stack > global > startupProbe > failureThreshold`
...
#### <a name="global_startupProbe_initialDelaySeconds"></a>3.37.4. Property `stack > global > startupProbe > initialDelaySeconds`
...
#### <a name="global_startupProbe_periodSeconds"></a>3.37.5. Property `stack > global > startupProbe > periodSeconds`
...
#### <a name="global_startupProbe_successThreshold"></a>3.37.6. Property `stack > global > startupProbe > successThreshold`
...
#### <a name="global_startupProbe_timeoutSeconds"></a>3.37.7. Property `stack > global > startupProbe > timeoutSeconds`
...
### <a name="global_tolerations"></a>3.38. Property `stack > global > tolerations`
...
### <a name="global_topologySpreadConstraints"></a>3.39. Property `stack > global > topologySpreadConstraints`
...
### <a name="global_volumeMounts"></a>3.40. Property `stack > global > volumeMounts`
...
### <a name="global_volumes"></a>3.41. Property `stack > global > volumes`
...
###### <a name="cronJobs_pattern1_persistence_pvc_resources"></a>4.1.22.4.2. Property `stack > cronJobs > ^.*$ > persistence > pvc > resources`
...
###### <a name="cronJobs_pattern1_persistence_pvc_resources_requests"></a>4.1.22.4.2.1. Property `stack > cronJobs > ^.*$ > persistence > pvc > resources > requests`
...
###### <a name="cronJobs_pattern1_persistence_pvc_resources_requests_storage"></a>4.1.22.4.2.1.1. Property `stack > cronJobs > ^.*$ > persistence > pvc > resources > requests > storage`
...
###### <a name="cronJobs_pattern1_persistence_pvc_storageClassName"></a>4.1.22.4.3. Property `stack > cronJobs > ^.*$ > persistence > pvc > storageClassName`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_previewService"></a>4.1.31.1.1.2. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > previewService`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_autoPromotionEnabled"></a>4.1.31.1.1.3. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > autoPromotionEnabled`
...
###### <a name="cronJobs_pattern1_rollout_strategy_canary"></a>4.1.31.1.2. Property `stack > cronJobs > ^.*$ > rollout > strategy > canary`
...
###### <a name="cronJobs_pattern1_rollout_strategy_canary_steps"></a>4.1.31.1.2.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > canary > steps`
...
###### <a name="cronJobs_pattern1_rollout_strategy_canary_steps_items"></a>4.1.31.1.2.1.1. stack > cronJobs > ^.*$ > rollout > strategy > canary > steps > steps items
...
##### <a name="cronJobs_pattern1_rollout_analysisRunMetadata"></a>4.1.31.2. Property `stack > cronJobs > ^.*$ > rollout > analysisRunMetadata`
...
###### <a name="cronJobs_pattern1_rollout_analysisRunMetadata_labels"></a>4.1.31.2.1. Property `stack > cronJobs > ^.*$ > rollout > analysisRunMetadata > labels`
...
###### <a name="cronJobs_pattern1_rollout_analysisRunMetadata_annotations"></a>4.1.31.2.2. Property `stack > cronJobs > ^.*$ > rollout > analysisRunMetadata > annotations`
...
##### <a name="cronJobs_pattern1_rollout_analysisTemplate"></a>4.1.31.3. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_name"></a>4.1.31.3.2. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > name`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics"></a>4.1.31.3.3. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items"></a>4.1.31.3.3.1. stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_name"></a>4.1.31.3.3.1.1. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > name`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_interval"></a>4.1.31.3.3.1.2. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > interval`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_count"></a>4.1.31.3.3.1.3. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > count`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_initialDelay"></a>4.1.31.3.3.1.4. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > initialDelay`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_timeout"></a>4.1.31.3.3.1.5. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > timeout`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_successCondition"></a>4.1.31.3.3.1.6. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > successCondition`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_failureCondition"></a>4.1.31.3.3.1.7. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > failureCondition`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider"></a>4.1.31.3.3.1.8. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > provider`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_oneOf_i0"></a>4.1.31.3.3.1.8.1. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > provider > oneOf > item 0`
...
###### <a name="autogenerated_heading_8"></a>4.1.31.3.3.1.8.1.1. The following properties are required
* web

###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_oneOf_i1"></a>4.1.31.3.3.1.8.2. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > provider > oneOf > item 1`
...
###### <a name="autogenerated_heading_9"></a>4.1.31.3.3.1.8.2.1. The following properties are required
* prometheus

###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_oneOf_i2"></a>4.1.31.3.3.1.8.3. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > provider > oneOf > item 2`
...
###### <a name="autogenerated_heading_10"></a>4.1.31.3.3.1.8.3.1. The following properties are required
* job

###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_web"></a>4.1.31.3.3.1.8.4. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > provider > web`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_web_url"></a>4.1.31.3.3.1.8.4.1. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > provider > web > url`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_web_jsonPath"></a>4.1.31.3.3.1.8.4.2. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > provider > web > jsonPath`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_prometheus"></a>4.1.31.3.3.1.8.5. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > provider > prometheus`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_prometheus_address"></a>4.1.31.3.3.1.8.5.1. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > provider > prometheus > address`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_prometheus_query"></a>4.1.31.3.3.1.8.5.2. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > provider > prometheus > query`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_job"></a>4.1.31.3.3.1.8.6. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > provider > job`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_job_spec"></a>4.1.31.3.3.1.8.6.1. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > provider > job > spec`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_enableDefaultMetrics"></a>4.1.31.3.4. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > enableDefaultMetrics`
...
###### <a name="cronJobs_pattern1_rollout_grafanaDashboard_enabled"></a>4.1.31.4.1. Property `stack > cronJobs > ^.*$ > rollout > grafanaDashboard > enabled`
...
###### <a name="cronJobs_pattern1_rollout_grafanaDashboard_name"></a>4.1.31.4.2. Property `stack > cronJobs > ^.*$ > rollout > grafanaDashboard > name`
...
###### <a name="cronJobs_pattern1_rollout_grafanaDashboard_folder"></a>4.1.31.4.3. Property `stack > cronJobs > ^.*$ > rollout > grafanaDashboard > folder`
...
#### <a name="cronJobs_pattern1_securityContext"></a>4.1.32. Property `stack > cronJobs > ^.*$ > securityContext`
...
#### <a name="cronJobs_pattern1_service"></a>4.1.33. Property `stack > cronJobs > ^.*$ > service`
...
##### <a name="cronJobs_pattern1_service_port"></a>4.1.33.1. Property `stack > cronJobs > ^.*$ > service > port`
...
##### <a name="cronJobs_pattern1_service_type"></a>4.1.33.2. Property `stack > cronJobs > ^.*$ > service > type`
...
#### <a name="cronJobs_pattern1_serviceAccount"></a>4.1.34. Property `stack > cronJobs > ^.*$ > serviceAccount`
...
##### <a name="cronJobs_pattern1_serviceAccount_annotations"></a>4.1.34.1. Property `stack > cronJobs > ^.*$ > serviceAccount > annotations`
...
##### <a name="cronJobs_pattern1_serviceAccount_automount"></a>4.1.34.2. Property `stack > cronJobs > ^.*$ > serviceAccount > automount`
...
##### <a name="cronJobs_pattern1_serviceAccount_create"></a>4.1.34.3. Property `stack > cronJobs > ^.*$ > serviceAccount > create`
...
##### <a name="cronJobs_pattern1_serviceAccount_name"></a>4.1.34.4. Property `stack > cronJobs > ^.*$ > serviceAccount > name`
...
#### <a name="cronJobs_pattern1_shareProcessNamespace"></a>4.1.35. Property `stack > cronJobs > ^.*$ > shareProcessNamespace`
...
#### <a name="cronJobs_pattern1_sidecars"></a>4.1.36. Property `stack > cronJobs > ^.*$ > sidecars`
...
#### <a name="cronJobs_pattern1_startupProbe"></a>4.1.37. Property `stack > cronJobs > ^.*$ > startupProbe`
...
##### <a name="cronJobs_pattern1_startupProbe_enabled"></a>4.1.37.1. Property `stack > cronJobs > ^.*$ > startupProbe > enabled`
...
##### <a name="cronJobs_pattern1_startupProbe_exec"></a>4.1.37.2. Property `stack > cronJobs > ^.*$ > startupProbe > exec`
...
###### <a name="cronJobs_pattern1_startupProbe_exec_command"></a>4.1.37.2.1. Property `stack > cronJobs > ^.*$ > startupProbe > exec > command`
...
###### <a name="cronJobs_pattern1_startupProbe_exec_command_items"></a>4.1.37.2.1.1. stack > cronJobs > ^.*$ > startupProbe > exec > command > command items
...
##### <a name="cronJobs_pattern1_startupProbe_failureThreshold"></a>4.1.37.3. Property `stack > cronJobs > ^.*$ > startupProbe > failureThreshold`
...
##### <a name="cronJobs_pattern1_startupProbe_initialDelaySeconds"></a>4.1.37.4. Property `stack > cronJobs > ^.*$ > startupProbe > initialDelaySeconds`
...
##### <a name="cronJobs_pattern1_startupProbe_periodSeconds"></a>4.1.37.5. Property `stack > cronJobs > ^.*$ > startupProbe > periodSeconds`
...
##### <a name="cronJobs_pattern1_startupProbe_successThreshold"></a>4.1.37.6. Property `stack > cronJobs > ^.*$ > startupProbe > successThreshold`
...
##### <a name="cronJobs_pattern1_startupProbe_timeoutSeconds"></a>4.1.37.7. Property `stack > cronJobs > ^.*$ > startupProbe > timeoutSeconds`
...
#### <a name="cronJobs_pattern1_tolerations"></a>4.1.38. Property `stack > cronJobs > ^.*$ > tolerations`
...
#### <a name="cronJobs_pattern1_topologySpreadConstraints"></a>4.1.39. Property `stack > cronJobs > ^.*$ > topologySpreadConstraints`
...
#### <a name="cronJobs_pattern1_volumeMounts"></a>4.1.40. Property `stack > cronJobs > ^.*$ > volumeMounts`
...
#### <a name="cronJobs_pattern1_volumes"></a>4.1.41. Property `stack > cronJobs > ^.*$ > volumes`
...
###### <a name="cronJobs_pattern1_persistence_pvc_resources"></a>5.1.22.4.2. Property `stack > cronJobs > ^.*$ > persistence > pvc > resources`
...
###### <a name="cronJobs_pattern1_persistence_pvc_resources_requests"></a>5.1.22.4.2.1. Property `stack > cronJobs > ^.*$ > persistence > pvc > resources > requests`
...
###### <a name="cronJobs_pattern1_persistence_pvc_resources_requests_storage"></a>5.1.22.4.2.1.1. Property `stack > cronJobs > ^.*$ > persistence > pvc > resources > requests > storage`
...
###### <a name="cronJobs_pattern1_persistence_pvc_storageClassName"></a>5.1.22.4.3. Property `stack > cronJobs > ^.*$ > persistence > pvc > storageClassName`
...
#### <a name="cronJobs_pattern1_rollout"></a>5.1.31. Property `stack > cronJobs > ^.*$ > rollout`
...
##### <a name="cronJobs_pattern1_rollout_strategy"></a>5.1.31.1. Property `stack > cronJobs > ^.*$ > rollout > strategy`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen"></a>5.1.31.1.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_previewService"></a>5.1.31.1.1.2. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > previewService`
...
###### <a name="cronJobs_pattern1_rollout_strategy_blueGreen_autoPromotionEnabled"></a>5.1.31.1.1.3. Property `stack > cronJobs > ^.*$ > rollout > strategy > blueGreen > autoPromotionEnabled`
...
###### <a name="cronJobs_pattern1_rollout_strategy_canary"></a>5.1.31.1.2. Property `stack > cronJobs > ^.*$ > rollout > strategy > canary`
...
###### <a name="cronJobs_pattern1_rollout_strategy_canary_steps"></a>5.1.31.1.2.1. Property `stack > cronJobs > ^.*$ > rollout > strategy > canary > steps`
...
###### <a name="cronJobs_pattern1_rollout_strategy_canary_steps_items"></a>5.1.31.1.2.1.1. stack > cronJobs > ^.*$ > rollout > strategy > canary > steps > steps items
...
##### <a name="cronJobs_pattern1_rollout_analysisRunMetadata"></a>5.1.31.2. Property `stack > cronJobs > ^.*$ > rollout > analysisRunMetadata`
...
###### <a name="cronJobs_pattern1_rollout_analysisRunMetadata_labels"></a>5.1.31.2.1. Property `stack > cronJobs > ^.*$ > rollout > analysisRunMetadata > labels`
...
###### <a name="cronJobs_pattern1_rollout_analysisRunMetadata_annotations"></a>5.1.31.2.2. Property `stack > cronJobs > ^.*$ > rollout > analysisRunMetadata > annotations`
...
##### <a name="cronJobs_pattern1_rollout_analysisTemplate"></a>5.1.31.3. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_name"></a>5.1.31.3.2. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > name`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics"></a>5.1.31.3.3. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items"></a>5.1.31.3.3.1. stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_name"></a>5.1.31.3.3.1.1. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > name`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_interval"></a>5.1.31.3.3.1.2. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > interval`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_count"></a>5.1.31.3.3.1.3. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > count`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_initialDelay"></a>5.1.31.3.3.1.4. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > initialDelay`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_timeout"></a>5.1.31.3.3.1.5. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > timeout`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_successCondition"></a>5.1.31.3.3.1.6. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > successCondition`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_failureCondition"></a>5.1.31.3.3.1.7. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > failureCondition`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider"></a>5.1.31.3.3.1.8. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > provider`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_oneOf_i0"></a>5.1.31.3.3.1.8.1. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > provider > oneOf > item 0`
...
###### <a name="autogenerated_heading_11"></a>5.1.31.3.3.1.8.1.1. The following properties are required
* web

###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_oneOf_i1"></a>5.1.31.3.3.1.8.2. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > provider > oneOf > item 1`
...
###### <a name="autogenerated_heading_12"></a>5.1.31.3.3.1.8.2.1. The following properties are required
* prometheus

###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_oneOf_i2"></a>5.1.31.3.3.1.8.3. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > provider > oneOf > item 2`
...
###### <a name="autogenerated_heading_13"></a>5.1.31.3.3.1.8.3.1. The following properties are required
* job

###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_web"></a>5.1.31.3.3.1.8.4. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > provider > web`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_web_url"></a>5.1.31.3.3.1.8.4.1. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > provider > web > url`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_web_jsonPath"></a>5.1.31.3.3.1.8.4.2. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > provider > web > jsonPath`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_prometheus"></a>5.1.31.3.3.1.8.5. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > provider > prometheus`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_prometheus_address"></a>5.1.31.3.3.1.8.5.1. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > provider > prometheus > address`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_prometheus_query"></a>5.1.31.3.3.1.8.5.2. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > provider > prometheus > query`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_job"></a>5.1.31.3.3.1.8.6. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > provider > job`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_metrics_items_provider_job_spec"></a>5.1.31.3.3.1.8.6.1. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > metrics > metrics items > provider > job > spec`
...
###### <a name="cronJobs_pattern1_rollout_analysisTemplate_enableDefaultMetrics"></a>5.1.31.3.4. Property `stack > cronJobs > ^.*$ > rollout > analysisTemplate > enableDefaultMetrics`
...
###### <a name="cronJobs_pattern1_rollout_grafanaDashboard_enabled"></a>5.1.31.4.1. Property `stack > cronJobs > ^.*$ > rollout > grafanaDashboard > enabled`
...
###### <a name="cronJobs_pattern1_rollout_grafanaDashboard_name"></a>5.1.31.4.2. Property `stack > cronJobs > ^.*$ > rollout > grafanaDashboard > name`
...
###### <a name="cronJobs_pattern1_rollout_grafanaDashboard_folder"></a>5.1.31.4.3. Property `stack > cronJobs > ^.*$ > rollout > grafanaDashboard > folder`
