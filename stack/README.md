...
| Property                                                 | Pattern | Type            | Deprecated | Definition | Title/Description                           |
| -------------------------------------------------------- | ------- | --------------- | ---------- | ---------- | ------------------------------------------- |
| - [annotations](#cronJobs_pattern1_gateway_annotations ) | No      | object          | No         | -          | Annotations to add to the HTTPRoute         |
| - [enabled](#cronJobs_pattern1_gateway_enabled )         | No      | boolean         | No         | -          | Enable Gateway API HTTPRoute                |
| - [filters](#cronJobs_pattern1_gateway_filters )         | No      | array of object | No         | -          | Filters to apply to all rules               |
| - [hostnames](#cronJobs_pattern1_gateway_hostnames )     | No      | array of string | No         | -          | Hostnames for the HTTPRoute                 |
| - [parentRefs](#cronJobs_pattern1_gateway_parentRefs )   | No      | array of object | No         | -          | Parent Gateway references for the HTTPRoute |
| - [rules](#cronJobs_pattern1_gateway_rules )             | No      | array of object | No         | -          | List of routing rules for the HTTPRoute     |
...
##### <a name="cronJobs_pattern1_gateway_filters"></a>2.1.16.3. Property `stack > cronJobs > ^.*$ > gateway > filters`
...
**Description:** Filters to apply to all rules
...
| Each item of this array must be                           | Description |
| --------------------------------------------------------- | ----------- |
| [filters items](#cronJobs_pattern1_gateway_filters_items) | -           |

###### <a name="cronJobs_pattern1_gateway_filters_items"></a>2.1.16.3.1. stack > cronJobs > ^.*$ > gateway > filters > filters items
...
| Property                                                                                     | Pattern | Type             | Deprecated | Definition | Title/Description |
| -------------------------------------------------------------------------------------------- | ------- | ---------------- | ---------- | ---------- | ----------------- |
| - [requestHeaderModifier](#cronJobs_pattern1_gateway_filters_items_requestHeaderModifier )   | No      | object           | No         | -          | -                 |
| - [requestRedirect](#cronJobs_pattern1_gateway_filters_items_requestRedirect )               | No      | object           | No         | -          | -                 |
| - [responseHeaderModifier](#cronJobs_pattern1_gateway_filters_items_responseHeaderModifier ) | No      | object           | No         | -          | -                 |
| - [type](#cronJobs_pattern1_gateway_filters_items_type )                                     | No      | enum (of string) | No         | -          | -                 |
| - [urlRewrite](#cronJobs_pattern1_gateway_filters_items_urlRewrite )                         | No      | object           | No         | -          | -                 |

###### <a name="cronJobs_pattern1_gateway_filters_items_requestHeaderModifier"></a>2.1.16.3.1.1. Property `stack > cronJobs > ^.*$ > gateway > filters > filters items > requestHeaderModifier`
...
###### <a name="cronJobs_pattern1_gateway_filters_items_requestRedirect"></a>2.1.16.3.1.2. Property `stack > cronJobs > ^.*$ > gateway > filters > filters items > requestRedirect`
...
###### <a name="cronJobs_pattern1_gateway_filters_items_responseHeaderModifier"></a>2.1.16.3.1.3. Property `stack > cronJobs > ^.*$ > gateway > filters > filters items > responseHeaderModifier`
...
###### <a name="cronJobs_pattern1_gateway_filters_items_type"></a>2.1.16.3.1.4. Property `stack > cronJobs > ^.*$ > gateway > filters > filters items > type`
...
###### <a name="cronJobs_pattern1_gateway_filters_items_urlRewrite"></a>2.1.16.3.1.5. Property `stack > cronJobs > ^.*$ > gateway > filters > filters items > urlRewrite`
...
##### <a name="cronJobs_pattern1_gateway_hostnames"></a>2.1.16.4. Property `stack > cronJobs > ^.*$ > gateway > hostnames`
...
| Each item of this array must be                               | Description |
| ------------------------------------------------------------- | ----------- |
| [hostnames items](#cronJobs_pattern1_gateway_hostnames_items) | -           |

###### <a name="cronJobs_pattern1_gateway_hostnames_items"></a>2.1.16.4.1. stack > cronJobs > ^.*$ > gateway > hostnames > hostnames items
...
##### <a name="cronJobs_pattern1_gateway_parentRefs"></a>2.1.16.5. Property `stack > cronJobs > ^.*$ > gateway > parentRefs`
...
###### <a name="cronJobs_pattern1_gateway_parentRefs_items"></a>2.1.16.5.1. stack > cronJobs > ^.*$ > gateway > parentRefs > parentRefs items
...
| Property                                                                  | Pattern | Type   | Deprecated | Definition | Title/Description                       |
| ------------------------------------------------------------------------- | ------- | ------ | ---------- | ---------- | --------------------------------------- |
| - [name](#cronJobs_pattern1_gateway_parentRefs_items_name )               | No      | string | No         | -          | Name of the Gateway to attach to        |
| - [namespace](#cronJobs_pattern1_gateway_parentRefs_items_namespace )     | No      | string | No         | -          | Namespace of the Gateway                |
| - [sectionName](#cronJobs_pattern1_gateway_parentRefs_items_sectionName ) | No      | string | No         | -          | Section within the Gateway to attach to |

###### <a name="cronJobs_pattern1_gateway_parentRefs_items_name"></a>2.1.16.5.1.1. Property `stack > cronJobs > ^.*$ > gateway > parentRefs > parentRefs items > name`
...
###### <a name="cronJobs_pattern1_gateway_parentRefs_items_namespace"></a>2.1.16.5.1.2. Property `stack > cronJobs > ^.*$ > gateway > parentRefs > parentRefs items > namespace`
...
###### <a name="cronJobs_pattern1_gateway_parentRefs_items_sectionName"></a>2.1.16.5.1.3. Property `stack > cronJobs > ^.*$ > gateway > parentRefs > parentRefs items > sectionName`
...
**Description:** Section within the Gateway to attach to

##### <a name="cronJobs_pattern1_gateway_rules"></a>2.1.16.6. Property `stack > cronJobs > ^.*$ > gateway > rules`
...
**Description:** List of routing rules for the HTTPRoute
...
| Each item of this array must be                       | Description |
| ----------------------------------------------------- | ----------- |
| [rules items](#cronJobs_pattern1_gateway_rules_items) | -           |

###### <a name="cronJobs_pattern1_gateway_rules_items"></a>2.1.16.6.1. stack > cronJobs > ^.*$ > gateway > rules > rules items
...
| Property                                                             | Pattern | Type             | Deprecated | Definition | Title/Description |
| -------------------------------------------------------------------- | ------- | ---------------- | ---------- | ---------- | ----------------- |
| - [headers](#cronJobs_pattern1_gateway_rules_items_headers )         | No      | array            | No         | -          | -                 |
| - [method](#cronJobs_pattern1_gateway_rules_items_method )           | No      | string           | No         | -          | -                 |
| - [path](#cronJobs_pattern1_gateway_rules_items_path )               | No      | string           | No         | -          | -                 |
| - [pathType](#cronJobs_pattern1_gateway_rules_items_pathType )       | No      | enum (of string) | No         | -          | -                 |
| - [queryParams](#cronJobs_pattern1_gateway_rules_items_queryParams ) | No      | array            | No         | -          | -                 |

###### <a name="cronJobs_pattern1_gateway_rules_items_headers"></a>2.1.16.6.1.1. Property `stack > cronJobs > ^.*$ > gateway > rules > rules items > headers`
...
###### <a name="cronJobs_pattern1_gateway_rules_items_method"></a>2.1.16.6.1.2. Property `stack > cronJobs > ^.*$ > gateway > rules > rules items > method`
...
###### <a name="cronJobs_pattern1_gateway_rules_items_path"></a>2.1.16.6.1.3. Property `stack > cronJobs > ^.*$ > gateway > rules > rules items > path`
...
###### <a name="cronJobs_pattern1_gateway_rules_items_pathType"></a>2.1.16.6.1.4. Property `stack > cronJobs > ^.*$ > gateway > rules > rules items > pathType`
...
###### <a name="cronJobs_pattern1_gateway_rules_items_queryParams"></a>2.1.16.6.1.5. Property `stack > cronJobs > ^.*$ > gateway > rules > rules items > queryParams`
...
| Property                                      | Pattern | Type            | Deprecated | Definition | Title/Description                           |
| --------------------------------------------- | ------- | --------------- | ---------- | ---------- | ------------------------------------------- |
| - [annotations](#global_gateway_annotations ) | No      | object          | No         | -          | Annotations to add to the HTTPRoute         |
| - [enabled](#global_gateway_enabled )         | No      | boolean         | No         | -          | Enable Gateway API HTTPRoute                |
| - [filters](#global_gateway_filters )         | No      | array of object | No         | -          | Filters to apply to all rules               |
| - [hostnames](#global_gateway_hostnames )     | No      | array of string | No         | -          | Hostnames for the HTTPRoute                 |
| - [parentRefs](#global_gateway_parentRefs )   | No      | array of object | No         | -          | Parent Gateway references for the HTTPRoute |
| - [rules](#global_gateway_rules )             | No      | array of object | No         | -          | List of routing rules for the HTTPRoute     |
...
#### <a name="global_gateway_filters"></a>3.16.3. Property `stack > global > gateway > filters`
...
| Each item of this array must be                | Description |
| ---------------------------------------------- | ----------- |
| [filters items](#global_gateway_filters_items) | -           |

##### <a name="global_gateway_filters_items"></a>3.16.3.1. stack > global > gateway > filters > filters items
...
| Property                                                                          | Pattern | Type             | Deprecated | Definition | Title/Description |
| --------------------------------------------------------------------------------- | ------- | ---------------- | ---------- | ---------- | ----------------- |
| - [requestHeaderModifier](#global_gateway_filters_items_requestHeaderModifier )   | No      | object           | No         | -          | -                 |
| - [requestRedirect](#global_gateway_filters_items_requestRedirect )               | No      | object           | No         | -          | -                 |
| - [responseHeaderModifier](#global_gateway_filters_items_responseHeaderModifier ) | No      | object           | No         | -          | -                 |
| - [type](#global_gateway_filters_items_type )                                     | No      | enum (of string) | No         | -          | -                 |
| - [urlRewrite](#global_gateway_filters_items_urlRewrite )                         | No      | object           | No         | -          | -                 |

###### <a name="global_gateway_filters_items_requestHeaderModifier"></a>3.16.3.1.1. Property `stack > global > gateway > filters > filters items > requestHeaderModifier`
...
###### <a name="global_gateway_filters_items_requestRedirect"></a>3.16.3.1.2. Property `stack > global > gateway > filters > filters items > requestRedirect`
...
###### <a name="global_gateway_filters_items_responseHeaderModifier"></a>3.16.3.1.3. Property `stack > global > gateway > filters > filters items > responseHeaderModifier`
...
###### <a name="global_gateway_filters_items_type"></a>3.16.3.1.4. Property `stack > global > gateway > filters > filters items > type`
...
###### <a name="global_gateway_filters_items_urlRewrite"></a>3.16.3.1.5. Property `stack > global > gateway > filters > filters items > urlRewrite`
...
#### <a name="global_gateway_hostnames"></a>3.16.4. Property `stack > global > gateway > hostnames`
...
| Each item of this array must be                    | Description |
| -------------------------------------------------- | ----------- |
| [hostnames items](#global_gateway_hostnames_items) | -           |

##### <a name="global_gateway_hostnames_items"></a>3.16.4.1. stack > global > gateway > hostnames > hostnames items
...
#### <a name="global_gateway_parentRefs"></a>3.16.5. Property `stack > global > gateway > parentRefs`
...
##### <a name="global_gateway_parentRefs_items"></a>3.16.5.1. stack > global > gateway > parentRefs > parentRefs items
...
| Property                                                       | Pattern | Type   | Deprecated | Definition | Title/Description                       |
| -------------------------------------------------------------- | ------- | ------ | ---------- | ---------- | --------------------------------------- |
| - [name](#global_gateway_parentRefs_items_name )               | No      | string | No         | -          | Name of the Gateway to attach to        |
| - [namespace](#global_gateway_parentRefs_items_namespace )     | No      | string | No         | -          | Namespace of the Gateway                |
| - [sectionName](#global_gateway_parentRefs_items_sectionName ) | No      | string | No         | -          | Section within the Gateway to attach to |

###### <a name="global_gateway_parentRefs_items_name"></a>3.16.5.1.1. Property `stack > global > gateway > parentRefs > parentRefs items > name`
...
###### <a name="global_gateway_parentRefs_items_namespace"></a>3.16.5.1.2. Property `stack > global > gateway > parentRefs > parentRefs items > namespace`
...
###### <a name="global_gateway_parentRefs_items_sectionName"></a>3.16.5.1.3. Property `stack > global > gateway > parentRefs > parentRefs items > sectionName`
...
#### <a name="global_gateway_rules"></a>3.16.6. Property `stack > global > gateway > rules`
...
| Each item of this array must be            | Description |
| ------------------------------------------ | ----------- |
| [rules items](#global_gateway_rules_items) | -           |

##### <a name="global_gateway_rules_items"></a>3.16.6.1. stack > global > gateway > rules > rules items
...
| Property                                                  | Pattern | Type             | Deprecated | Definition | Title/Description |
| --------------------------------------------------------- | ------- | ---------------- | ---------- | ---------- | ----------------- |
| - [headers](#global_gateway_rules_items_headers )         | No      | array            | No         | -          | -                 |
| - [method](#global_gateway_rules_items_method )           | No      | string           | No         | -          | -                 |
| - [path](#global_gateway_rules_items_path )               | No      | string           | No         | -          | -                 |
| - [pathType](#global_gateway_rules_items_pathType )       | No      | enum (of string) | No         | -          | -                 |
| - [queryParams](#global_gateway_rules_items_queryParams ) | No      | array            | No         | -          | -                 |

###### <a name="global_gateway_rules_items_headers"></a>3.16.6.1.1. Property `stack > global > gateway > rules > rules items > headers`
...
###### <a name="global_gateway_rules_items_method"></a>3.16.6.1.2. Property `stack > global > gateway > rules > rules items > method`
...
###### <a name="global_gateway_rules_items_path"></a>3.16.6.1.3. Property `stack > global > gateway > rules > rules items > path`
...
###### <a name="global_gateway_rules_items_pathType"></a>3.16.6.1.4. Property `stack > global > gateway > rules > rules items > pathType`
...
###### <a name="global_gateway_rules_items_queryParams"></a>3.16.6.1.5. Property `stack > global > gateway > rules > rules items > queryParams`
...
##### <a name="cronJobs_pattern1_gateway_filters"></a>4.1.16.3. Property `stack > cronJobs > ^.*$ > gateway > filters`
...
###### <a name="cronJobs_pattern1_gateway_filters_items"></a>4.1.16.3.1. stack > cronJobs > ^.*$ > gateway > filters > filters items
...
###### <a name="cronJobs_pattern1_gateway_filters_items_requestHeaderModifier"></a>4.1.16.3.1.1. Property `stack > cronJobs > ^.*$ > gateway > filters > filters items > requestHeaderModifier`
...
###### <a name="cronJobs_pattern1_gateway_filters_items_requestRedirect"></a>4.1.16.3.1.2. Property `stack > cronJobs > ^.*$ > gateway > filters > filters items > requestRedirect`
...
###### <a name="cronJobs_pattern1_gateway_filters_items_responseHeaderModifier"></a>4.1.16.3.1.3. Property `stack > cronJobs > ^.*$ > gateway > filters > filters items > responseHeaderModifier`
...
###### <a name="cronJobs_pattern1_gateway_filters_items_type"></a>4.1.16.3.1.4. Property `stack > cronJobs > ^.*$ > gateway > filters > filters items > type`
...
###### <a name="cronJobs_pattern1_gateway_filters_items_urlRewrite"></a>4.1.16.3.1.5. Property `stack > cronJobs > ^.*$ > gateway > filters > filters items > urlRewrite`
...
##### <a name="cronJobs_pattern1_gateway_hostnames"></a>4.1.16.4. Property `stack > cronJobs > ^.*$ > gateway > hostnames`
...
###### <a name="cronJobs_pattern1_gateway_hostnames_items"></a>4.1.16.4.1. stack > cronJobs > ^.*$ > gateway > hostnames > hostnames items
...
##### <a name="cronJobs_pattern1_gateway_parentRefs"></a>4.1.16.5. Property `stack > cronJobs > ^.*$ > gateway > parentRefs`
...
###### <a name="cronJobs_pattern1_gateway_parentRefs_items"></a>4.1.16.5.1. stack > cronJobs > ^.*$ > gateway > parentRefs > parentRefs items
...
###### <a name="cronJobs_pattern1_gateway_parentRefs_items_name"></a>4.1.16.5.1.1. Property `stack > cronJobs > ^.*$ > gateway > parentRefs > parentRefs items > name`
...
###### <a name="cronJobs_pattern1_gateway_parentRefs_items_namespace"></a>4.1.16.5.1.2. Property `stack > cronJobs > ^.*$ > gateway > parentRefs > parentRefs items > namespace`
...
###### <a name="cronJobs_pattern1_gateway_parentRefs_items_sectionName"></a>4.1.16.5.1.3. Property `stack > cronJobs > ^.*$ > gateway > parentRefs > parentRefs items > sectionName`
...
##### <a name="cronJobs_pattern1_gateway_rules"></a>4.1.16.6. Property `stack > cronJobs > ^.*$ > gateway > rules`
...
###### <a name="cronJobs_pattern1_gateway_rules_items"></a>4.1.16.6.1. stack > cronJobs > ^.*$ > gateway > rules > rules items
...
###### <a name="cronJobs_pattern1_gateway_rules_items_headers"></a>4.1.16.6.1.1. Property `stack > cronJobs > ^.*$ > gateway > rules > rules items > headers`
...
###### <a name="cronJobs_pattern1_gateway_rules_items_method"></a>4.1.16.6.1.2. Property `stack > cronJobs > ^.*$ > gateway > rules > rules items > method`
...
###### <a name="cronJobs_pattern1_gateway_rules_items_path"></a>4.1.16.6.1.3. Property `stack > cronJobs > ^.*$ > gateway > rules > rules items > path`
...
###### <a name="cronJobs_pattern1_gateway_rules_items_pathType"></a>4.1.16.6.1.4. Property `stack > cronJobs > ^.*$ > gateway > rules > rules items > pathType`
...
###### <a name="cronJobs_pattern1_gateway_rules_items_queryParams"></a>4.1.16.6.1.5. Property `stack > cronJobs > ^.*$ > gateway > rules > rules items > queryParams`
...
##### <a name="cronJobs_pattern1_gateway_filters"></a>7.1.16.3. Property `stack > cronJobs > ^.*$ > gateway > filters`
...
###### <a name="cronJobs_pattern1_gateway_filters_items"></a>7.1.16.3.1. stack > cronJobs > ^.*$ > gateway > filters > filters items
...
###### <a name="cronJobs_pattern1_gateway_filters_items_requestHeaderModifier"></a>7.1.16.3.1.1. Property `stack > cronJobs > ^.*$ > gateway > filters > filters items > requestHeaderModifier`
...
###### <a name="cronJobs_pattern1_gateway_filters_items_requestRedirect"></a>7.1.16.3.1.2. Property `stack > cronJobs > ^.*$ > gateway > filters > filters items > requestRedirect`
...
###### <a name="cronJobs_pattern1_gateway_filters_items_responseHeaderModifier"></a>7.1.16.3.1.3. Property `stack > cronJobs > ^.*$ > gateway > filters > filters items > responseHeaderModifier`
...
###### <a name="cronJobs_pattern1_gateway_filters_items_type"></a>7.1.16.3.1.4. Property `stack > cronJobs > ^.*$ > gateway > filters > filters items > type`
...
###### <a name="cronJobs_pattern1_gateway_filters_items_urlRewrite"></a>7.1.16.3.1.5. Property `stack > cronJobs > ^.*$ > gateway > filters > filters items > urlRewrite`
...
##### <a name="cronJobs_pattern1_gateway_hostnames"></a>7.1.16.4. Property `stack > cronJobs > ^.*$ > gateway > hostnames`
...
###### <a name="cronJobs_pattern1_gateway_hostnames_items"></a>7.1.16.4.1. stack > cronJobs > ^.*$ > gateway > hostnames > hostnames items
...
##### <a name="cronJobs_pattern1_gateway_parentRefs"></a>7.1.16.5. Property `stack > cronJobs > ^.*$ > gateway > parentRefs`
...
###### <a name="cronJobs_pattern1_gateway_parentRefs_items"></a>7.1.16.5.1. stack > cronJobs > ^.*$ > gateway > parentRefs > parentRefs items
...
###### <a name="cronJobs_pattern1_gateway_parentRefs_items_name"></a>7.1.16.5.1.1. Property `stack > cronJobs > ^.*$ > gateway > parentRefs > parentRefs items > name`
...
###### <a name="cronJobs_pattern1_gateway_parentRefs_items_namespace"></a>7.1.16.5.1.2. Property `stack > cronJobs > ^.*$ > gateway > parentRefs > parentRefs items > namespace`
...
###### <a name="cronJobs_pattern1_gateway_parentRefs_items_sectionName"></a>7.1.16.5.1.3. Property `stack > cronJobs > ^.*$ > gateway > parentRefs > parentRefs items > sectionName`
...
##### <a name="cronJobs_pattern1_gateway_rules"></a>7.1.16.6. Property `stack > cronJobs > ^.*$ > gateway > rules`
...
###### <a name="cronJobs_pattern1_gateway_rules_items"></a>7.1.16.6.1. stack > cronJobs > ^.*$ > gateway > rules > rules items
...
###### <a name="cronJobs_pattern1_gateway_rules_items_headers"></a>7.1.16.6.1.1. Property `stack > cronJobs > ^.*$ > gateway > rules > rules items > headers`
...
###### <a name="cronJobs_pattern1_gateway_rules_items_method"></a>7.1.16.6.1.2. Property `stack > cronJobs > ^.*$ > gateway > rules > rules items > method`
...
###### <a name="cronJobs_pattern1_gateway_rules_items_path"></a>7.1.16.6.1.3. Property `stack > cronJobs > ^.*$ > gateway > rules > rules items > path`
...
###### <a name="cronJobs_pattern1_gateway_rules_items_pathType"></a>7.1.16.6.1.4. Property `stack > cronJobs > ^.*$ > gateway > rules > rules items > pathType`
...
###### <a name="cronJobs_pattern1_gateway_rules_items_queryParams"></a>7.1.16.6.1.5. Property `stack > cronJobs > ^.*$ > gateway > rules > rules items > queryParams`
