...
| - [oidcProxyGateway](#cronJobs_pattern1_oidcProxyGateway )                   | No      | object           | No         | -                       | Native Envoy Gateway OIDC authentication configuration (used when gateway.oidcProtected is true). Automatically discovers OAUTH2_PROXY_CLIENT_ID, OAUTH2_PROXY_CLIENT_SECRET, and OAUTH2_PROXY_OIDC_ISSUER_URL from appSecrets and oidcProxy.additionalSecrets. Automatically generates redirectURL as https://<gateway.host>/oauth2/callback and ensures a root path (/) route exists to handle the callback. |
...
**Description:** Native Envoy Gateway OIDC authentication configuration (used when gateway.oidcProtected is true). Automatically discovers OAUTH2_PROXY_CLIENT_ID, OAUTH2_PROXY_CLIENT_SECRET, and OAUTH2_PROXY_OIDC_ISSUER_URL from appSecrets and oidcProxy.additionalSecrets. Automatically generates redirectURL as https://<gateway.host>/oauth2/callback and ensures a root path (/) route exists to handle the callback.
...
| - [provider](#cronJobs_pattern1_oidcProxyGateway_provider )                     | No      | object          | No         | -          | OIDC provider configuration (all fields auto-discovered from secrets if not specified) |
...
**Description:** OIDC provider configuration (all fields auto-discovered from secrets if not specified)
...
| - [issuer](#cronJobs_pattern1_oidcProxyGateway_provider_issuer )                               | No      | string | No         | -          | OIDC provider issuer URL (auto-discovered from OAUTH2_PROXY_OIDC_ISSUER_URL if empty) |
...
**Description:** OIDC provider issuer URL (auto-discovered from OAUTH2_PROXY_OIDC_ISSUER_URL if empty)
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_refreshToken"></a>2.1.26.7. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > refreshToken`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_resources"></a>2.1.26.8. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > resources`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_scopes"></a>2.1.26.9. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > scopes`
...
| - [provider](#global_oidcProxyGateway_provider )                     | No      | object          | No         | -          | OIDC provider configuration (all fields auto-discovered from secrets if not specified) |
...
| - [issuer](#global_oidcProxyGateway_provider_issuer )                               | No      | string | No         | -          | OIDC provider issuer URL (auto-discovered from OAUTH2_PROXY_OIDC_ISSUER_URL if empty) |
...
#### <a name="global_oidcProxyGateway_refreshToken"></a>3.26.7. Property `stack > global > oidcProxyGateway > refreshToken`
...
#### <a name="global_oidcProxyGateway_resources"></a>3.26.8. Property `stack > global > oidcProxyGateway > resources`
...
#### <a name="global_oidcProxyGateway_scopes"></a>3.26.9. Property `stack > global > oidcProxyGateway > scopes`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_refreshToken"></a>4.1.26.7. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > refreshToken`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_resources"></a>4.1.26.8. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > resources`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_scopes"></a>4.1.26.9. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > scopes`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_refreshToken"></a>7.1.26.7. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > refreshToken`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_resources"></a>7.1.26.8. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > resources`
...
##### <a name="cronJobs_pattern1_oidcProxyGateway_scopes"></a>7.1.26.9. Property `stack > cronJobs > ^.*$ > oidcProxyGateway > scopes`
