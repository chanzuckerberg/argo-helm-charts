...
- [1. Property `stack helm chart > argus-config`](#argus-config)
- [2. Property `stack helm chart > cronJobs`](#cronJobs)
  - [2.1. Pattern Property `stack helm chart > cronJobs > global`](#cronJobs_pattern1)
    - [2.1.1. Property `stack helm chart > cronJobs > ^.*$ > affinity`](#cronJobs_pattern1_affinity)
    - [2.1.2. Property `stack helm chart > cronJobs > ^.*$ > annotations`](#cronJobs_pattern1_annotations)
    - [2.1.3. Property `stack helm chart > cronJobs > ^.*$ > appContext`](#cronJobs_pattern1_appContext)
      - [2.1.3.1. Property `stack helm chart > cronJobs > ^.*$ > appContext > envContextConfigMapName`](#cronJobs_pattern1_appContext_envContextConfigMapName)
      - [2.1.3.2. Property `stack helm chart > cronJobs > ^.*$ > appContext > stackContextConfigMapName`](#cronJobs_pattern1_appContext_stackContextConfigMapName)
    - [2.1.4. Property `stack helm chart > cronJobs > ^.*$ > appSecrets`](#cronJobs_pattern1_appSecrets)
      - [2.1.4.1. Property `stack helm chart > cronJobs > ^.*$ > appSecrets > clusterSecret`](#cronJobs_pattern1_appSecrets_clusterSecret)
        - [2.1.4.1.1. Property `stack helm chart > cronJobs > ^.*$ > appSecrets > clusterSecret > secretKey`](#cronJobs_pattern1_appSecrets_clusterSecret_secretKey)
        - [2.1.4.1.2. Property `stack helm chart > cronJobs > ^.*$ > appSecrets > clusterSecret > secretName`](#cronJobs_pattern1_appSecrets_clusterSecret_secretName)
      - [2.1.4.2. Property `stack helm chart > cronJobs > ^.*$ > appSecrets > envSecret`](#cronJobs_pattern1_appSecrets_envSecret)
        - [2.1.4.2.1. Property `stack helm chart > cronJobs > ^.*$ > appSecrets > envSecret > secretKey`](#cronJobs_pattern1_appSecrets_envSecret_secretKey)
        - [2.1.4.2.2. Property `stack helm chart > cronJobs > ^.*$ > appSecrets > envSecret > secretName`](#cronJobs_pattern1_appSecrets_envSecret_secretName)
      - [2.1.4.3. Property `stack helm chart > cronJobs > ^.*$ > appSecrets > stackSecret`](#cronJobs_pattern1_appSecrets_stackSecret)
        - [2.1.4.3.1. Property `stack helm chart > cronJobs > ^.*$ > appSecrets > stackSecret > secretKey`](#cronJobs_pattern1_appSecrets_stackSecret_secretKey)
        - [2.1.4.3.2. Property `stack helm chart > cronJobs > ^.*$ > appSecrets > stackSecret > secretName`](#cronJobs_pattern1_appSecrets_stackSecret_secretName)
    - [2.1.5. Property `stack helm chart > cronJobs > ^.*$ > args`](#cronJobs_pattern1_args)
      - [2.1.5.1. stack helm chart > cronJobs > ^.*$ > args > args items](#cronJobs_pattern1_args_items)
    - [2.1.6. Property `stack helm chart > cronJobs > ^.*$ > autoscaling`](#cronJobs_pattern1_autoscaling)
      - [2.1.6.1. Property `stack helm chart > cronJobs > ^.*$ > autoscaling > enabled`](#cronJobs_pattern1_autoscaling_enabled)
      - [2.1.6.2. Property `stack helm chart > cronJobs > ^.*$ > autoscaling > maxReplicas`](#cronJobs_pattern1_autoscaling_maxReplicas)
      - [2.1.6.3. Property `stack helm chart > cronJobs > ^.*$ > autoscaling > minReplicas`](#cronJobs_pattern1_autoscaling_minReplicas)
      - [2.1.6.4. Property `stack helm chart > cronJobs > ^.*$ > autoscaling > targetCPUUtilizationPercentage`](#cronJobs_pattern1_autoscaling_targetCPUUtilizationPercentage)
      - [2.1.6.5. Property `stack helm chart > cronJobs > ^.*$ > autoscaling > targetMemoryUtilizationPercentage`](#cronJobs_pattern1_autoscaling_targetMemoryUtilizationPercentage)
    - [2.1.7. Property `stack helm chart > cronJobs > ^.*$ > command`](#cronJobs_pattern1_command)
      - [2.1.7.1. stack helm chart > cronJobs > ^.*$ > command > command items](#cronJobs_pattern1_command_items)
    - [2.1.8. Property `stack helm chart > cronJobs > ^.*$ > deploymentStage`](#cronJobs_pattern1_deploymentStage)
    - [2.1.9. Property `stack helm chart > cronJobs > ^.*$ > dnsPolicy`](#cronJobs_pattern1_dnsPolicy)
    - [2.1.10. Property `stack helm chart > cronJobs > ^.*$ > env`](#cronJobs_pattern1_env)
      - [2.1.10.1. stack helm chart > cronJobs > ^.*$ > env > env items](#cronJobs_pattern1_env_items)
        - [2.1.10.1.1. Property `stack helm chart > cronJobs > ^.*$ > env > env items > name`](#cronJobs_pattern1_env_items_name)
        - [2.1.10.1.2. Property `stack helm chart > cronJobs > ^.*$ > env > env items > value`](#cronJobs_pattern1_env_items_value)
    - [2.1.11. Property `stack helm chart > cronJobs > ^.*$ > envFrom`](#cronJobs_pattern1_envFrom)
      - [2.1.11.1. stack helm chart > cronJobs > ^.*$ > envFrom > envFrom items](#cronJobs_pattern1_envFrom_items)
        - [2.1.11.1.1. Property `stack helm chart > cronJobs > ^.*$ > envFrom > envFrom items > configMapRef`](#cronJobs_pattern1_envFrom_items_configMapRef)
        - [2.1.11.1.2. Property `stack helm chart > cronJobs > ^.*$ > envFrom > envFrom items > prefix`](#cronJobs_pattern1_envFrom_items_prefix)
        - [2.1.11.1.3. Property `stack helm chart > cronJobs > ^.*$ > envFrom > envFrom items > secretRef`](#cronJobs_pattern1_envFrom_items_secretRef)
    - [2.1.12. Property `stack helm chart > cronJobs > ^.*$ > fullnameOverride`](#cronJobs_pattern1_fullnameOverride)
    - [2.1.13. Property `stack helm chart > cronJobs > ^.*$ > image`](#cronJobs_pattern1_image)
      - [2.1.13.1. Property `stack helm chart > cronJobs > ^.*$ > image > pullPolicy`](#cronJobs_pattern1_image_pullPolicy)
      - [2.1.13.2. Property `stack helm chart > cronJobs > ^.*$ > image > repository`](#cronJobs_pattern1_image_repository)
      - [2.1.13.3. Property `stack helm chart > cronJobs > ^.*$ > image > tag`](#cronJobs_pattern1_image_tag)
    - [2.1.14. Property `stack helm chart > cronJobs > ^.*$ > imagePullSecrets`](#cronJobs_pattern1_imagePullSecrets)
      - [2.1.14.1. stack helm chart > cronJobs > ^.*$ > imagePullSecrets > imagePullSecrets items](#cronJobs_pattern1_imagePullSecrets_items)
    - [2.1.15. Property `stack helm chart > cronJobs > ^.*$ > ingress`](#cronJobs_pattern1_ingress)
      - [2.1.15.1. Property `stack helm chart > cronJobs > ^.*$ > ingress > annotations`](#cronJobs_pattern1_ingress_annotations)
        - [2.1.15.1.1. Property `stack helm chart > cronJobs > ^.*$ > ingress > annotations > nginx.ingress.kubernetes.io/affinity`](#cronJobs_pattern1_ingress_annotations_nginxingresskubernetesio/affinity)
        - [2.1.15.1.2. Property `stack helm chart > cronJobs > ^.*$ > ingress > annotations > nginx.ingress.kubernetes.io/proxy-connect-timeout`](#cronJobs_pattern1_ingress_annotations_nginxingresskubernetesio/proxy-connect-timeout)
        - [2.1.15.1.3. Property `stack helm chart > cronJobs > ^.*$ > ingress > annotations > nginx.ingress.kubernetes.io/proxy-read-timeout`](#cronJobs_pattern1_ingress_annotations_nginxingresskubernetesio/proxy-read-timeout)
        - [2.1.15.1.4. Property `stack helm chart > cronJobs > ^.*$ > ingress > annotations > nginx.ingress.kubernetes.io/proxy-send-timeout`](#cronJobs_pattern1_ingress_annotations_nginxingresskubernetesio/proxy-send-timeout)
        - [2.1.15.1.5. Property `stack helm chart > cronJobs > ^.*$ > ingress > annotations > nginx.ingress.kubernetes.io/session-cookie-max-age`](#cronJobs_pattern1_ingress_annotations_nginxingresskubernetesio/session-cookie-max-age)
        - [2.1.15.1.6. Property `stack helm chart > cronJobs > ^.*$ > ingress > annotations > nginx.ingress.kubernetes.io/session-cookie-name`](#cronJobs_pattern1_ingress_annotations_nginxingresskubernetesio/session-cookie-name)
      - [2.1.15.2. Property `stack helm chart > cronJobs > ^.*$ > ingress > className`](#cronJobs_pattern1_ingress_className)
      - [2.1.15.3. Property `stack helm chart > cronJobs > ^.*$ > ingress > enabled`](#cronJobs_pattern1_ingress_enabled)
      - [2.1.15.4. Property `stack helm chart > cronJobs > ^.*$ > ingress > host`](#cronJobs_pattern1_ingress_host)
      - [2.1.15.5. Property `stack helm chart > cronJobs > ^.*$ > ingress > oidcProtected`](#cronJobs_pattern1_ingress_oidcProtected)
      - [2.1.15.6. Property `stack helm chart > cronJobs > ^.*$ > ingress > paths`](#cronJobs_pattern1_ingress_paths)
        - [2.1.15.6.1. stack helm chart > cronJobs > ^.*$ > ingress > paths > paths items](#cronJobs_pattern1_ingress_paths_items)
          - [2.1.15.6.1.1. Property `stack helm chart > cronJobs > ^.*$ > ingress > paths > paths items > path`](#cronJobs_pattern1_ingress_paths_items_path)
          - [2.1.15.6.1.2. Property `stack helm chart > cronJobs > ^.*$ > ingress > paths > paths items > pathType`](#cronJobs_pattern1_ingress_paths_items_pathType)
      - [2.1.15.7. Property `stack helm chart > cronJobs > ^.*$ > ingress > rules`](#cronJobs_pattern1_ingress_rules)
      - [2.1.15.8. Property `stack helm chart > cronJobs > ^.*$ > ingress > tls`](#cronJobs_pattern1_ingress_tls)
    - [2.1.16. Property `stack helm chart > cronJobs > ^.*$ > initContainers`](#cronJobs_pattern1_initContainers)
    - [2.1.17. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe`](#cronJobs_pattern1_livenessProbe)
      - [2.1.17.1. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > failureThreshold`](#cronJobs_pattern1_livenessProbe_failureThreshold)
      - [2.1.17.2. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > httpGet`](#cronJobs_pattern1_livenessProbe_httpGet)
        - [2.1.17.2.1. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > httpGet > path`](#cronJobs_pattern1_livenessProbe_httpGet_path)
        - [2.1.17.2.2. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > httpGet > port`](#cronJobs_pattern1_livenessProbe_httpGet_port)
          - [2.1.17.2.2.1. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > httpGet > port > oneOf > item 0`](#cronJobs_pattern1_livenessProbe_httpGet_port_oneOf_i0)
          - [2.1.17.2.2.2. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > httpGet > port > oneOf > item 1`](#cronJobs_pattern1_livenessProbe_httpGet_port_oneOf_i1)
        - [2.1.17.2.3. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > httpGet > scheme`](#cronJobs_pattern1_livenessProbe_httpGet_scheme)
      - [2.1.17.3. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > initialDelaySeconds`](#cronJobs_pattern1_livenessProbe_initialDelaySeconds)
      - [2.1.17.4. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > periodSeconds`](#cronJobs_pattern1_livenessProbe_periodSeconds)
      - [2.1.17.5. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > successThreshold`](#cronJobs_pattern1_livenessProbe_successThreshold)
      - [2.1.17.6. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > timeoutSeconds`](#cronJobs_pattern1_livenessProbe_timeoutSeconds)
    - [2.1.18. Property `stack helm chart > cronJobs > ^.*$ > nameOverride`](#cronJobs_pattern1_nameOverride)
    - [2.1.19. Property `stack helm chart > cronJobs > ^.*$ > nodeSelector`](#cronJobs_pattern1_nodeSelector)
      - [2.1.19.1. Property `stack helm chart > cronJobs > ^.*$ > nodeSelector > kubernetes.io/arch`](#cronJobs_pattern1_nodeSelector_kubernetesio/arch)
    - [2.1.20. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy`](#cronJobs_pattern1_oidcProxy)
      - [2.1.20.1. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > additionalHeaders`](#cronJobs_pattern1_oidcProxy_additionalHeaders)
      - [2.1.20.2. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > additionalSecrets`](#cronJobs_pattern1_oidcProxy_additionalSecrets)
      - [2.1.20.3. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > annotations`](#cronJobs_pattern1_oidcProxy_annotations)
      - [2.1.20.4. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > cookieRefresh`](#cronJobs_pattern1_oidcProxy_cookieRefresh)
      - [2.1.20.5. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > enabled`](#cronJobs_pattern1_oidcProxy_enabled)
      - [2.1.20.6. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > extraArgs`](#cronJobs_pattern1_oidcProxy_extraArgs)
        - [2.1.20.6.1. stack helm chart > cronJobs > ^.*$ > oidcProxy > extraArgs > extraArgs items](#cronJobs_pattern1_oidcProxy_extraArgs_items)
      - [2.1.20.7. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > image`](#cronJobs_pattern1_oidcProxy_image)
        - [2.1.20.7.1. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > image > repository`](#cronJobs_pattern1_oidcProxy_image_repository)
        - [2.1.20.7.2. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > image > tag`](#cronJobs_pattern1_oidcProxy_image_tag)
      - [2.1.20.8. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > replicaCount`](#cronJobs_pattern1_oidcProxy_replicaCount)
      - [2.1.20.9. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources`](#cronJobs_pattern1_oidcProxy_resources)
        - [2.1.20.9.1. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > limits`](#cronJobs_pattern1_oidcProxy_resources_limits)
          - [2.1.20.9.1.1. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > limits > cpu`](#cronJobs_pattern1_oidcProxy_resources_limits_cpu)
            - [2.1.20.9.1.1.1. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > limits > cpu > oneOf > item 0`](#cronJobs_pattern1_oidcProxy_resources_limits_cpu_oneOf_i0)
            - [2.1.20.9.1.1.2. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > limits > cpu > oneOf > item 1`](#cronJobs_pattern1_oidcProxy_resources_limits_cpu_oneOf_i1)
          - [2.1.20.9.1.2. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > limits > memory`](#cronJobs_pattern1_oidcProxy_resources_limits_memory)
        - [2.1.20.9.2. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > requests`](#cronJobs_pattern1_oidcProxy_resources_requests)
          - [2.1.20.9.2.1. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > requests > cpu`](#cronJobs_pattern1_oidcProxy_resources_requests_cpu)
            - [2.1.20.9.2.1.1. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > requests > cpu > oneOf > item 0`](#cronJobs_pattern1_oidcProxy_resources_requests_cpu_oneOf_i0)
            - [2.1.20.9.2.1.2. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > requests > cpu > oneOf > item 1`](#cronJobs_pattern1_oidcProxy_resources_requests_cpu_oneOf_i1)
          - [2.1.20.9.2.2. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > requests > memory`](#cronJobs_pattern1_oidcProxy_resources_requests_memory)
      - [2.1.20.10. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > skipAuth`](#cronJobs_pattern1_oidcProxy_skipAuth)
        - [2.1.20.10.1. stack helm chart > cronJobs > ^.*$ > oidcProxy > skipAuth > skipAuth items](#cronJobs_pattern1_oidcProxy_skipAuth_items)
          - [2.1.20.10.1.1. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > skipAuth > skipAuth items > method`](#cronJobs_pattern1_oidcProxy_skipAuth_items_method)
          - [2.1.20.10.1.2. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > skipAuth > skipAuth items > path`](#cronJobs_pattern1_oidcProxy_skipAuth_items_path)
      - [2.1.20.11. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > volumeMounts`](#cronJobs_pattern1_oidcProxy_volumeMounts)
    - [2.1.21. Property `stack helm chart > cronJobs > ^.*$ > persistence`](#cronJobs_pattern1_persistence)
      - [2.1.21.1. Property `stack helm chart > cronJobs > ^.*$ > persistence > enabled`](#cronJobs_pattern1_persistence_enabled)
      - [2.1.21.2. Property `stack helm chart > cronJobs > ^.*$ > persistence > existingClaim`](#cronJobs_pattern1_persistence_existingClaim)
      - [2.1.21.3. Property `stack helm chart > cronJobs > ^.*$ > persistence > mountPath`](#cronJobs_pattern1_persistence_mountPath)
      - [2.1.21.4. Property `stack helm chart > cronJobs > ^.*$ > persistence > pvc`](#cronJobs_pattern1_persistence_pvc)
        - [2.1.21.4.1. Property `stack helm chart > cronJobs > ^.*$ > persistence > pvc > accessModes`](#cronJobs_pattern1_persistence_pvc_accessModes)
          - [2.1.21.4.1.1. stack helm chart > cronJobs > ^.*$ > persistence > pvc > accessModes > accessModes items](#cronJobs_pattern1_persistence_pvc_accessModes_items)
        - [2.1.21.4.2. Property `stack helm chart > cronJobs > ^.*$ > persistence > pvc > resources`](#cronJobs_pattern1_persistence_pvc_resources)
          - [2.1.21.4.2.1. Property `stack helm chart > cronJobs > ^.*$ > persistence > pvc > resources > requests`](#cronJobs_pattern1_persistence_pvc_resources_requests)
            - [2.1.21.4.2.1.1. Property `stack helm chart > cronJobs > ^.*$ > persistence > pvc > resources > requests > storage`](#cronJobs_pattern1_persistence_pvc_resources_requests_storage)
        - [2.1.21.4.3. Property `stack helm chart > cronJobs > ^.*$ > persistence > pvc > storageClassName`](#cronJobs_pattern1_persistence_pvc_storageClassName)
    - [2.1.22. Property `stack helm chart > cronJobs > ^.*$ > podAnnotations`](#cronJobs_pattern1_podAnnotations)
      - [2.1.22.1. Property `stack helm chart > cronJobs > ^.*$ > podAnnotations > config.linkerd.io/skip-outbound-ports`](#cronJobs_pattern1_podAnnotations_configlinkerdio/skip-outbound-ports)
      - [2.1.22.2. Property `stack helm chart > cronJobs > ^.*$ > podAnnotations > linkerd.io/inject`](#cronJobs_pattern1_podAnnotations_linkerdio/inject)
    - [2.1.23. Property `stack helm chart > cronJobs > ^.*$ > podLabels`](#cronJobs_pattern1_podLabels)
    - [2.1.24. Property `stack helm chart > cronJobs > ^.*$ > podSecurityContext`](#cronJobs_pattern1_podSecurityContext)
    - [2.1.25. Property `stack helm chart > cronJobs > ^.*$ > progressDeadlineSeconds`](#cronJobs_pattern1_progressDeadlineSeconds)
    - [2.1.26. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe`](#cronJobs_pattern1_readinessProbe)
      - [2.1.26.1. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > failureThreshold`](#cronJobs_pattern1_readinessProbe_failureThreshold)
      - [2.1.26.2. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > httpGet`](#cronJobs_pattern1_readinessProbe_httpGet)
        - [2.1.26.2.1. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > httpGet > path`](#cronJobs_pattern1_readinessProbe_httpGet_path)
        - [2.1.26.2.2. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > httpGet > port`](#cronJobs_pattern1_readinessProbe_httpGet_port)
          - [2.1.26.2.2.1. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > httpGet > port > oneOf > item 0`](#cronJobs_pattern1_readinessProbe_httpGet_port_oneOf_i0)
          - [2.1.26.2.2.2. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > httpGet > port > oneOf > item 1`](#cronJobs_pattern1_readinessProbe_httpGet_port_oneOf_i1)
        - [2.1.26.2.3. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > httpGet > scheme`](#cronJobs_pattern1_readinessProbe_httpGet_scheme)
      - [2.1.26.3. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > initialDelaySeconds`](#cronJobs_pattern1_readinessProbe_initialDelaySeconds)
      - [2.1.26.4. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > periodSeconds`](#cronJobs_pattern1_readinessProbe_periodSeconds)
      - [2.1.26.5. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > successThreshold`](#cronJobs_pattern1_readinessProbe_successThreshold)
      - [2.1.26.6. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > timeoutSeconds`](#cronJobs_pattern1_readinessProbe_timeoutSeconds)
    - [2.1.27. Property `stack helm chart > cronJobs > ^.*$ > replicaCount`](#cronJobs_pattern1_replicaCount)
    - [2.1.28. Property `stack helm chart > cronJobs > ^.*$ > resources`](#cronJobs_pattern1_resources)
      - [2.1.28.1. Property `stack helm chart > cronJobs > ^.*$ > resources > limits`](#cronJobs_pattern1_resources_limits)
        - [2.1.28.1.1. Property `stack helm chart > cronJobs > ^.*$ > resources > limits > cpu`](#cronJobs_pattern1_resources_limits_cpu)
          - [2.1.28.1.1.1. Property `stack helm chart > cronJobs > ^.*$ > resources > limits > cpu > oneOf > item 0`](#cronJobs_pattern1_resources_limits_cpu_oneOf_i0)
          - [2.1.28.1.1.2. Property `stack helm chart > cronJobs > ^.*$ > resources > limits > cpu > oneOf > item 1`](#cronJobs_pattern1_resources_limits_cpu_oneOf_i1)
        - [2.1.28.1.2. Property `stack helm chart > cronJobs > ^.*$ > resources > limits > memory`](#cronJobs_pattern1_resources_limits_memory)
      - [2.1.28.2. Property `stack helm chart > cronJobs > ^.*$ > resources > requests`](#cronJobs_pattern1_resources_requests)
        - [2.1.28.2.1. Property `stack helm chart > cronJobs > ^.*$ > resources > requests > cpu`](#cronJobs_pattern1_resources_requests_cpu)
          - [2.1.28.2.1.1. Property `stack helm chart > cronJobs > ^.*$ > resources > requests > cpu > oneOf > item 0`](#cronJobs_pattern1_resources_requests_cpu_oneOf_i0)
          - [2.1.28.2.1.2. Property `stack helm chart > cronJobs > ^.*$ > resources > requests > cpu > oneOf > item 1`](#cronJobs_pattern1_resources_requests_cpu_oneOf_i1)
        - [2.1.28.2.2. Property `stack helm chart > cronJobs > ^.*$ > resources > requests > memory`](#cronJobs_pattern1_resources_requests_memory)
    - [2.1.29. Property `stack helm chart > cronJobs > ^.*$ > restartPolicy`](#cronJobs_pattern1_restartPolicy)
    - [2.1.30. Property `stack helm chart > cronJobs > ^.*$ > securityContext`](#cronJobs_pattern1_securityContext)
    - [2.1.31. Property `stack helm chart > cronJobs > ^.*$ > service`](#cronJobs_pattern1_service)
      - [2.1.31.1. Property `stack helm chart > cronJobs > ^.*$ > service > port`](#cronJobs_pattern1_service_port)
      - [2.1.31.2. Property `stack helm chart > cronJobs > ^.*$ > service > type`](#cronJobs_pattern1_service_type)
    - [2.1.32. Property `stack helm chart > cronJobs > ^.*$ > serviceAccount`](#cronJobs_pattern1_serviceAccount)
      - [2.1.32.1. Property `stack helm chart > cronJobs > ^.*$ > serviceAccount > annotations`](#cronJobs_pattern1_serviceAccount_annotations)
      - [2.1.32.2. Property `stack helm chart > cronJobs > ^.*$ > serviceAccount > automount`](#cronJobs_pattern1_serviceAccount_automount)
      - [2.1.32.3. Property `stack helm chart > cronJobs > ^.*$ > serviceAccount > create`](#cronJobs_pattern1_serviceAccount_create)
      - [2.1.32.4. Property `stack helm chart > cronJobs > ^.*$ > serviceAccount > name`](#cronJobs_pattern1_serviceAccount_name)
    - [2.1.33. Property `stack helm chart > cronJobs > ^.*$ > shareProcessNamespace`](#cronJobs_pattern1_shareProcessNamespace)
    - [2.1.34. Property `stack helm chart > cronJobs > ^.*$ > sidecars`](#cronJobs_pattern1_sidecars)
    - [2.1.35. Property `stack helm chart > cronJobs > ^.*$ > startupProbe`](#cronJobs_pattern1_startupProbe)
      - [2.1.35.1. Property `stack helm chart > cronJobs > ^.*$ > startupProbe > enabled`](#cronJobs_pattern1_startupProbe_enabled)
      - [2.1.35.2. Property `stack helm chart > cronJobs > ^.*$ > startupProbe > exec`](#cronJobs_pattern1_startupProbe_exec)
        - [2.1.35.2.1. Property `stack helm chart > cronJobs > ^.*$ > startupProbe > exec > command`](#cronJobs_pattern1_startupProbe_exec_command)
          - [2.1.35.2.1.1. stack helm chart > cronJobs > ^.*$ > startupProbe > exec > command > command items](#cronJobs_pattern1_startupProbe_exec_command_items)
      - [2.1.35.3. Property `stack helm chart > cronJobs > ^.*$ > startupProbe > failureThreshold`](#cronJobs_pattern1_startupProbe_failureThreshold)
      - [2.1.35.4. Property `stack helm chart > cronJobs > ^.*$ > startupProbe > initialDelaySeconds`](#cronJobs_pattern1_startupProbe_initialDelaySeconds)
      - [2.1.35.5. Property `stack helm chart > cronJobs > ^.*$ > startupProbe > periodSeconds`](#cronJobs_pattern1_startupProbe_periodSeconds)
      - [2.1.35.6. Property `stack helm chart > cronJobs > ^.*$ > startupProbe > successThreshold`](#cronJobs_pattern1_startupProbe_successThreshold)
      - [2.1.35.7. Property `stack helm chart > cronJobs > ^.*$ > startupProbe > timeoutSeconds`](#cronJobs_pattern1_startupProbe_timeoutSeconds)
    - [2.1.36. Property `stack helm chart > cronJobs > ^.*$ > tolerations`](#cronJobs_pattern1_tolerations)
    - [2.1.37. Property `stack helm chart > cronJobs > ^.*$ > topologySpreadConstraints`](#cronJobs_pattern1_topologySpreadConstraints)
    - [2.1.38. Property `stack helm chart > cronJobs > ^.*$ > volumeMounts`](#cronJobs_pattern1_volumeMounts)
    - [2.1.39. Property `stack helm chart > cronJobs > ^.*$ > volumes`](#cronJobs_pattern1_volumes)
- [3. Property `stack helm chart > global`](#global)
  - [3.1. Property `stack helm chart > global > affinity`](#global_affinity)
  - [3.2. Property `stack helm chart > global > annotations`](#global_annotations)
  - [3.3. Property `stack helm chart > global > appContext`](#global_appContext)
    - [3.3.1. Property `stack helm chart > global > appContext > envContextConfigMapName`](#global_appContext_envContextConfigMapName)
    - [3.3.2. Property `stack helm chart > global > appContext > stackContextConfigMapName`](#global_appContext_stackContextConfigMapName)
  - [3.4. Property `stack helm chart > global > appSecrets`](#global_appSecrets)
    - [3.4.1. Property `stack helm chart > global > appSecrets > clusterSecret`](#global_appSecrets_clusterSecret)
      - [3.4.1.1. Property `stack helm chart > global > appSecrets > clusterSecret > secretKey`](#global_appSecrets_clusterSecret_secretKey)
      - [3.4.1.2. Property `stack helm chart > global > appSecrets > clusterSecret > secretName`](#global_appSecrets_clusterSecret_secretName)
    - [3.4.2. Property `stack helm chart > global > appSecrets > envSecret`](#global_appSecrets_envSecret)
      - [3.4.2.1. Property `stack helm chart > global > appSecrets > envSecret > secretKey`](#global_appSecrets_envSecret_secretKey)
      - [3.4.2.2. Property `stack helm chart > global > appSecrets > envSecret > secretName`](#global_appSecrets_envSecret_secretName)
    - [3.4.3. Property `stack helm chart > global > appSecrets > stackSecret`](#global_appSecrets_stackSecret)
      - [3.4.3.1. Property `stack helm chart > global > appSecrets > stackSecret > secretKey`](#global_appSecrets_stackSecret_secretKey)
      - [3.4.3.2. Property `stack helm chart > global > appSecrets > stackSecret > secretName`](#global_appSecrets_stackSecret_secretName)
  - [3.5. Property `stack helm chart > global > args`](#global_args)
    - [3.5.1. stack helm chart > global > args > args items](#global_args_items)
  - [3.6. Property `stack helm chart > global > autoscaling`](#global_autoscaling)
    - [3.6.1. Property `stack helm chart > global > autoscaling > enabled`](#global_autoscaling_enabled)
    - [3.6.2. Property `stack helm chart > global > autoscaling > maxReplicas`](#global_autoscaling_maxReplicas)
    - [3.6.3. Property `stack helm chart > global > autoscaling > minReplicas`](#global_autoscaling_minReplicas)
    - [3.6.4. Property `stack helm chart > global > autoscaling > targetCPUUtilizationPercentage`](#global_autoscaling_targetCPUUtilizationPercentage)
    - [3.6.5. Property `stack helm chart > global > autoscaling > targetMemoryUtilizationPercentage`](#global_autoscaling_targetMemoryUtilizationPercentage)
  - [3.7. Property `stack helm chart > global > command`](#global_command)
    - [3.7.1. stack helm chart > global > command > command items](#global_command_items)
  - [3.8. Property `stack helm chart > global > deploymentStage`](#global_deploymentStage)
  - [3.9. Property `stack helm chart > global > dnsPolicy`](#global_dnsPolicy)
  - [3.10. Property `stack helm chart > global > env`](#global_env)
    - [3.10.1. stack helm chart > global > env > env items](#global_env_items)
      - [3.10.1.1. Property `stack helm chart > global > env > env items > name`](#global_env_items_name)
      - [3.10.1.2. Property `stack helm chart > global > env > env items > value`](#global_env_items_value)
  - [3.11. Property `stack helm chart > global > envFrom`](#global_envFrom)
    - [3.11.1. stack helm chart > global > envFrom > envFrom items](#global_envFrom_items)
      - [3.11.1.1. Property `stack helm chart > global > envFrom > envFrom items > configMapRef`](#global_envFrom_items_configMapRef)
      - [3.11.1.2. Property `stack helm chart > global > envFrom > envFrom items > prefix`](#global_envFrom_items_prefix)
      - [3.11.1.3. Property `stack helm chart > global > envFrom > envFrom items > secretRef`](#global_envFrom_items_secretRef)
  - [3.12. Property `stack helm chart > global > fullnameOverride`](#global_fullnameOverride)
  - [3.13. Property `stack helm chart > global > image`](#global_image)
    - [3.13.1. Property `stack helm chart > global > image > pullPolicy`](#global_image_pullPolicy)
    - [3.13.2. Property `stack helm chart > global > image > repository`](#global_image_repository)
    - [3.13.3. Property `stack helm chart > global > image > tag`](#global_image_tag)
  - [3.14. Property `stack helm chart > global > imagePullSecrets`](#global_imagePullSecrets)
    - [3.14.1. stack helm chart > global > imagePullSecrets > imagePullSecrets items](#global_imagePullSecrets_items)
  - [3.15. Property `stack helm chart > global > ingress`](#global_ingress)
    - [3.15.1. Property `stack helm chart > global > ingress > annotations`](#global_ingress_annotations)
      - [3.15.1.1. Property `stack helm chart > global > ingress > annotations > nginx.ingress.kubernetes.io/affinity`](#global_ingress_annotations_nginxingresskubernetesio/affinity)
      - [3.15.1.2. Property `stack helm chart > global > ingress > annotations > nginx.ingress.kubernetes.io/proxy-connect-timeout`](#global_ingress_annotations_nginxingresskubernetesio/proxy-connect-timeout)
      - [3.15.1.3. Property `stack helm chart > global > ingress > annotations > nginx.ingress.kubernetes.io/proxy-read-timeout`](#global_ingress_annotations_nginxingresskubernetesio/proxy-read-timeout)
      - [3.15.1.4. Property `stack helm chart > global > ingress > annotations > nginx.ingress.kubernetes.io/proxy-send-timeout`](#global_ingress_annotations_nginxingresskubernetesio/proxy-send-timeout)
      - [3.15.1.5. Property `stack helm chart > global > ingress > annotations > nginx.ingress.kubernetes.io/session-cookie-max-age`](#global_ingress_annotations_nginxingresskubernetesio/session-cookie-max-age)
      - [3.15.1.6. Property `stack helm chart > global > ingress > annotations > nginx.ingress.kubernetes.io/session-cookie-name`](#global_ingress_annotations_nginxingresskubernetesio/session-cookie-name)
    - [3.15.2. Property `stack helm chart > global > ingress > className`](#global_ingress_className)
    - [3.15.3. Property `stack helm chart > global > ingress > enabled`](#global_ingress_enabled)
    - [3.15.4. Property `stack helm chart > global > ingress > host`](#global_ingress_host)
    - [3.15.5. Property `stack helm chart > global > ingress > oidcProtected`](#global_ingress_oidcProtected)
    - [3.15.6. Property `stack helm chart > global > ingress > paths`](#global_ingress_paths)
      - [3.15.6.1. stack helm chart > global > ingress > paths > paths items](#global_ingress_paths_items)
        - [3.15.6.1.1. Property `stack helm chart > global > ingress > paths > paths items > path`](#global_ingress_paths_items_path)
        - [3.15.6.1.2. Property `stack helm chart > global > ingress > paths > paths items > pathType`](#global_ingress_paths_items_pathType)
    - [3.15.7. Property `stack helm chart > global > ingress > rules`](#global_ingress_rules)
    - [3.15.8. Property `stack helm chart > global > ingress > tls`](#global_ingress_tls)
  - [3.16. Property `stack helm chart > global > initContainers`](#global_initContainers)
  - [3.17. Property `stack helm chart > global > livenessProbe`](#global_livenessProbe)
    - [3.17.1. Property `stack helm chart > global > livenessProbe > failureThreshold`](#global_livenessProbe_failureThreshold)
    - [3.17.2. Property `stack helm chart > global > livenessProbe > httpGet`](#global_livenessProbe_httpGet)
      - [3.17.2.1. Property `stack helm chart > global > livenessProbe > httpGet > path`](#global_livenessProbe_httpGet_path)
      - [3.17.2.2. Property `stack helm chart > global > livenessProbe > httpGet > port`](#global_livenessProbe_httpGet_port)
        - [3.17.2.2.1. Property `stack helm chart > global > livenessProbe > httpGet > port > oneOf > item 0`](#global_livenessProbe_httpGet_port_oneOf_i0)
        - [3.17.2.2.2. Property `stack helm chart > global > livenessProbe > httpGet > port > oneOf > item 1`](#global_livenessProbe_httpGet_port_oneOf_i1)
      - [3.17.2.3. Property `stack helm chart > global > livenessProbe > httpGet > scheme`](#global_livenessProbe_httpGet_scheme)
    - [3.17.3. Property `stack helm chart > global > livenessProbe > initialDelaySeconds`](#global_livenessProbe_initialDelaySeconds)
    - [3.17.4. Property `stack helm chart > global > livenessProbe > periodSeconds`](#global_livenessProbe_periodSeconds)
    - [3.17.5. Property `stack helm chart > global > livenessProbe > successThreshold`](#global_livenessProbe_successThreshold)
    - [3.17.6. Property `stack helm chart > global > livenessProbe > timeoutSeconds`](#global_livenessProbe_timeoutSeconds)
  - [3.18. Property `stack helm chart > global > nameOverride`](#global_nameOverride)
  - [3.19. Property `stack helm chart > global > nodeSelector`](#global_nodeSelector)
    - [3.19.1. Property `stack helm chart > global > nodeSelector > kubernetes.io/arch`](#global_nodeSelector_kubernetesio/arch)
  - [3.20. Property `stack helm chart > global > oidcProxy`](#global_oidcProxy)
    - [3.20.1. Property `stack helm chart > global > oidcProxy > additionalHeaders`](#global_oidcProxy_additionalHeaders)
    - [3.20.2. Property `stack helm chart > global > oidcProxy > additionalSecrets`](#global_oidcProxy_additionalSecrets)
    - [3.20.3. Property `stack helm chart > global > oidcProxy > annotations`](#global_oidcProxy_annotations)
    - [3.20.4. Property `stack helm chart > global > oidcProxy > cookieRefresh`](#global_oidcProxy_cookieRefresh)
    - [3.20.5. Property `stack helm chart > global > oidcProxy > enabled`](#global_oidcProxy_enabled)
    - [3.20.6. Property `stack helm chart > global > oidcProxy > extraArgs`](#global_oidcProxy_extraArgs)
      - [3.20.6.1. stack helm chart > global > oidcProxy > extraArgs > extraArgs items](#global_oidcProxy_extraArgs_items)
    - [3.20.7. Property `stack helm chart > global > oidcProxy > image`](#global_oidcProxy_image)
      - [3.20.7.1. Property `stack helm chart > global > oidcProxy > image > repository`](#global_oidcProxy_image_repository)
      - [3.20.7.2. Property `stack helm chart > global > oidcProxy > image > tag`](#global_oidcProxy_image_tag)
    - [3.20.8. Property `stack helm chart > global > oidcProxy > replicaCount`](#global_oidcProxy_replicaCount)
    - [3.20.9. Property `stack helm chart > global > oidcProxy > resources`](#global_oidcProxy_resources)
      - [3.20.9.1. Property `stack helm chart > global > oidcProxy > resources > limits`](#global_oidcProxy_resources_limits)
        - [3.20.9.1.1. Property `stack helm chart > global > oidcProxy > resources > limits > cpu`](#global_oidcProxy_resources_limits_cpu)
          - [3.20.9.1.1.1. Property `stack helm chart > global > oidcProxy > resources > limits > cpu > oneOf > item 0`](#global_oidcProxy_resources_limits_cpu_oneOf_i0)
          - [3.20.9.1.1.2. Property `stack helm chart > global > oidcProxy > resources > limits > cpu > oneOf > item 1`](#global_oidcProxy_resources_limits_cpu_oneOf_i1)
        - [3.20.9.1.2. Property `stack helm chart > global > oidcProxy > resources > limits > memory`](#global_oidcProxy_resources_limits_memory)
      - [3.20.9.2. Property `stack helm chart > global > oidcProxy > resources > requests`](#global_oidcProxy_resources_requests)
        - [3.20.9.2.1. Property `stack helm chart > global > oidcProxy > resources > requests > cpu`](#global_oidcProxy_resources_requests_cpu)
          - [3.20.9.2.1.1. Property `stack helm chart > global > oidcProxy > resources > requests > cpu > oneOf > item 0`](#global_oidcProxy_resources_requests_cpu_oneOf_i0)
          - [3.20.9.2.1.2. Property `stack helm chart > global > oidcProxy > resources > requests > cpu > oneOf > item 1`](#global_oidcProxy_resources_requests_cpu_oneOf_i1)
        - [3.20.9.2.2. Property `stack helm chart > global > oidcProxy > resources > requests > memory`](#global_oidcProxy_resources_requests_memory)
    - [3.20.10. Property `stack helm chart > global > oidcProxy > skipAuth`](#global_oidcProxy_skipAuth)
      - [3.20.10.1. stack helm chart > global > oidcProxy > skipAuth > skipAuth items](#global_oidcProxy_skipAuth_items)
        - [3.20.10.1.1. Property `stack helm chart > global > oidcProxy > skipAuth > skipAuth items > method`](#global_oidcProxy_skipAuth_items_method)
        - [3.20.10.1.2. Property `stack helm chart > global > oidcProxy > skipAuth > skipAuth items > path`](#global_oidcProxy_skipAuth_items_path)
    - [3.20.11. Property `stack helm chart > global > oidcProxy > volumeMounts`](#global_oidcProxy_volumeMounts)
  - [3.21. Property `stack helm chart > global > persistence`](#global_persistence)
    - [3.21.1. Property `stack helm chart > global > persistence > enabled`](#global_persistence_enabled)
    - [3.21.2. Property `stack helm chart > global > persistence > existingClaim`](#global_persistence_existingClaim)
    - [3.21.3. Property `stack helm chart > global > persistence > mountPath`](#global_persistence_mountPath)
    - [3.21.4. Property `stack helm chart > global > persistence > pvc`](#global_persistence_pvc)
      - [3.21.4.1. Property `stack helm chart > global > persistence > pvc > accessModes`](#global_persistence_pvc_accessModes)
        - [3.21.4.1.1. stack helm chart > global > persistence > pvc > accessModes > accessModes items](#global_persistence_pvc_accessModes_items)
      - [3.21.4.2. Property `stack helm chart > global > persistence > pvc > resources`](#global_persistence_pvc_resources)
        - [3.21.4.2.1. Property `stack helm chart > global > persistence > pvc > resources > requests`](#global_persistence_pvc_resources_requests)
          - [3.21.4.2.1.1. Property `stack helm chart > global > persistence > pvc > resources > requests > storage`](#global_persistence_pvc_resources_requests_storage)
      - [3.21.4.3. Property `stack helm chart > global > persistence > pvc > storageClassName`](#global_persistence_pvc_storageClassName)
  - [3.22. Property `stack helm chart > global > podAnnotations`](#global_podAnnotations)
    - [3.22.1. Property `stack helm chart > global > podAnnotations > config.linkerd.io/skip-outbound-ports`](#global_podAnnotations_configlinkerdio/skip-outbound-ports)
    - [3.22.2. Property `stack helm chart > global > podAnnotations > linkerd.io/inject`](#global_podAnnotations_linkerdio/inject)
  - [3.23. Property `stack helm chart > global > podLabels`](#global_podLabels)
  - [3.24. Property `stack helm chart > global > podSecurityContext`](#global_podSecurityContext)
  - [3.25. Property `stack helm chart > global > progressDeadlineSeconds`](#global_progressDeadlineSeconds)
  - [3.26. Property `stack helm chart > global > readinessProbe`](#global_readinessProbe)
    - [3.26.1. Property `stack helm chart > global > readinessProbe > failureThreshold`](#global_readinessProbe_failureThreshold)
    - [3.26.2. Property `stack helm chart > global > readinessProbe > httpGet`](#global_readinessProbe_httpGet)
      - [3.26.2.1. Property `stack helm chart > global > readinessProbe > httpGet > path`](#global_readinessProbe_httpGet_path)
      - [3.26.2.2. Property `stack helm chart > global > readinessProbe > httpGet > port`](#global_readinessProbe_httpGet_port)
        - [3.26.2.2.1. Property `stack helm chart > global > readinessProbe > httpGet > port > oneOf > item 0`](#global_readinessProbe_httpGet_port_oneOf_i0)
        - [3.26.2.2.2. Property `stack helm chart > global > readinessProbe > httpGet > port > oneOf > item 1`](#global_readinessProbe_httpGet_port_oneOf_i1)
      - [3.26.2.3. Property `stack helm chart > global > readinessProbe > httpGet > scheme`](#global_readinessProbe_httpGet_scheme)
    - [3.26.3. Property `stack helm chart > global > readinessProbe > initialDelaySeconds`](#global_readinessProbe_initialDelaySeconds)
    - [3.26.4. Property `stack helm chart > global > readinessProbe > periodSeconds`](#global_readinessProbe_periodSeconds)
    - [3.26.5. Property `stack helm chart > global > readinessProbe > successThreshold`](#global_readinessProbe_successThreshold)
    - [3.26.6. Property `stack helm chart > global > readinessProbe > timeoutSeconds`](#global_readinessProbe_timeoutSeconds)
  - [3.27. Property `stack helm chart > global > replicaCount`](#global_replicaCount)
  - [3.28. Property `stack helm chart > global > resources`](#global_resources)
    - [3.28.1. Property `stack helm chart > global > resources > limits`](#global_resources_limits)
      - [3.28.1.1. Property `stack helm chart > global > resources > limits > cpu`](#global_resources_limits_cpu)
        - [3.28.1.1.1. Property `stack helm chart > global > resources > limits > cpu > oneOf > item 0`](#global_resources_limits_cpu_oneOf_i0)
        - [3.28.1.1.2. Property `stack helm chart > global > resources > limits > cpu > oneOf > item 1`](#global_resources_limits_cpu_oneOf_i1)
      - [3.28.1.2. Property `stack helm chart > global > resources > limits > memory`](#global_resources_limits_memory)
    - [3.28.2. Property `stack helm chart > global > resources > requests`](#global_resources_requests)
      - [3.28.2.1. Property `stack helm chart > global > resources > requests > cpu`](#global_resources_requests_cpu)
        - [3.28.2.1.1. Property `stack helm chart > global > resources > requests > cpu > oneOf > item 0`](#global_resources_requests_cpu_oneOf_i0)
        - [3.28.2.1.2. Property `stack helm chart > global > resources > requests > cpu > oneOf > item 1`](#global_resources_requests_cpu_oneOf_i1)
      - [3.28.2.2. Property `stack helm chart > global > resources > requests > memory`](#global_resources_requests_memory)
  - [3.29. Property `stack helm chart > global > restartPolicy`](#global_restartPolicy)
  - [3.30. Property `stack helm chart > global > securityContext`](#global_securityContext)
  - [3.31. Property `stack helm chart > global > service`](#global_service)
    - [3.31.1. Property `stack helm chart > global > service > port`](#global_service_port)
    - [3.31.2. Property `stack helm chart > global > service > type`](#global_service_type)
  - [3.32. Property `stack helm chart > global > serviceAccount`](#global_serviceAccount)
    - [3.32.1. Property `stack helm chart > global > serviceAccount > annotations`](#global_serviceAccount_annotations)
    - [3.32.2. Property `stack helm chart > global > serviceAccount > automount`](#global_serviceAccount_automount)
    - [3.32.3. Property `stack helm chart > global > serviceAccount > create`](#global_serviceAccount_create)
    - [3.32.4. Property `stack helm chart > global > serviceAccount > name`](#global_serviceAccount_name)
  - [3.33. Property `stack helm chart > global > shareProcessNamespace`](#global_shareProcessNamespace)
  - [3.34. Property `stack helm chart > global > sidecars`](#global_sidecars)
  - [3.35. Property `stack helm chart > global > startupProbe`](#global_startupProbe)
    - [3.35.1. Property `stack helm chart > global > startupProbe > enabled`](#global_startupProbe_enabled)
    - [3.35.2. Property `stack helm chart > global > startupProbe > exec`](#global_startupProbe_exec)
      - [3.35.2.1. Property `stack helm chart > global > startupProbe > exec > command`](#global_startupProbe_exec_command)
        - [3.35.2.1.1. stack helm chart > global > startupProbe > exec > command > command items](#global_startupProbe_exec_command_items)
    - [3.35.3. Property `stack helm chart > global > startupProbe > failureThreshold`](#global_startupProbe_failureThreshold)
    - [3.35.4. Property `stack helm chart > global > startupProbe > initialDelaySeconds`](#global_startupProbe_initialDelaySeconds)
    - [3.35.5. Property `stack helm chart > global > startupProbe > periodSeconds`](#global_startupProbe_periodSeconds)
    - [3.35.6. Property `stack helm chart > global > startupProbe > successThreshold`](#global_startupProbe_successThreshold)
    - [3.35.7. Property `stack helm chart > global > startupProbe > timeoutSeconds`](#global_startupProbe_timeoutSeconds)
  - [3.36. Property `stack helm chart > global > tolerations`](#global_tolerations)
  - [3.37. Property `stack helm chart > global > topologySpreadConstraints`](#global_topologySpreadConstraints)
  - [3.38. Property `stack helm chart > global > volumeMounts`](#global_volumeMounts)
  - [3.39. Property `stack helm chart > global > volumes`](#global_volumes)
- [4. Property `stack helm chart > jobs`](#jobs)
  - [4.1. Pattern Property `stack helm chart > jobs > global`](#jobs_pattern1)
    - [4.1.1. Property `stack helm chart > cronJobs > ^.*$ > affinity`](#cronJobs_pattern1_affinity)
    - [4.1.2. Property `stack helm chart > cronJobs > ^.*$ > annotations`](#cronJobs_pattern1_annotations)
    - [4.1.3. Property `stack helm chart > cronJobs > ^.*$ > appContext`](#cronJobs_pattern1_appContext)
      - [4.1.3.1. Property `stack helm chart > cronJobs > ^.*$ > appContext > envContextConfigMapName`](#cronJobs_pattern1_appContext_envContextConfigMapName)
      - [4.1.3.2. Property `stack helm chart > cronJobs > ^.*$ > appContext > stackContextConfigMapName`](#cronJobs_pattern1_appContext_stackContextConfigMapName)
    - [4.1.4. Property `stack helm chart > cronJobs > ^.*$ > appSecrets`](#cronJobs_pattern1_appSecrets)
      - [4.1.4.1. Property `stack helm chart > cronJobs > ^.*$ > appSecrets > clusterSecret`](#cronJobs_pattern1_appSecrets_clusterSecret)
        - [4.1.4.1.1. Property `stack helm chart > cronJobs > ^.*$ > appSecrets > clusterSecret > secretKey`](#cronJobs_pattern1_appSecrets_clusterSecret_secretKey)
        - [4.1.4.1.2. Property `stack helm chart > cronJobs > ^.*$ > appSecrets > clusterSecret > secretName`](#cronJobs_pattern1_appSecrets_clusterSecret_secretName)
      - [4.1.4.2. Property `stack helm chart > cronJobs > ^.*$ > appSecrets > envSecret`](#cronJobs_pattern1_appSecrets_envSecret)
        - [4.1.4.2.1. Property `stack helm chart > cronJobs > ^.*$ > appSecrets > envSecret > secretKey`](#cronJobs_pattern1_appSecrets_envSecret_secretKey)
        - [4.1.4.2.2. Property `stack helm chart > cronJobs > ^.*$ > appSecrets > envSecret > secretName`](#cronJobs_pattern1_appSecrets_envSecret_secretName)
      - [4.1.4.3. Property `stack helm chart > cronJobs > ^.*$ > appSecrets > stackSecret`](#cronJobs_pattern1_appSecrets_stackSecret)
        - [4.1.4.3.1. Property `stack helm chart > cronJobs > ^.*$ > appSecrets > stackSecret > secretKey`](#cronJobs_pattern1_appSecrets_stackSecret_secretKey)
        - [4.1.4.3.2. Property `stack helm chart > cronJobs > ^.*$ > appSecrets > stackSecret > secretName`](#cronJobs_pattern1_appSecrets_stackSecret_secretName)
    - [4.1.5. Property `stack helm chart > cronJobs > ^.*$ > args`](#cronJobs_pattern1_args)
      - [4.1.5.1. stack helm chart > cronJobs > ^.*$ > args > args items](#cronJobs_pattern1_args_items)
    - [4.1.6. Property `stack helm chart > cronJobs > ^.*$ > autoscaling`](#cronJobs_pattern1_autoscaling)
      - [4.1.6.1. Property `stack helm chart > cronJobs > ^.*$ > autoscaling > enabled`](#cronJobs_pattern1_autoscaling_enabled)
      - [4.1.6.2. Property `stack helm chart > cronJobs > ^.*$ > autoscaling > maxReplicas`](#cronJobs_pattern1_autoscaling_maxReplicas)
      - [4.1.6.3. Property `stack helm chart > cronJobs > ^.*$ > autoscaling > minReplicas`](#cronJobs_pattern1_autoscaling_minReplicas)
      - [4.1.6.4. Property `stack helm chart > cronJobs > ^.*$ > autoscaling > targetCPUUtilizationPercentage`](#cronJobs_pattern1_autoscaling_targetCPUUtilizationPercentage)
      - [4.1.6.5. Property `stack helm chart > cronJobs > ^.*$ > autoscaling > targetMemoryUtilizationPercentage`](#cronJobs_pattern1_autoscaling_targetMemoryUtilizationPercentage)
    - [4.1.7. Property `stack helm chart > cronJobs > ^.*$ > command`](#cronJobs_pattern1_command)
      - [4.1.7.1. stack helm chart > cronJobs > ^.*$ > command > command items](#cronJobs_pattern1_command_items)
    - [4.1.8. Property `stack helm chart > cronJobs > ^.*$ > deploymentStage`](#cronJobs_pattern1_deploymentStage)
    - [4.1.9. Property `stack helm chart > cronJobs > ^.*$ > dnsPolicy`](#cronJobs_pattern1_dnsPolicy)
    - [4.1.10. Property `stack helm chart > cronJobs > ^.*$ > env`](#cronJobs_pattern1_env)
      - [4.1.10.1. stack helm chart > cronJobs > ^.*$ > env > env items](#cronJobs_pattern1_env_items)
        - [4.1.10.1.1. Property `stack helm chart > cronJobs > ^.*$ > env > env items > name`](#cronJobs_pattern1_env_items_name)
        - [4.1.10.1.2. Property `stack helm chart > cronJobs > ^.*$ > env > env items > value`](#cronJobs_pattern1_env_items_value)
    - [4.1.11. Property `stack helm chart > cronJobs > ^.*$ > envFrom`](#cronJobs_pattern1_envFrom)
      - [4.1.11.1. stack helm chart > cronJobs > ^.*$ > envFrom > envFrom items](#cronJobs_pattern1_envFrom_items)
        - [4.1.11.1.1. Property `stack helm chart > cronJobs > ^.*$ > envFrom > envFrom items > configMapRef`](#cronJobs_pattern1_envFrom_items_configMapRef)
        - [4.1.11.1.2. Property `stack helm chart > cronJobs > ^.*$ > envFrom > envFrom items > prefix`](#cronJobs_pattern1_envFrom_items_prefix)
        - [4.1.11.1.3. Property `stack helm chart > cronJobs > ^.*$ > envFrom > envFrom items > secretRef`](#cronJobs_pattern1_envFrom_items_secretRef)
    - [4.1.12. Property `stack helm chart > cronJobs > ^.*$ > fullnameOverride`](#cronJobs_pattern1_fullnameOverride)
    - [4.1.13. Property `stack helm chart > cronJobs > ^.*$ > image`](#cronJobs_pattern1_image)
      - [4.1.13.1. Property `stack helm chart > cronJobs > ^.*$ > image > pullPolicy`](#cronJobs_pattern1_image_pullPolicy)
      - [4.1.13.2. Property `stack helm chart > cronJobs > ^.*$ > image > repository`](#cronJobs_pattern1_image_repository)
      - [4.1.13.3. Property `stack helm chart > cronJobs > ^.*$ > image > tag`](#cronJobs_pattern1_image_tag)
    - [4.1.14. Property `stack helm chart > cronJobs > ^.*$ > imagePullSecrets`](#cronJobs_pattern1_imagePullSecrets)
      - [4.1.14.1. stack helm chart > cronJobs > ^.*$ > imagePullSecrets > imagePullSecrets items](#cronJobs_pattern1_imagePullSecrets_items)
    - [4.1.15. Property `stack helm chart > cronJobs > ^.*$ > ingress`](#cronJobs_pattern1_ingress)
      - [4.1.15.1. Property `stack helm chart > cronJobs > ^.*$ > ingress > annotations`](#cronJobs_pattern1_ingress_annotations)
        - [4.1.15.1.1. Property `stack helm chart > cronJobs > ^.*$ > ingress > annotations > nginx.ingress.kubernetes.io/affinity`](#cronJobs_pattern1_ingress_annotations_nginxingresskubernetesio/affinity)
        - [4.1.15.1.2. Property `stack helm chart > cronJobs > ^.*$ > ingress > annotations > nginx.ingress.kubernetes.io/proxy-connect-timeout`](#cronJobs_pattern1_ingress_annotations_nginxingresskubernetesio/proxy-connect-timeout)
        - [4.1.15.1.3. Property `stack helm chart > cronJobs > ^.*$ > ingress > annotations > nginx.ingress.kubernetes.io/proxy-read-timeout`](#cronJobs_pattern1_ingress_annotations_nginxingresskubernetesio/proxy-read-timeout)
        - [4.1.15.1.4. Property `stack helm chart > cronJobs > ^.*$ > ingress > annotations > nginx.ingress.kubernetes.io/proxy-send-timeout`](#cronJobs_pattern1_ingress_annotations_nginxingresskubernetesio/proxy-send-timeout)
        - [4.1.15.1.5. Property `stack helm chart > cronJobs > ^.*$ > ingress > annotations > nginx.ingress.kubernetes.io/session-cookie-max-age`](#cronJobs_pattern1_ingress_annotations_nginxingresskubernetesio/session-cookie-max-age)
        - [4.1.15.1.6. Property `stack helm chart > cronJobs > ^.*$ > ingress > annotations > nginx.ingress.kubernetes.io/session-cookie-name`](#cronJobs_pattern1_ingress_annotations_nginxingresskubernetesio/session-cookie-name)
      - [4.1.15.2. Property `stack helm chart > cronJobs > ^.*$ > ingress > className`](#cronJobs_pattern1_ingress_className)
      - [4.1.15.3. Property `stack helm chart > cronJobs > ^.*$ > ingress > enabled`](#cronJobs_pattern1_ingress_enabled)
      - [4.1.15.4. Property `stack helm chart > cronJobs > ^.*$ > ingress > host`](#cronJobs_pattern1_ingress_host)
      - [4.1.15.5. Property `stack helm chart > cronJobs > ^.*$ > ingress > oidcProtected`](#cronJobs_pattern1_ingress_oidcProtected)
      - [4.1.15.6. Property `stack helm chart > cronJobs > ^.*$ > ingress > paths`](#cronJobs_pattern1_ingress_paths)
        - [4.1.15.6.1. stack helm chart > cronJobs > ^.*$ > ingress > paths > paths items](#cronJobs_pattern1_ingress_paths_items)
          - [4.1.15.6.1.1. Property `stack helm chart > cronJobs > ^.*$ > ingress > paths > paths items > path`](#cronJobs_pattern1_ingress_paths_items_path)
          - [4.1.15.6.1.2. Property `stack helm chart > cronJobs > ^.*$ > ingress > paths > paths items > pathType`](#cronJobs_pattern1_ingress_paths_items_pathType)
      - [4.1.15.7. Property `stack helm chart > cronJobs > ^.*$ > ingress > rules`](#cronJobs_pattern1_ingress_rules)
      - [4.1.15.8. Property `stack helm chart > cronJobs > ^.*$ > ingress > tls`](#cronJobs_pattern1_ingress_tls)
    - [4.1.16. Property `stack helm chart > cronJobs > ^.*$ > initContainers`](#cronJobs_pattern1_initContainers)
    - [4.1.17. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe`](#cronJobs_pattern1_livenessProbe)
      - [4.1.17.1. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > failureThreshold`](#cronJobs_pattern1_livenessProbe_failureThreshold)
      - [4.1.17.2. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > httpGet`](#cronJobs_pattern1_livenessProbe_httpGet)
        - [4.1.17.2.1. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > httpGet > path`](#cronJobs_pattern1_livenessProbe_httpGet_path)
        - [4.1.17.2.2. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > httpGet > port`](#cronJobs_pattern1_livenessProbe_httpGet_port)
          - [4.1.17.2.2.1. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > httpGet > port > oneOf > item 0`](#cronJobs_pattern1_livenessProbe_httpGet_port_oneOf_i0)
          - [4.1.17.2.2.2. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > httpGet > port > oneOf > item 1`](#cronJobs_pattern1_livenessProbe_httpGet_port_oneOf_i1)
        - [4.1.17.2.3. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > httpGet > scheme`](#cronJobs_pattern1_livenessProbe_httpGet_scheme)
      - [4.1.17.3. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > initialDelaySeconds`](#cronJobs_pattern1_livenessProbe_initialDelaySeconds)
      - [4.1.17.4. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > periodSeconds`](#cronJobs_pattern1_livenessProbe_periodSeconds)
      - [4.1.17.5. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > successThreshold`](#cronJobs_pattern1_livenessProbe_successThreshold)
      - [4.1.17.6. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > timeoutSeconds`](#cronJobs_pattern1_livenessProbe_timeoutSeconds)
    - [4.1.18. Property `stack helm chart > cronJobs > ^.*$ > nameOverride`](#cronJobs_pattern1_nameOverride)
    - [4.1.19. Property `stack helm chart > cronJobs > ^.*$ > nodeSelector`](#cronJobs_pattern1_nodeSelector)
      - [4.1.19.1. Property `stack helm chart > cronJobs > ^.*$ > nodeSelector > kubernetes.io/arch`](#cronJobs_pattern1_nodeSelector_kubernetesio/arch)
    - [4.1.20. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy`](#cronJobs_pattern1_oidcProxy)
      - [4.1.20.1. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > additionalHeaders`](#cronJobs_pattern1_oidcProxy_additionalHeaders)
      - [4.1.20.2. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > additionalSecrets`](#cronJobs_pattern1_oidcProxy_additionalSecrets)
      - [4.1.20.3. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > annotations`](#cronJobs_pattern1_oidcProxy_annotations)
      - [4.1.20.4. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > cookieRefresh`](#cronJobs_pattern1_oidcProxy_cookieRefresh)
      - [4.1.20.5. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > enabled`](#cronJobs_pattern1_oidcProxy_enabled)
      - [4.1.20.6. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > extraArgs`](#cronJobs_pattern1_oidcProxy_extraArgs)
        - [4.1.20.6.1. stack helm chart > cronJobs > ^.*$ > oidcProxy > extraArgs > extraArgs items](#cronJobs_pattern1_oidcProxy_extraArgs_items)
      - [4.1.20.7. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > image`](#cronJobs_pattern1_oidcProxy_image)
        - [4.1.20.7.1. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > image > repository`](#cronJobs_pattern1_oidcProxy_image_repository)
        - [4.1.20.7.2. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > image > tag`](#cronJobs_pattern1_oidcProxy_image_tag)
      - [4.1.20.8. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > replicaCount`](#cronJobs_pattern1_oidcProxy_replicaCount)
      - [4.1.20.9. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources`](#cronJobs_pattern1_oidcProxy_resources)
        - [4.1.20.9.1. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > limits`](#cronJobs_pattern1_oidcProxy_resources_limits)
          - [4.1.20.9.1.1. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > limits > cpu`](#cronJobs_pattern1_oidcProxy_resources_limits_cpu)
            - [4.1.20.9.1.1.1. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > limits > cpu > oneOf > item 0`](#cronJobs_pattern1_oidcProxy_resources_limits_cpu_oneOf_i0)
            - [4.1.20.9.1.1.2. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > limits > cpu > oneOf > item 1`](#cronJobs_pattern1_oidcProxy_resources_limits_cpu_oneOf_i1)
          - [4.1.20.9.1.2. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > limits > memory`](#cronJobs_pattern1_oidcProxy_resources_limits_memory)
        - [4.1.20.9.2. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > requests`](#cronJobs_pattern1_oidcProxy_resources_requests)
          - [4.1.20.9.2.1. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > requests > cpu`](#cronJobs_pattern1_oidcProxy_resources_requests_cpu)
            - [4.1.20.9.2.1.1. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > requests > cpu > oneOf > item 0`](#cronJobs_pattern1_oidcProxy_resources_requests_cpu_oneOf_i0)
            - [4.1.20.9.2.1.2. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > requests > cpu > oneOf > item 1`](#cronJobs_pattern1_oidcProxy_resources_requests_cpu_oneOf_i1)
          - [4.1.20.9.2.2. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > requests > memory`](#cronJobs_pattern1_oidcProxy_resources_requests_memory)
      - [4.1.20.10. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > skipAuth`](#cronJobs_pattern1_oidcProxy_skipAuth)
        - [4.1.20.10.1. stack helm chart > cronJobs > ^.*$ > oidcProxy > skipAuth > skipAuth items](#cronJobs_pattern1_oidcProxy_skipAuth_items)
          - [4.1.20.10.1.1. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > skipAuth > skipAuth items > method`](#cronJobs_pattern1_oidcProxy_skipAuth_items_method)
          - [4.1.20.10.1.2. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > skipAuth > skipAuth items > path`](#cronJobs_pattern1_oidcProxy_skipAuth_items_path)
      - [4.1.20.11. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > volumeMounts`](#cronJobs_pattern1_oidcProxy_volumeMounts)
    - [4.1.21. Property `stack helm chart > cronJobs > ^.*$ > persistence`](#cronJobs_pattern1_persistence)
      - [4.1.21.1. Property `stack helm chart > cronJobs > ^.*$ > persistence > enabled`](#cronJobs_pattern1_persistence_enabled)
      - [4.1.21.2. Property `stack helm chart > cronJobs > ^.*$ > persistence > existingClaim`](#cronJobs_pattern1_persistence_existingClaim)
      - [4.1.21.3. Property `stack helm chart > cronJobs > ^.*$ > persistence > mountPath`](#cronJobs_pattern1_persistence_mountPath)
      - [4.1.21.4. Property `stack helm chart > cronJobs > ^.*$ > persistence > pvc`](#cronJobs_pattern1_persistence_pvc)
        - [4.1.21.4.1. Property `stack helm chart > cronJobs > ^.*$ > persistence > pvc > accessModes`](#cronJobs_pattern1_persistence_pvc_accessModes)
          - [4.1.21.4.1.1. stack helm chart > cronJobs > ^.*$ > persistence > pvc > accessModes > accessModes items](#cronJobs_pattern1_persistence_pvc_accessModes_items)
        - [4.1.21.4.2. Property `stack helm chart > cronJobs > ^.*$ > persistence > pvc > resources`](#cronJobs_pattern1_persistence_pvc_resources)
          - [4.1.21.4.2.1. Property `stack helm chart > cronJobs > ^.*$ > persistence > pvc > resources > requests`](#cronJobs_pattern1_persistence_pvc_resources_requests)
            - [4.1.21.4.2.1.1. Property `stack helm chart > cronJobs > ^.*$ > persistence > pvc > resources > requests > storage`](#cronJobs_pattern1_persistence_pvc_resources_requests_storage)
        - [4.1.21.4.3. Property `stack helm chart > cronJobs > ^.*$ > persistence > pvc > storageClassName`](#cronJobs_pattern1_persistence_pvc_storageClassName)
    - [4.1.22. Property `stack helm chart > cronJobs > ^.*$ > podAnnotations`](#cronJobs_pattern1_podAnnotations)
      - [4.1.22.1. Property `stack helm chart > cronJobs > ^.*$ > podAnnotations > config.linkerd.io/skip-outbound-ports`](#cronJobs_pattern1_podAnnotations_configlinkerdio/skip-outbound-ports)
      - [4.1.22.2. Property `stack helm chart > cronJobs > ^.*$ > podAnnotations > linkerd.io/inject`](#cronJobs_pattern1_podAnnotations_linkerdio/inject)
    - [4.1.23. Property `stack helm chart > cronJobs > ^.*$ > podLabels`](#cronJobs_pattern1_podLabels)
    - [4.1.24. Property `stack helm chart > cronJobs > ^.*$ > podSecurityContext`](#cronJobs_pattern1_podSecurityContext)
    - [4.1.25. Property `stack helm chart > cronJobs > ^.*$ > progressDeadlineSeconds`](#cronJobs_pattern1_progressDeadlineSeconds)
    - [4.1.26. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe`](#cronJobs_pattern1_readinessProbe)
      - [4.1.26.1. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > failureThreshold`](#cronJobs_pattern1_readinessProbe_failureThreshold)
      - [4.1.26.2. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > httpGet`](#cronJobs_pattern1_readinessProbe_httpGet)
        - [4.1.26.2.1. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > httpGet > path`](#cronJobs_pattern1_readinessProbe_httpGet_path)
        - [4.1.26.2.2. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > httpGet > port`](#cronJobs_pattern1_readinessProbe_httpGet_port)
          - [4.1.26.2.2.1. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > httpGet > port > oneOf > item 0`](#cronJobs_pattern1_readinessProbe_httpGet_port_oneOf_i0)
          - [4.1.26.2.2.2. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > httpGet > port > oneOf > item 1`](#cronJobs_pattern1_readinessProbe_httpGet_port_oneOf_i1)
        - [4.1.26.2.3. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > httpGet > scheme`](#cronJobs_pattern1_readinessProbe_httpGet_scheme)
      - [4.1.26.3. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > initialDelaySeconds`](#cronJobs_pattern1_readinessProbe_initialDelaySeconds)
      - [4.1.26.4. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > periodSeconds`](#cronJobs_pattern1_readinessProbe_periodSeconds)
      - [4.1.26.5. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > successThreshold`](#cronJobs_pattern1_readinessProbe_successThreshold)
      - [4.1.26.6. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > timeoutSeconds`](#cronJobs_pattern1_readinessProbe_timeoutSeconds)
    - [4.1.27. Property `stack helm chart > cronJobs > ^.*$ > replicaCount`](#cronJobs_pattern1_replicaCount)
    - [4.1.28. Property `stack helm chart > cronJobs > ^.*$ > resources`](#cronJobs_pattern1_resources)
      - [4.1.28.1. Property `stack helm chart > cronJobs > ^.*$ > resources > limits`](#cronJobs_pattern1_resources_limits)
        - [4.1.28.1.1. Property `stack helm chart > cronJobs > ^.*$ > resources > limits > cpu`](#cronJobs_pattern1_resources_limits_cpu)
          - [4.1.28.1.1.1. Property `stack helm chart > cronJobs > ^.*$ > resources > limits > cpu > oneOf > item 0`](#cronJobs_pattern1_resources_limits_cpu_oneOf_i0)
          - [4.1.28.1.1.2. Property `stack helm chart > cronJobs > ^.*$ > resources > limits > cpu > oneOf > item 1`](#cronJobs_pattern1_resources_limits_cpu_oneOf_i1)
        - [4.1.28.1.2. Property `stack helm chart > cronJobs > ^.*$ > resources > limits > memory`](#cronJobs_pattern1_resources_limits_memory)
      - [4.1.28.2. Property `stack helm chart > cronJobs > ^.*$ > resources > requests`](#cronJobs_pattern1_resources_requests)
        - [4.1.28.2.1. Property `stack helm chart > cronJobs > ^.*$ > resources > requests > cpu`](#cronJobs_pattern1_resources_requests_cpu)
          - [4.1.28.2.1.1. Property `stack helm chart > cronJobs > ^.*$ > resources > requests > cpu > oneOf > item 0`](#cronJobs_pattern1_resources_requests_cpu_oneOf_i0)
          - [4.1.28.2.1.2. Property `stack helm chart > cronJobs > ^.*$ > resources > requests > cpu > oneOf > item 1`](#cronJobs_pattern1_resources_requests_cpu_oneOf_i1)
        - [4.1.28.2.2. Property `stack helm chart > cronJobs > ^.*$ > resources > requests > memory`](#cronJobs_pattern1_resources_requests_memory)
    - [4.1.29. Property `stack helm chart > cronJobs > ^.*$ > restartPolicy`](#cronJobs_pattern1_restartPolicy)
    - [4.1.30. Property `stack helm chart > cronJobs > ^.*$ > securityContext`](#cronJobs_pattern1_securityContext)
    - [4.1.31. Property `stack helm chart > cronJobs > ^.*$ > service`](#cronJobs_pattern1_service)
      - [4.1.31.1. Property `stack helm chart > cronJobs > ^.*$ > service > port`](#cronJobs_pattern1_service_port)
      - [4.1.31.2. Property `stack helm chart > cronJobs > ^.*$ > service > type`](#cronJobs_pattern1_service_type)
    - [4.1.32. Property `stack helm chart > cronJobs > ^.*$ > serviceAccount`](#cronJobs_pattern1_serviceAccount)
      - [4.1.32.1. Property `stack helm chart > cronJobs > ^.*$ > serviceAccount > annotations`](#cronJobs_pattern1_serviceAccount_annotations)
      - [4.1.32.2. Property `stack helm chart > cronJobs > ^.*$ > serviceAccount > automount`](#cronJobs_pattern1_serviceAccount_automount)
      - [4.1.32.3. Property `stack helm chart > cronJobs > ^.*$ > serviceAccount > create`](#cronJobs_pattern1_serviceAccount_create)
      - [4.1.32.4. Property `stack helm chart > cronJobs > ^.*$ > serviceAccount > name`](#cronJobs_pattern1_serviceAccount_name)
    - [4.1.33. Property `stack helm chart > cronJobs > ^.*$ > shareProcessNamespace`](#cronJobs_pattern1_shareProcessNamespace)
    - [4.1.34. Property `stack helm chart > cronJobs > ^.*$ > sidecars`](#cronJobs_pattern1_sidecars)
    - [4.1.35. Property `stack helm chart > cronJobs > ^.*$ > startupProbe`](#cronJobs_pattern1_startupProbe)
      - [4.1.35.1. Property `stack helm chart > cronJobs > ^.*$ > startupProbe > enabled`](#cronJobs_pattern1_startupProbe_enabled)
      - [4.1.35.2. Property `stack helm chart > cronJobs > ^.*$ > startupProbe > exec`](#cronJobs_pattern1_startupProbe_exec)
        - [4.1.35.2.1. Property `stack helm chart > cronJobs > ^.*$ > startupProbe > exec > command`](#cronJobs_pattern1_startupProbe_exec_command)
          - [4.1.35.2.1.1. stack helm chart > cronJobs > ^.*$ > startupProbe > exec > command > command items](#cronJobs_pattern1_startupProbe_exec_command_items)
      - [4.1.35.3. Property `stack helm chart > cronJobs > ^.*$ > startupProbe > failureThreshold`](#cronJobs_pattern1_startupProbe_failureThreshold)
      - [4.1.35.4. Property `stack helm chart > cronJobs > ^.*$ > startupProbe > initialDelaySeconds`](#cronJobs_pattern1_startupProbe_initialDelaySeconds)
      - [4.1.35.5. Property `stack helm chart > cronJobs > ^.*$ > startupProbe > periodSeconds`](#cronJobs_pattern1_startupProbe_periodSeconds)
      - [4.1.35.6. Property `stack helm chart > cronJobs > ^.*$ > startupProbe > successThreshold`](#cronJobs_pattern1_startupProbe_successThreshold)
      - [4.1.35.7. Property `stack helm chart > cronJobs > ^.*$ > startupProbe > timeoutSeconds`](#cronJobs_pattern1_startupProbe_timeoutSeconds)
    - [4.1.36. Property `stack helm chart > cronJobs > ^.*$ > tolerations`](#cronJobs_pattern1_tolerations)
    - [4.1.37. Property `stack helm chart > cronJobs > ^.*$ > topologySpreadConstraints`](#cronJobs_pattern1_topologySpreadConstraints)
    - [4.1.38. Property `stack helm chart > cronJobs > ^.*$ > volumeMounts`](#cronJobs_pattern1_volumeMounts)
    - [4.1.39. Property `stack helm chart > cronJobs > ^.*$ > volumes`](#cronJobs_pattern1_volumes)
- [5. Property `stack helm chart > services`](#services)
  - [5.1. Pattern Property `stack helm chart > services > global`](#services_pattern1)
    - [5.1.1. Property `stack helm chart > cronJobs > ^.*$ > affinity`](#cronJobs_pattern1_affinity)
    - [5.1.2. Property `stack helm chart > cronJobs > ^.*$ > annotations`](#cronJobs_pattern1_annotations)
    - [5.1.3. Property `stack helm chart > cronJobs > ^.*$ > appContext`](#cronJobs_pattern1_appContext)
      - [5.1.3.1. Property `stack helm chart > cronJobs > ^.*$ > appContext > envContextConfigMapName`](#cronJobs_pattern1_appContext_envContextConfigMapName)
      - [5.1.3.2. Property `stack helm chart > cronJobs > ^.*$ > appContext > stackContextConfigMapName`](#cronJobs_pattern1_appContext_stackContextConfigMapName)
    - [5.1.4. Property `stack helm chart > cronJobs > ^.*$ > appSecrets`](#cronJobs_pattern1_appSecrets)
      - [5.1.4.1. Property `stack helm chart > cronJobs > ^.*$ > appSecrets > clusterSecret`](#cronJobs_pattern1_appSecrets_clusterSecret)
        - [5.1.4.1.1. Property `stack helm chart > cronJobs > ^.*$ > appSecrets > clusterSecret > secretKey`](#cronJobs_pattern1_appSecrets_clusterSecret_secretKey)
        - [5.1.4.1.2. Property `stack helm chart > cronJobs > ^.*$ > appSecrets > clusterSecret > secretName`](#cronJobs_pattern1_appSecrets_clusterSecret_secretName)
      - [5.1.4.2. Property `stack helm chart > cronJobs > ^.*$ > appSecrets > envSecret`](#cronJobs_pattern1_appSecrets_envSecret)
        - [5.1.4.2.1. Property `stack helm chart > cronJobs > ^.*$ > appSecrets > envSecret > secretKey`](#cronJobs_pattern1_appSecrets_envSecret_secretKey)
        - [5.1.4.2.2. Property `stack helm chart > cronJobs > ^.*$ > appSecrets > envSecret > secretName`](#cronJobs_pattern1_appSecrets_envSecret_secretName)
      - [5.1.4.3. Property `stack helm chart > cronJobs > ^.*$ > appSecrets > stackSecret`](#cronJobs_pattern1_appSecrets_stackSecret)
        - [5.1.4.3.1. Property `stack helm chart > cronJobs > ^.*$ > appSecrets > stackSecret > secretKey`](#cronJobs_pattern1_appSecrets_stackSecret_secretKey)
        - [5.1.4.3.2. Property `stack helm chart > cronJobs > ^.*$ > appSecrets > stackSecret > secretName`](#cronJobs_pattern1_appSecrets_stackSecret_secretName)
    - [5.1.5. Property `stack helm chart > cronJobs > ^.*$ > args`](#cronJobs_pattern1_args)
      - [5.1.5.1. stack helm chart > cronJobs > ^.*$ > args > args items](#cronJobs_pattern1_args_items)
    - [5.1.6. Property `stack helm chart > cronJobs > ^.*$ > autoscaling`](#cronJobs_pattern1_autoscaling)
      - [5.1.6.1. Property `stack helm chart > cronJobs > ^.*$ > autoscaling > enabled`](#cronJobs_pattern1_autoscaling_enabled)
      - [5.1.6.2. Property `stack helm chart > cronJobs > ^.*$ > autoscaling > maxReplicas`](#cronJobs_pattern1_autoscaling_maxReplicas)
      - [5.1.6.3. Property `stack helm chart > cronJobs > ^.*$ > autoscaling > minReplicas`](#cronJobs_pattern1_autoscaling_minReplicas)
      - [5.1.6.4. Property `stack helm chart > cronJobs > ^.*$ > autoscaling > targetCPUUtilizationPercentage`](#cronJobs_pattern1_autoscaling_targetCPUUtilizationPercentage)
      - [5.1.6.5. Property `stack helm chart > cronJobs > ^.*$ > autoscaling > targetMemoryUtilizationPercentage`](#cronJobs_pattern1_autoscaling_targetMemoryUtilizationPercentage)
    - [5.1.7. Property `stack helm chart > cronJobs > ^.*$ > command`](#cronJobs_pattern1_command)
      - [5.1.7.1. stack helm chart > cronJobs > ^.*$ > command > command items](#cronJobs_pattern1_command_items)
    - [5.1.8. Property `stack helm chart > cronJobs > ^.*$ > deploymentStage`](#cronJobs_pattern1_deploymentStage)
    - [5.1.9. Property `stack helm chart > cronJobs > ^.*$ > dnsPolicy`](#cronJobs_pattern1_dnsPolicy)
    - [5.1.10. Property `stack helm chart > cronJobs > ^.*$ > env`](#cronJobs_pattern1_env)
      - [5.1.10.1. stack helm chart > cronJobs > ^.*$ > env > env items](#cronJobs_pattern1_env_items)
        - [5.1.10.1.1. Property `stack helm chart > cronJobs > ^.*$ > env > env items > name`](#cronJobs_pattern1_env_items_name)
        - [5.1.10.1.2. Property `stack helm chart > cronJobs > ^.*$ > env > env items > value`](#cronJobs_pattern1_env_items_value)
    - [5.1.11. Property `stack helm chart > cronJobs > ^.*$ > envFrom`](#cronJobs_pattern1_envFrom)
      - [5.1.11.1. stack helm chart > cronJobs > ^.*$ > envFrom > envFrom items](#cronJobs_pattern1_envFrom_items)
        - [5.1.11.1.1. Property `stack helm chart > cronJobs > ^.*$ > envFrom > envFrom items > configMapRef`](#cronJobs_pattern1_envFrom_items_configMapRef)
        - [5.1.11.1.2. Property `stack helm chart > cronJobs > ^.*$ > envFrom > envFrom items > prefix`](#cronJobs_pattern1_envFrom_items_prefix)
        - [5.1.11.1.3. Property `stack helm chart > cronJobs > ^.*$ > envFrom > envFrom items > secretRef`](#cronJobs_pattern1_envFrom_items_secretRef)
    - [5.1.12. Property `stack helm chart > cronJobs > ^.*$ > fullnameOverride`](#cronJobs_pattern1_fullnameOverride)
    - [5.1.13. Property `stack helm chart > cronJobs > ^.*$ > image`](#cronJobs_pattern1_image)
      - [5.1.13.1. Property `stack helm chart > cronJobs > ^.*$ > image > pullPolicy`](#cronJobs_pattern1_image_pullPolicy)
      - [5.1.13.2. Property `stack helm chart > cronJobs > ^.*$ > image > repository`](#cronJobs_pattern1_image_repository)
      - [5.1.13.3. Property `stack helm chart > cronJobs > ^.*$ > image > tag`](#cronJobs_pattern1_image_tag)
    - [5.1.14. Property `stack helm chart > cronJobs > ^.*$ > imagePullSecrets`](#cronJobs_pattern1_imagePullSecrets)
      - [5.1.14.1. stack helm chart > cronJobs > ^.*$ > imagePullSecrets > imagePullSecrets items](#cronJobs_pattern1_imagePullSecrets_items)
    - [5.1.15. Property `stack helm chart > cronJobs > ^.*$ > ingress`](#cronJobs_pattern1_ingress)
      - [5.1.15.1. Property `stack helm chart > cronJobs > ^.*$ > ingress > annotations`](#cronJobs_pattern1_ingress_annotations)
        - [5.1.15.1.1. Property `stack helm chart > cronJobs > ^.*$ > ingress > annotations > nginx.ingress.kubernetes.io/affinity`](#cronJobs_pattern1_ingress_annotations_nginxingresskubernetesio/affinity)
        - [5.1.15.1.2. Property `stack helm chart > cronJobs > ^.*$ > ingress > annotations > nginx.ingress.kubernetes.io/proxy-connect-timeout`](#cronJobs_pattern1_ingress_annotations_nginxingresskubernetesio/proxy-connect-timeout)
        - [5.1.15.1.3. Property `stack helm chart > cronJobs > ^.*$ > ingress > annotations > nginx.ingress.kubernetes.io/proxy-read-timeout`](#cronJobs_pattern1_ingress_annotations_nginxingresskubernetesio/proxy-read-timeout)
        - [5.1.15.1.4. Property `stack helm chart > cronJobs > ^.*$ > ingress > annotations > nginx.ingress.kubernetes.io/proxy-send-timeout`](#cronJobs_pattern1_ingress_annotations_nginxingresskubernetesio/proxy-send-timeout)
        - [5.1.15.1.5. Property `stack helm chart > cronJobs > ^.*$ > ingress > annotations > nginx.ingress.kubernetes.io/session-cookie-max-age`](#cronJobs_pattern1_ingress_annotations_nginxingresskubernetesio/session-cookie-max-age)
        - [5.1.15.1.6. Property `stack helm chart > cronJobs > ^.*$ > ingress > annotations > nginx.ingress.kubernetes.io/session-cookie-name`](#cronJobs_pattern1_ingress_annotations_nginxingresskubernetesio/session-cookie-name)
      - [5.1.15.2. Property `stack helm chart > cronJobs > ^.*$ > ingress > className`](#cronJobs_pattern1_ingress_className)
      - [5.1.15.3. Property `stack helm chart > cronJobs > ^.*$ > ingress > enabled`](#cronJobs_pattern1_ingress_enabled)
      - [5.1.15.4. Property `stack helm chart > cronJobs > ^.*$ > ingress > host`](#cronJobs_pattern1_ingress_host)
      - [5.1.15.5. Property `stack helm chart > cronJobs > ^.*$ > ingress > oidcProtected`](#cronJobs_pattern1_ingress_oidcProtected)
      - [5.1.15.6. Property `stack helm chart > cronJobs > ^.*$ > ingress > paths`](#cronJobs_pattern1_ingress_paths)
        - [5.1.15.6.1. stack helm chart > cronJobs > ^.*$ > ingress > paths > paths items](#cronJobs_pattern1_ingress_paths_items)
          - [5.1.15.6.1.1. Property `stack helm chart > cronJobs > ^.*$ > ingress > paths > paths items > path`](#cronJobs_pattern1_ingress_paths_items_path)
          - [5.1.15.6.1.2. Property `stack helm chart > cronJobs > ^.*$ > ingress > paths > paths items > pathType`](#cronJobs_pattern1_ingress_paths_items_pathType)
      - [5.1.15.7. Property `stack helm chart > cronJobs > ^.*$ > ingress > rules`](#cronJobs_pattern1_ingress_rules)
      - [5.1.15.8. Property `stack helm chart > cronJobs > ^.*$ > ingress > tls`](#cronJobs_pattern1_ingress_tls)
    - [5.1.16. Property `stack helm chart > cronJobs > ^.*$ > initContainers`](#cronJobs_pattern1_initContainers)
    - [5.1.17. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe`](#cronJobs_pattern1_livenessProbe)
      - [5.1.17.1. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > failureThreshold`](#cronJobs_pattern1_livenessProbe_failureThreshold)
      - [5.1.17.2. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > httpGet`](#cronJobs_pattern1_livenessProbe_httpGet)
        - [5.1.17.2.1. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > httpGet > path`](#cronJobs_pattern1_livenessProbe_httpGet_path)
        - [5.1.17.2.2. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > httpGet > port`](#cronJobs_pattern1_livenessProbe_httpGet_port)
          - [5.1.17.2.2.1. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > httpGet > port > oneOf > item 0`](#cronJobs_pattern1_livenessProbe_httpGet_port_oneOf_i0)
          - [5.1.17.2.2.2. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > httpGet > port > oneOf > item 1`](#cronJobs_pattern1_livenessProbe_httpGet_port_oneOf_i1)
        - [5.1.17.2.3. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > httpGet > scheme`](#cronJobs_pattern1_livenessProbe_httpGet_scheme)
      - [5.1.17.3. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > initialDelaySeconds`](#cronJobs_pattern1_livenessProbe_initialDelaySeconds)
      - [5.1.17.4. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > periodSeconds`](#cronJobs_pattern1_livenessProbe_periodSeconds)
      - [5.1.17.5. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > successThreshold`](#cronJobs_pattern1_livenessProbe_successThreshold)
      - [5.1.17.6. Property `stack helm chart > cronJobs > ^.*$ > livenessProbe > timeoutSeconds`](#cronJobs_pattern1_livenessProbe_timeoutSeconds)
    - [5.1.18. Property `stack helm chart > cronJobs > ^.*$ > nameOverride`](#cronJobs_pattern1_nameOverride)
    - [5.1.19. Property `stack helm chart > cronJobs > ^.*$ > nodeSelector`](#cronJobs_pattern1_nodeSelector)
      - [5.1.19.1. Property `stack helm chart > cronJobs > ^.*$ > nodeSelector > kubernetes.io/arch`](#cronJobs_pattern1_nodeSelector_kubernetesio/arch)
    - [5.1.20. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy`](#cronJobs_pattern1_oidcProxy)
      - [5.1.20.1. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > additionalHeaders`](#cronJobs_pattern1_oidcProxy_additionalHeaders)
      - [5.1.20.2. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > additionalSecrets`](#cronJobs_pattern1_oidcProxy_additionalSecrets)
      - [5.1.20.3. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > annotations`](#cronJobs_pattern1_oidcProxy_annotations)
      - [5.1.20.4. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > cookieRefresh`](#cronJobs_pattern1_oidcProxy_cookieRefresh)
      - [5.1.20.5. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > enabled`](#cronJobs_pattern1_oidcProxy_enabled)
      - [5.1.20.6. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > extraArgs`](#cronJobs_pattern1_oidcProxy_extraArgs)
        - [5.1.20.6.1. stack helm chart > cronJobs > ^.*$ > oidcProxy > extraArgs > extraArgs items](#cronJobs_pattern1_oidcProxy_extraArgs_items)
      - [5.1.20.7. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > image`](#cronJobs_pattern1_oidcProxy_image)
        - [5.1.20.7.1. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > image > repository`](#cronJobs_pattern1_oidcProxy_image_repository)
        - [5.1.20.7.2. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > image > tag`](#cronJobs_pattern1_oidcProxy_image_tag)
      - [5.1.20.8. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > replicaCount`](#cronJobs_pattern1_oidcProxy_replicaCount)
      - [5.1.20.9. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources`](#cronJobs_pattern1_oidcProxy_resources)
        - [5.1.20.9.1. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > limits`](#cronJobs_pattern1_oidcProxy_resources_limits)
          - [5.1.20.9.1.1. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > limits > cpu`](#cronJobs_pattern1_oidcProxy_resources_limits_cpu)
            - [5.1.20.9.1.1.1. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > limits > cpu > oneOf > item 0`](#cronJobs_pattern1_oidcProxy_resources_limits_cpu_oneOf_i0)
            - [5.1.20.9.1.1.2. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > limits > cpu > oneOf > item 1`](#cronJobs_pattern1_oidcProxy_resources_limits_cpu_oneOf_i1)
          - [5.1.20.9.1.2. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > limits > memory`](#cronJobs_pattern1_oidcProxy_resources_limits_memory)
        - [5.1.20.9.2. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > requests`](#cronJobs_pattern1_oidcProxy_resources_requests)
          - [5.1.20.9.2.1. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > requests > cpu`](#cronJobs_pattern1_oidcProxy_resources_requests_cpu)
            - [5.1.20.9.2.1.1. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > requests > cpu > oneOf > item 0`](#cronJobs_pattern1_oidcProxy_resources_requests_cpu_oneOf_i0)
            - [5.1.20.9.2.1.2. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > requests > cpu > oneOf > item 1`](#cronJobs_pattern1_oidcProxy_resources_requests_cpu_oneOf_i1)
          - [5.1.20.9.2.2. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > resources > requests > memory`](#cronJobs_pattern1_oidcProxy_resources_requests_memory)
      - [5.1.20.10. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > skipAuth`](#cronJobs_pattern1_oidcProxy_skipAuth)
        - [5.1.20.10.1. stack helm chart > cronJobs > ^.*$ > oidcProxy > skipAuth > skipAuth items](#cronJobs_pattern1_oidcProxy_skipAuth_items)
          - [5.1.20.10.1.1. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > skipAuth > skipAuth items > method`](#cronJobs_pattern1_oidcProxy_skipAuth_items_method)
          - [5.1.20.10.1.2. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > skipAuth > skipAuth items > path`](#cronJobs_pattern1_oidcProxy_skipAuth_items_path)
      - [5.1.20.11. Property `stack helm chart > cronJobs > ^.*$ > oidcProxy > volumeMounts`](#cronJobs_pattern1_oidcProxy_volumeMounts)
    - [5.1.21. Property `stack helm chart > cronJobs > ^.*$ > persistence`](#cronJobs_pattern1_persistence)
      - [5.1.21.1. Property `stack helm chart > cronJobs > ^.*$ > persistence > enabled`](#cronJobs_pattern1_persistence_enabled)
      - [5.1.21.2. Property `stack helm chart > cronJobs > ^.*$ > persistence > existingClaim`](#cronJobs_pattern1_persistence_existingClaim)
      - [5.1.21.3. Property `stack helm chart > cronJobs > ^.*$ > persistence > mountPath`](#cronJobs_pattern1_persistence_mountPath)
      - [5.1.21.4. Property `stack helm chart > cronJobs > ^.*$ > persistence > pvc`](#cronJobs_pattern1_persistence_pvc)
        - [5.1.21.4.1. Property `stack helm chart > cronJobs > ^.*$ > persistence > pvc > accessModes`](#cronJobs_pattern1_persistence_pvc_accessModes)
          - [5.1.21.4.1.1. stack helm chart > cronJobs > ^.*$ > persistence > pvc > accessModes > accessModes items](#cronJobs_pattern1_persistence_pvc_accessModes_items)
        - [5.1.21.4.2. Property `stack helm chart > cronJobs > ^.*$ > persistence > pvc > resources`](#cronJobs_pattern1_persistence_pvc_resources)
          - [5.1.21.4.2.1. Property `stack helm chart > cronJobs > ^.*$ > persistence > pvc > resources > requests`](#cronJobs_pattern1_persistence_pvc_resources_requests)
            - [5.1.21.4.2.1.1. Property `stack helm chart > cronJobs > ^.*$ > persistence > pvc > resources > requests > storage`](#cronJobs_pattern1_persistence_pvc_resources_requests_storage)
        - [5.1.21.4.3. Property `stack helm chart > cronJobs > ^.*$ > persistence > pvc > storageClassName`](#cronJobs_pattern1_persistence_pvc_storageClassName)
    - [5.1.22. Property `stack helm chart > cronJobs > ^.*$ > podAnnotations`](#cronJobs_pattern1_podAnnotations)
      - [5.1.22.1. Property `stack helm chart > cronJobs > ^.*$ > podAnnotations > config.linkerd.io/skip-outbound-ports`](#cronJobs_pattern1_podAnnotations_configlinkerdio/skip-outbound-ports)
      - [5.1.22.2. Property `stack helm chart > cronJobs > ^.*$ > podAnnotations > linkerd.io/inject`](#cronJobs_pattern1_podAnnotations_linkerdio/inject)
    - [5.1.23. Property `stack helm chart > cronJobs > ^.*$ > podLabels`](#cronJobs_pattern1_podLabels)
    - [5.1.24. Property `stack helm chart > cronJobs > ^.*$ > podSecurityContext`](#cronJobs_pattern1_podSecurityContext)
    - [5.1.25. Property `stack helm chart > cronJobs > ^.*$ > progressDeadlineSeconds`](#cronJobs_pattern1_progressDeadlineSeconds)
    - [5.1.26. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe`](#cronJobs_pattern1_readinessProbe)
      - [5.1.26.1. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > failureThreshold`](#cronJobs_pattern1_readinessProbe_failureThreshold)
      - [5.1.26.2. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > httpGet`](#cronJobs_pattern1_readinessProbe_httpGet)
        - [5.1.26.2.1. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > httpGet > path`](#cronJobs_pattern1_readinessProbe_httpGet_path)
        - [5.1.26.2.2. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > httpGet > port`](#cronJobs_pattern1_readinessProbe_httpGet_port)
          - [5.1.26.2.2.1. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > httpGet > port > oneOf > item 0`](#cronJobs_pattern1_readinessProbe_httpGet_port_oneOf_i0)
          - [5.1.26.2.2.2. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > httpGet > port > oneOf > item 1`](#cronJobs_pattern1_readinessProbe_httpGet_port_oneOf_i1)
        - [5.1.26.2.3. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > httpGet > scheme`](#cronJobs_pattern1_readinessProbe_httpGet_scheme)
      - [5.1.26.3. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > initialDelaySeconds`](#cronJobs_pattern1_readinessProbe_initialDelaySeconds)
      - [5.1.26.4. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > periodSeconds`](#cronJobs_pattern1_readinessProbe_periodSeconds)
      - [5.1.26.5. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > successThreshold`](#cronJobs_pattern1_readinessProbe_successThreshold)
      - [5.1.26.6. Property `stack helm chart > cronJobs > ^.*$ > readinessProbe > timeoutSeconds`](#cronJobs_pattern1_readinessProbe_timeoutSeconds)
    - [5.1.27. Property `stack helm chart > cronJobs > ^.*$ > replicaCount`](#cronJobs_pattern1_replicaCount)
    - [5.1.28. Property `stack helm chart > cronJobs > ^.*$ > resources`](#cronJobs_pattern1_resources)
      - [5.1.28.1. Property `stack helm chart > cronJobs > ^.*$ > resources > limits`](#cronJobs_pattern1_resources_limits)
        - [5.1.28.1.1. Property `stack helm chart > cronJobs > ^.*$ > resources > limits > cpu`](#cronJobs_pattern1_resources_limits_cpu)
          - [5.1.28.1.1.1. Property `stack helm chart > cronJobs > ^.*$ > resources > limits > cpu > oneOf > item 0`](#cronJobs_pattern1_resources_limits_cpu_oneOf_i0)
          - [5.1.28.1.1.2. Property `stack helm chart > cronJobs > ^.*$ > resources > limits > cpu > oneOf > item 1`](#cronJobs_pattern1_resources_limits_cpu_oneOf_i1)
        - [5.1.28.1.2. Property `stack helm chart > cronJobs > ^.*$ > resources > limits > memory`](#cronJobs_pattern1_resources_limits_memory)
      - [5.1.28.2. Property `stack helm chart > cronJobs > ^.*$ > resources > requests`](#cronJobs_pattern1_resources_requests)
        - [5.1.28.2.1. Property `stack helm chart > cronJobs > ^.*$ > resources > requests > cpu`](#cronJobs_pattern1_resources_requests_cpu)
          - [5.1.28.2.1.1. Property `stack helm chart > cronJobs > ^.*$ > resources > requests > cpu > oneOf > item 0`](#cronJobs_pattern1_resources_requests_cpu_oneOf_i0)
          - [5.1.28.2.1.2. Property `stack helm chart > cronJobs > ^.*$ > resources > requests > cpu > oneOf > item 1`](#cronJobs_pattern1_resources_requests_cpu_oneOf_i1)
        - [5.1.28.2.2. Property `stack helm chart > cronJobs > ^.*$ > resources > requests > memory`](#cronJobs_pattern1_resources_requests_memory)
    - [5.1.29. Property `stack helm chart > cronJobs > ^.*$ > restartPolicy`](#cronJobs_pattern1_restartPolicy)
    - [5.1.30. Property `stack helm chart > cronJobs > ^.*$ > securityContext`](#cronJobs_pattern1_securityContext)
    - [5.1.31. Property `stack helm chart > cronJobs > ^.*$ > service`](#cronJobs_pattern1_service)
      - [5.1.31.1. Property `stack helm chart > cronJobs > ^.*$ > service > port`](#cronJobs_pattern1_service_port)
      - [5.1.31.2. Property `stack helm chart > cronJobs > ^.*$ > service > type`](#cronJobs_pattern1_service_type)
    - [5.1.32. Property `stack helm chart > cronJobs > ^.*$ > serviceAccount`](#cronJobs_pattern1_serviceAccount)
      - [5.1.32.1. Property `stack helm chart > cronJobs > ^.*$ > serviceAccount > annotations`](#cronJobs_pattern1_serviceAccount_annotations)
      - [5.1.32.2. Property `stack helm chart > cronJobs > ^.*$ > serviceAccount > automount`](#cronJobs_pattern1_serviceAccount_automount)
      - [5.1.32.3. Property `stack helm chart > cronJobs > ^.*$ > serviceAccount > create`](#cronJobs_pattern1_serviceAccount_create)
      - [5.1.32.4. Property `stack helm chart > cronJobs > ^.*$ > serviceAccount > name`](#cronJobs_pattern1_serviceAccount_name)
    - [5.1.33. Property `stack helm chart > cronJobs > ^.*$ > shareProcessNamespace`](#cronJobs_pattern1_shareProcessNamespace)
    - [5.1.34. Property `stack helm chart > cronJobs > ^.*$ > sidecars`](#cronJobs_pattern1_sidecars)
    - [5.1.35. Property `stack helm chart > cronJobs > ^.*$ > startupProbe`](#cronJobs_pattern1_startupProbe)
      - [5.1.35.1. Property `stack helm chart > cronJobs > ^.*$ > startupProbe > enabled`](#cronJobs_pattern1_startupProbe_enabled)
      - [5.1.35.2. Property `stack helm chart > cronJobs > ^.*$ > startupProbe > exec`](#cronJobs_pattern1_startupProbe_exec)
        - [5.1.35.2.1. Property `stack helm chart > cronJobs > ^.*$ > startupProbe > exec > command`](#cronJobs_pattern1_startupProbe_exec_command)
          - [5.1.35.2.1.1. stack helm chart > cronJobs > ^.*$ > startupProbe > exec > command > command items](#cronJobs_pattern1_startupProbe_exec_command_items)
      - [5.1.35.3. Property `stack helm chart > cronJobs > ^.*$ > startupProbe > failureThreshold`](#cronJobs_pattern1_startupProbe_failureThreshold)
      - [5.1.35.4. Property `stack helm chart > cronJobs > ^.*$ > startupProbe > initialDelaySeconds`](#cronJobs_pattern1_startupProbe_initialDelaySeconds)
      - [5.1.35.5. Property `stack helm chart > cronJobs > ^.*$ > startupProbe > periodSeconds`](#cronJobs_pattern1_startupProbe_periodSeconds)
      - [5.1.35.6. Property `stack helm chart > cronJobs > ^.*$ > startupProbe > successThreshold`](#cronJobs_pattern1_startupProbe_successThreshold)
      - [5.1.35.7. Property `stack helm chart > cronJobs > ^.*$ > startupProbe > timeoutSeconds`](#cronJobs_pattern1_startupProbe_timeoutSeconds)
    - [5.1.36. Property `stack helm chart > cronJobs > ^.*$ > tolerations`](#cronJobs_pattern1_tolerations)
    - [5.1.37. Property `stack helm chart > cronJobs > ^.*$ > topologySpreadConstraints`](#cronJobs_pattern1_topologySpreadConstraints)
    - [5.1.38. Property `stack helm chart > cronJobs > ^.*$ > volumeMounts`](#cronJobs_pattern1_volumeMounts)
    - [5.1.39. Property `stack helm chart > cronJobs > ^.*$ > volumes`](#cronJobs_pattern1_volumes)
...
----------------------------------------------------------------------------------------------------------------------------
Generated using [json-schema-for-humans](https://github.com/coveooss/json-schema-for-humans) on 2025-03-14 at 13:40:05 -0600
